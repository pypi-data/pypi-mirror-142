...
def create_torch_client():
    return TorchClient(url='https://acceldata.mars.acceldata.dev/torch', access_key = '3LWJ268SWCNTYAO', secret_key ='VCBJIBNLCZYKR4Z5JNHS4Z4OGIB5YG')
...
def create_pipeline(torch_client):
    pipeline = CreatePipeline(
        ...
        meta=PipelineMetadata(
            owner='vaishvik', team='torch_sdk_code', codeLocation='...'),
...
def create_datagen_job(pipeline):
    job = CreateJob(
        ...
        outputs=[
            Dataset('snowflake',
                    'FINANCE.FINANCE.A1'), Dataset('snowflake',
                                                         'FINANCE.FINANCE.A2')],
