...
class NEMA_Frame:
    ...
    def Assign_NEMA_Phase(self, EW_OR_NS):
        if EW_OR_NS:  # true for EW
            ...
            self.Movement_NEMA_Table[EMovement_Index.NBL] = E_NEMA_Phase.Mi_SLB
            self.Movement_NEMA_Table[EMovement_Index.SBL] = E_NEMA_Phase.Mi_SLA
            self.Movement_NEMA_Table[EMovement_Index.NBT] = E_NEMA_Phase.Mi_STRB
            self.Movement_NEMA_Table[EMovement_Index.SBT] = E_NEMA_Phase.Mi_STRA
            self.Movement_NEMA_Table[EMovement_Index.NBR] = E_NEMA_Phase.Mi_STRB
            self.Movement_NEMA_Table[EMovement_Index.SBR] = E_NEMA_Phase.Mi_STRA
        else:
            ...
            self.Movement_NEMA_Table[EMovement_Index.NBL] = E_NEMA_Phase.Ma_SLB
            self.Movement_NEMA_Table[EMovement_Index.SBL] = E_NEMA_Phase.Ma_SLA
            self.Movement_NEMA_Table[EMovement_Index.NBT] = E_NEMA_Phase.Ma_STRB
            self.Movement_NEMA_Table[EMovement_Index.SBT] = E_NEMA_Phase.Ma_STRA
            self.Movement_NEMA_Table[EMovement_Index.NBR] = E_NEMA_Phase.Ma_STRB
            self.Movement_NEMA_Table[EMovement_Index.SBR] = E_NEMA_Phase.Ma_STRA
