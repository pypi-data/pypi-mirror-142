...
class CPVCSConfigContext:
 ...
 def is_remotly_managed(self,pod_name:str=None)->bool:
  if pod_name:
...
class PodFilePaths:
 @classmethod
 def metamodel_file(cls,revision:int,version:int=None,absolute=False)->str:
  if not revision:
