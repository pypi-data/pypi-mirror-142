...
class LambdaInvokeAction(
    ...
    def bind(
        ...
        *,
    ...
    ) -> aws_cdk.aws_iotevents_alpha.ActionConfig:
        ...
        :stability: experimental
        '''
        options = aws_cdk.aws_iotevents_alpha.ActionBindOptions(role=role)

        return typing.cast(aws_cdk.aws_iotevents_alpha.ActionConfig, jsii.invoke(self, "bind", [_scope, options]))
