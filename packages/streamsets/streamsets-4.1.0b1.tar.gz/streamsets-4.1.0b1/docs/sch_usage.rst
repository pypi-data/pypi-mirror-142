...
.. warning::
   The documentation in this section of **Control Hub Usage** is not yet updated for StreamSets DataOps Platform SDK
   for Python.

   StreamSets team is working diligently on this. In the meantime, please refer to the updated
