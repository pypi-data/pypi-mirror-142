...
import os
import platform
from piedpy import __version__
from piedpy.packages.special import iocommands
from piedpy.packages.special.utils import format_uptime
...
def status(cur, **_):
    ...
    client_info = []
    client_info.append('piedpy {0},'.format(__version__))
