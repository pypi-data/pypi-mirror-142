...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, url=None, tls_validation=None, pulp_href=None, sock_connect_timeout=None, pulp_labels=None, max_retries=None, client_cert=None, pulp_last_updated=None, proxy_url=None, headers=None, connect_timeout=None, download_concurrency=None, sock_read_timeout=None, rate_limit=None, total_timeout=None, pulp_created=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
