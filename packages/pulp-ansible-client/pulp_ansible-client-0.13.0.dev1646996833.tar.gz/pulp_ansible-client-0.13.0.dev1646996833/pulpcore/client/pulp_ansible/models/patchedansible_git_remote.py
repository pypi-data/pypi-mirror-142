...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, pulp_labels=None, headers=None, total_timeout=None, sock_read_timeout=None, username=None, client_key=None, connect_timeout=None, ca_cert=None, url=None, password=None, proxy_password=None, max_retries=None, tls_validation=None, proxy_url=None, download_concurrency=None, rate_limit=None, name=None, client_cert=None, sock_connect_timeout=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
