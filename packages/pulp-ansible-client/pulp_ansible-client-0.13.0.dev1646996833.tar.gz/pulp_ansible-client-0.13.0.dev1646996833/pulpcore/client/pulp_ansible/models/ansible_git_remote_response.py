...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, headers=None, total_timeout=None, sock_read_timeout=None, connect_timeout=None, ca_cert=None, url=None, max_retries=None, pulp_href=None, tls_validation=None, proxy_url=None, download_concurrency=None, rate_limit=None, name=None, pulp_last_updated=None, pulp_created=None, client_cert=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
