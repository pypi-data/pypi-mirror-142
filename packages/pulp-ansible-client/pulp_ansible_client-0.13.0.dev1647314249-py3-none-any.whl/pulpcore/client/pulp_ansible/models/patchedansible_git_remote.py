...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, name=None, url=None, tls_validation=None, username=None, proxy_password=None, sock_connect_timeout=None, pulp_labels=None, max_retries=None, proxy_username=None, client_cert=None, proxy_url=None, headers=None, client_key=None, connect_timeout=None, download_concurrency=None, sock_read_timeout=None, rate_limit=None, total_timeout=None, password=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
