...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, ca_cert=None, pulp_created=None, pulp_labels=None, headers=None, sock_read_timeout=None, proxy_url=None, download_concurrency=None, client_cert=None, total_timeout=None, sock_connect_timeout=None, connect_timeout=None, pulp_last_updated=None, pulp_href=None, rate_limit=None, tls_validation=None, name=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
