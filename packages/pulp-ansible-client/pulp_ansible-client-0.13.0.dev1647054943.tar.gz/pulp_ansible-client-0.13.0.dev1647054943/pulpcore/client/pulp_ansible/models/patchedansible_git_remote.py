...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_key=None, max_retries=None, ca_cert=None, proxy_username=None, pulp_labels=None, password=None, headers=None, sock_read_timeout=None, proxy_password=None, proxy_url=None, download_concurrency=None, client_cert=None, total_timeout=None, sock_connect_timeout=None, connect_timeout=None, rate_limit=None, tls_validation=None, name=None, username=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
