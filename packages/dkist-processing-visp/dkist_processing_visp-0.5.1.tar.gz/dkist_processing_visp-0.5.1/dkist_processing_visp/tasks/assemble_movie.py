...
class AssembleVispMovie(AssembleMovie):
    ...
    def fits_parsing_class(self):
        """
        The ViSP specific subclass of L1FitsAccess to use for reading images.
        """
        return VispL1FitsAccess

    def write_overlay(self, draw: ImageDraw, fits_obj: VispL0FitsAccess) -> None:
        """
        This function marks each image with it's instrument, observed wavelength, and observation time.
