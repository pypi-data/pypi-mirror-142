...
from credoai.reporting.credo_reporter import CredoReport
...
class DatasetModuleReport(CredoReport):
    ...
    def _plot_mutual_information(self):
        ...
        ref_name = self.module.sensitive_features.name
        ...
        sns.despine()
        ax.set_title(
            "Normalized mututal information with feature: " + ref_name
        )
        ax.set_xlabel("")
