...
class ParserLEDET:
    ...
    def writeLedetWorkbookSheet(self, book, sheet, variableGroup, variableLabels):
        """
...
def copy_modified_map2d_ribbon_cable(magnet_name: str, map2d_file_name: str, output_path: str, geometry_ribbon_cable,
                                     flagIron: int, flagSelfField: int, suffix: str = '', verbose: bool = False):
    ''' #TODO '''
    ...
    NewMap2d = ParserMap2d.modify_map2d_ribbon_cable(map2d_file_name, geometry_ribbon_cable)
