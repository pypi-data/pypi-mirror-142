...
**This NLP task was difficult because the structure of local dialect is not codified but often rely on the structure of its lexifier (Standard English). Also spelling varies from speaker to speaker. In addition, creole words/spelling are not initial present in the vector space which made training times and optimization longer .**
