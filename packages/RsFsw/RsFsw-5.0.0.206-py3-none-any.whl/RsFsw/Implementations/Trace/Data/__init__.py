...
class Data:
	...
	def get(self, trace_type: enums.TraceNumber, window=repcap.Window.Default) -> List[float]:
		"""SCPI: TRACe<n>[:DATA] \n
		Snippet: value: List[float] = driver.trace.data.get(trace_type = enums.TraceNumber.BTOBits, window = repcap.Window.Default) \n
		This command queries current trace data and measurement results. The data format depends on method RsFsw.FormatPy.Data.
		set. \n
