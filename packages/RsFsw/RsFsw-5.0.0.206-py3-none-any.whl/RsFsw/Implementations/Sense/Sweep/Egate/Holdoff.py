...
class Holdoff:
	...
	def set(self, delay_time: float) -> None:
		...
		This command defines the delay time between the gate signal and the continuation of the measurement. Note: If you perform
		gated measurements in combination with the IF Power trigger, the R&S FSW ignores the holding time for frequency sweep,
