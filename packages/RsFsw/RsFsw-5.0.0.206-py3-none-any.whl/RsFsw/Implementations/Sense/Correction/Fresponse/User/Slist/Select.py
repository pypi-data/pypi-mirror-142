...
class Select:
	...
	def set(self, file_path: str, touchStone=repcap.TouchStone.Default) -> None:
		...
		Snippet: driver.sense.correction.fresponse.user.slist.select.set(file_path = '1', touchStone = repcap.TouchStone.Default) \n
		...
		self._core.io.write(f'SENSe:CORRection:FRESponse:USER:SLISt{touchStone_cmd_val}:SELect {param}')
