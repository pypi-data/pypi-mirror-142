...
class Alternate:
	...
	def set(self, alpha: float, channel=repcap.Channel.Default) -> None:
		...
		This command defines the roll-off factor for the alternate channel weighting filter. For asymmetrical MSR signals, this
		command defines the roll-off factor for the lower alternate channels. To configure the factor for the upper alterante
		channels, use the [SENSe:]POWer:ACHannel:FILTer:ALPHa:UALTernate<ch> command. \n
