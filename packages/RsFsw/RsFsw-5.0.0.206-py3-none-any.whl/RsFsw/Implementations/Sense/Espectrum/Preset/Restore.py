...
class Restore:
	...
	def set(self, subBlock=repcap.SubBlock.Default) -> None:
		...
		This command restores the default configurations of predefined SEM standards. Note that the command will overwrite
		customized standards that have the same name as predefined standards. \n
