...
class Result:
	...
	def get(self, trace_mode: enums.TraceModeB) -> float:
		...
		Snippet: value: float = driver.sense.ademod.pm.tdomain.result.get(trace_mode = enums.TraceModeB.AVERage) \n
		...
		response = self._core.io.query_str(f'SENSe:ADEMod:PM:TDOMain:RESult? {param}')
