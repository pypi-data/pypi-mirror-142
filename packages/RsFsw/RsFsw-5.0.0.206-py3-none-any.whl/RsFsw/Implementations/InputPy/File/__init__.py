...
class File:
	...
	@property
	def zpading(self):
		"""zpading commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_zpading'):
			from .Zpading import Zpading
			self._zpading = Zpading(self._core, self._cmd_group)
		return self._zpading
