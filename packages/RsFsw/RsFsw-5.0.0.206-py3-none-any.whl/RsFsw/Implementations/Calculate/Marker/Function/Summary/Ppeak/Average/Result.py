...
class Result:
	...
	def get(self, window=repcap.Window.Default, marker=repcap.Marker.Default) -> float:
		...
		This command queries the average positive peak time domain power. The query is only possible if averaging has been
		activated previously using method RsFsw.Calculate.Marker.Function.Summary.Average.set. To get a valid result, you have to
