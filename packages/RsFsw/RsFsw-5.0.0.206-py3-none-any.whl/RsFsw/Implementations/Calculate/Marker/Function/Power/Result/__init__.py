...
class Result:
	...
	def details(self):
		...
		if not hasattr(self, '_details'):
			...
			self._details = Details(self._core, self._cmd_group)
	...
	def set(self, measurement: enums.MarkerFunctionA, window=repcap.Window.Default, marker=repcap.Marker.Default, subBlock=repcap.SubBlock.Default) -> None:
		...
		This command queries the results of power measurements. To get a valid result, you have to perform a complete measurement
