...
class Auto:
	...
	def set(self, event: enums.EventOnce, powerMeter=repcap.PowerMeter.Default) -> None:
		"""SCPI: CALibration:PMETer<p>:ZERO:AUTO \n
		Snippet: driver.calibration.pmeter.zero.auto.set(event = enums.EventOnce.ONCE, powerMeter = repcap.PowerMeter.Default) \n
		This command zeroes the power sensor. Note that you have to disconnect the signals from the power sensor input before you
