...
class Minimum:
	...
	def get(self) -> float:
		"""SCPI: FETCh:TDPower:MINimum \n
		Snippet: value: float = driver.applications.k9X11Ad.fetch.tdPower.minimum.get() \n
		...
		response = self._core.io.query_str(f'FETCh:TDPower:MINimum?')
