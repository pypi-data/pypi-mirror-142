...
class Minimum:
	...
	def get(self) -> float:
		"""SCPI: FETCh:GIMBalance:MINimum \n
		Snippet: value: float = driver.applications.k9X11Ad.fetch.gimbalance.minimum.get() \n
		...
		response = self._core.io.query_str(f'FETCh:GIMBalance:MINimum?')
