...
class Step:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k9X11Ad.sense.frequency.center.step.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:FREQuency:CENTer:STEP \n
		Snippet: value: float = driver.applications.k9X11Ad.sense.frequency.center.step.get() \n
		This command defines the center frequency step size. \n
