...
class Mode:
	...
	def set(self, mode: enums.AutoManualMode) -> None:
		...
		Snippet: driver.applications.k9X11Ad.sense.adjust.configure.level.duration.mode.set(mode = enums.AutoManualMode.AUTO) \n
	...
	def get(self) -> enums.AutoManualMode:
		"""SCPI: [SENSe]:ADJust:CONFigure[:LEVel]:DURation:MODE \n
		Snippet: value: enums.AutoManualMode = driver.applications.k9X11Ad.sense.adjust.configure.level.duration.mode.get() \n
		No command help available \n
