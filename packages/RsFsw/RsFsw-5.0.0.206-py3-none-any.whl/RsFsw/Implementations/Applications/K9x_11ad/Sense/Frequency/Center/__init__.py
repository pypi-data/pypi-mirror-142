...
class Center:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k9X11Ad.sense.frequency.center.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:FREQuency:CENTer \n
		Snippet: value: float = driver.applications.k9X11Ad.sense.frequency.center.get() \n
		This command defines the center frequency. \n
