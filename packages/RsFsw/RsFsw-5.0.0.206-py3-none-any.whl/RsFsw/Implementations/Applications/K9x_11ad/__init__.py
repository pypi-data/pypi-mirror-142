...
class K9x_11ad:
	"""K9x_11ad commands group definition. 255 total commands, 17 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("k9x_11ad", core, parent)
	...
	@property
	def fetch(self):
		"""fetch commands group. 16 Sub-classes, 0 commands."""
	...
	def clone(self) -> 'K9x_11ad':
		"""Clones the group by creating new object from it and its whole existing subgroups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = K9x_11ad(self._core, self._cmd_group.parent)
