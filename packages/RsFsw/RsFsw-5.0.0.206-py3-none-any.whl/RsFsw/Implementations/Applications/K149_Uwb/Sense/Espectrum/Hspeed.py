...
class Hspeed:
	...
	def set(self, state: bool, subBlock=repcap.SubBlock.Default) -> None:
		...
		Snippet: driver.applications.k149Uwb.sense.espectrum.hspeed.set(state = False, subBlock = repcap.SubBlock.Default) \n
	...
	def get(self, subBlock=repcap.SubBlock.Default) -> bool:
		"""SCPI: [SENSe]:ESPectrum<sb>:HSPeed \n
		Snippet: value: bool = driver.applications.k149Uwb.sense.espectrum.hspeed.get(subBlock = repcap.SubBlock.Default) \n
		No command help available \n
			:param subBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Espectrum')
