...
class Link:
	...
	def set(self, step_link: enums.FrequencyCouplingLinkB) -> None:
		...
		Snippet: driver.applications.k149Uwb.sense.frequency.center.step.link.set(step_link = enums.FrequencyCouplingLinkB.OFF) \n
		No command help available \n
			:param step_link: No help available
		"""
	...
	def get(self) -> enums.FrequencyCouplingLinkB:
		"""SCPI: [SENSe]:FREQuency:CENTer:STEP:LINK \n
		Snippet: value: enums.FrequencyCouplingLinkB = driver.applications.k149Uwb.sense.frequency.center.step.link.get() \n
		No command help available \n
