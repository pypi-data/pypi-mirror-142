...
class Passed:
	...
	def get(self, window=repcap.Window.Default) -> str:
		"""SCPI: FETCh<n>:SUMMary:XCORr:SLOBe:PEAK:PASSed \n
		Snippet: value: str = driver.applications.k149Uwb.fetch.summary.xcorr.slobe.peak.passed.get(window = repcap.Window.Default) \n
		...
		response = self._core.io.query_str(f'FETCh{window_cmd_val}:SUMMary:XCORr:SLOBe:PEAK:PASSed?')
