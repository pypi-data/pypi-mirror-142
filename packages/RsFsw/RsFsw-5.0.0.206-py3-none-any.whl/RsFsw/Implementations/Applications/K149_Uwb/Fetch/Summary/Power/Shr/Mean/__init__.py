...
class Mean:
	...
	def get(self, window=repcap.Window.Default) -> float:
		"""SCPI: FETCh<n>:SUMMary:POWer:SHR:MEAN \n
		Snippet: value: float = driver.applications.k149Uwb.fetch.summary.power.shr.mean.get(window = repcap.Window.Default) \n
		...
		response = self._core.io.query_str(f'FETCh{window_cmd_val}:SUMMary:POWer:SHR:MEAN?')
