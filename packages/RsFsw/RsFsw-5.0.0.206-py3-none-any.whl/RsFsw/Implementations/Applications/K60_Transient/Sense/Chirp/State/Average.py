...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:STATe:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.state.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:STATe:AVERage? {param}')
