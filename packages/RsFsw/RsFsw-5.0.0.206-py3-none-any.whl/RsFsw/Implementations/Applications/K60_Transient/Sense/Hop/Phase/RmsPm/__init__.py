...
class RmsPm:
	...
	def get(self, query_range: enums.SelectionRange) -> float:
		"""SCPI: [SENSe]:HOP:PHASe:RMSPm \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.phase.rmsPm.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:PHASe:RMSPm? {param}')
