...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:HOP:TIMing:DWELl:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.timing.dwell.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:TIMing:DWELl:AVERage? {param}')
