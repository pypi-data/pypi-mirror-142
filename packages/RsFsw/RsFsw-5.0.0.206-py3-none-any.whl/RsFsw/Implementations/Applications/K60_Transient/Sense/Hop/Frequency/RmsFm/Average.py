...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:HOP:FREQuency:RMSFm:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.frequency.rmsFm.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:FREQuency:RMSFm:AVERage? {param}')
