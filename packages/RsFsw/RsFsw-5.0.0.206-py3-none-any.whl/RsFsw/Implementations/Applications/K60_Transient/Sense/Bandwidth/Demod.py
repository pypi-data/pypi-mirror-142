...
class Demod:
	...
	def set(self, bandwidth: float) -> None:
		...
		Snippet: driver.applications.k60Transient.sense.bandwidth.demod.set(bandwidth = 1.0) \n
		No command help available \n
			:param bandwidth: Range: 80 Hz to depends on options installed, Unit: HZ
		"""
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:BWIDth:DEMod \n
		Snippet: value: float = driver.applications.k60Transient.sense.bandwidth.demod.get() \n
		No command help available \n
			:return: bandwidth: Range: 80 Hz to depends on options installed, Unit: HZ"""
