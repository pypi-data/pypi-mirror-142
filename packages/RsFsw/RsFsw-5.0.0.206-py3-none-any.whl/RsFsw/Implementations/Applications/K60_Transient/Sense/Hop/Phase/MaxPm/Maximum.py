...
class Maximum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:HOP:PHASe:MAXPm:MAXimum \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.phase.maxPm.maximum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:PHASe:MAXPm:MAXimum? {param}')
