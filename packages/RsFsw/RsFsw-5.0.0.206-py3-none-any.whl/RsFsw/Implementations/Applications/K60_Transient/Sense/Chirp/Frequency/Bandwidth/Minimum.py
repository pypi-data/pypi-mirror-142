...
class Minimum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:FREQuency:BWIDth:MINimum \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.frequency.bandwidth.minimum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:FREQuency:BWIDth:MINimum? {param}')
