...
class X:
	...
	def set(self, xaxis: enums.XaXisPmSettling, window=repcap.Window.Default) -> None:
		"""SCPI: CALCulate<n>:TRENd:CHIRp:PMSettling:X \n
		Snippet: driver.applications.k60Transient.calculate.trend.chirp.pmSettling.x.set(xaxis = enums.XaXisPmSettling.PMSLength, window = repcap.Window.Default) \n
		Configures the x-axis of the Parameter Trend result display for chirp PM settling parameters. \n
		...
		self._core.io.write(f'CALCulate{window_cmd_val}:TRENd:CHIRp:PMSettling:X {param}')
