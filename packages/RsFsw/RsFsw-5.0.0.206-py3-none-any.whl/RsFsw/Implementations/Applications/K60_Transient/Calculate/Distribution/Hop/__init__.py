...
class Hop:
	"""Hop commands group definition. 7 total commands, 7 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("hop", core, parent)
	...
	@property
	def fmSettling(self):
		"""fmSettling commands group. 0 Sub-classes, 1 commands."""
	...
	@property
	def pmSettling(self):
		"""pmSettling commands group. 0 Sub-classes, 1 commands."""
	...
	def clone(self) -> 'Hop':
		...
		new_group = Hop(self._core, self._cmd_group.parent)
