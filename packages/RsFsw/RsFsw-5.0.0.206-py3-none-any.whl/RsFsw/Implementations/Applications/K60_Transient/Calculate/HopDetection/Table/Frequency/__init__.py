...
class Frequency:
	"""Frequency commands group definition. 7 total commands, 7 Subgroups, 0 group commands"""
	...
	@property
	def fmError(self):
		"""fmError commands group. 0 Sub-classes, 1 commands."""
	...
	def relFrequency(self):
		"""relFrequency commands group. 0 Sub-classes, 1 commands."""
