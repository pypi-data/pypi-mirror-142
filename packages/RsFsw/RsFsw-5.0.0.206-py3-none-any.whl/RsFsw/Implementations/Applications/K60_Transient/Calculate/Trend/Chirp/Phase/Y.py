...
class Y:
	...
	def set(self, yaxis: enums.AxisPhase, window=repcap.Window.Default) -> None:
		"""SCPI: CALCulate<n>:TRENd:CHIRp:PHASe:Y \n
		Snippet: driver.applications.k60Transient.calculate.trend.chirp.phase.y.set(yaxis = enums.AxisPhase.AVPHm, window = repcap.Window.Default) \n
		Configures the y-axis of the Parameter Trend result display for chirp phase parameters. \n
		...
		self._core.io.write(f'CALCulate{window_cmd_val}:TRENd:CHIRp:PHASe:Y {param}')
