...
class K60_Transient:
	"""K60_Transient commands group definition. 704 total commands, 13 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("k60_Transient", core, parent)
	...
	@property
	def sense(self):
		"""sense commands group. 19 Sub-classes, 0 commands."""
	...
	def clone(self) -> 'K60_Transient':
		"""Clones the group by creating new object from it and its whole existing subgroups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = K60_Transient(self._core, self._cmd_group.parent)
