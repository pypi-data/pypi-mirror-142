...
class Source:
	...
	def set(self, source: enums.TriggerSourceE) -> None:
		"""SCPI: TRIGger[:SEQuence]:SOURce \n
		Snippet: driver.applications.k60Transient.trigger.sequence.source.set(source = enums.TriggerSourceE.EXT2) \n
	...
	def get(self) -> enums.TriggerSourceE:
		...
		return Conversions.str_to_scalar_enum(response, enums.TriggerSourceE)
