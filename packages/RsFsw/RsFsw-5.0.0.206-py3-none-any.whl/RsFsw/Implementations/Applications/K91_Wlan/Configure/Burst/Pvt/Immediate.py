...
class Immediate:
	...
	def set(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: CONFigure:BURSt:PVT[:IMMediate] \n
		Snippet: driver.applications.k91Wlan.configure.burst.pvt.immediate.set() \n
		This remote control command configures the measurement type to be Power vs Time. Note that the CONF:BURS:<ResultType>:IMM
		...
		self._core.io.write_with_opc(f'CONFigure:BURSt:PVT:IMMediate', opc_timeout_ms)
