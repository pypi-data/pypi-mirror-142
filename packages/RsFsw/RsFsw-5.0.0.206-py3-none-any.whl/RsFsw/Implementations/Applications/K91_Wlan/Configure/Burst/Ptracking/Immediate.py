...
class Immediate:
	...
	def set(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: CONFigure:BURSt:PTRacking[:IMMediate] \n
		Snippet: driver.applications.k91Wlan.configure.burst.ptracking.immediate.set() \n
		...
		self._core.io.write_with_opc(f'CONFigure:BURSt:PTRacking:IMMediate', opc_timeout_ms)
