...
class IqMcomp:
	...
	def set(self, state: bool) -> None:
		...
		mismatch') . This setting is not available for standards IEEE 802.11b and g (DSSS) . \n
			:param state: ON | OFF | 1 | 0 ON | 1 Compensation for gain imbalance, quadrature offset, and I/Q skew impairments is applied. OFF | 0 Compensation is not applied; this setting is required for measurements strictly according to the IEEE 802.11-2012, IEEE 802.11ac-2013 WLAN standard
		"""
	...
	def get(self) -> bool:
		...
		Activates or deactivates the compensation for I/Q mismatch (gain imbalance, quadrature offset, I/Q skew, see 'I/Q
		mismatch') . This setting is not available for standards IEEE 802.11b and g (DSSS) . \n
			:return: state: ON | OFF | 1 | 0 ON | 1 Compensation for gain imbalance, quadrature offset, and I/Q skew impairments is applied. OFF | 0 Compensation is not applied; this setting is required for measurements strictly according to the IEEE 802.11-2012, IEEE 802.11ac-2013 WLAN standard"""
