...
class Probe:
	"""Probe commands group definition. 11 total commands, 2 Subgroups, 0 group commands
	...
	@property
	def id(self):
		"""id commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def setup(self):
		"""setup commands group. 10 Sub-classes, 0 commands."""
