...
class State:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k91Wlan.sense.mixer.harmonic.high.state.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: [SENSe]:MIXer:HARMonic:HIGH:STATe \n
		Snippet: value: bool = driver.applications.k91Wlan.sense.mixer.harmonic.high.state.get() \n
		This command specifies whether a second (high) harmonic is to be used to cover the band's frequency range. \n
			:return: state: ON | OFF"""
