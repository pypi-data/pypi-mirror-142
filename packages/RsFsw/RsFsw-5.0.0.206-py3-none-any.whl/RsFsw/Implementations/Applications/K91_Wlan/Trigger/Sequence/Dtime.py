...
class Dtime:
	...
	def set(self, dropout_time: float) -> None:
		...
		Snippet: driver.applications.k91Wlan.trigger.sequence.dtime.set(dropout_time = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: TRIGger[:SEQuence]:DTIMe \n
		Snippet: value: float = driver.applications.k91Wlan.trigger.sequence.dtime.get() \n
		Defines the time the input signal must stay below the trigger level before a trigger is detected again. \n
