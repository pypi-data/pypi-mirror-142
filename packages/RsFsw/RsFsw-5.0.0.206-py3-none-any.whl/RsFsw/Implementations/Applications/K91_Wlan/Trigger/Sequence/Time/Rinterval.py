...
class Rinterval:
	...
	def set(self, interval: float) -> None:
		...
		Snippet: driver.applications.k91Wlan.trigger.sequence.time.rinterval.set(interval = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: TRIGger[:SEQuence]:TIME:RINTerval \n
		Snippet: value: float = driver.applications.k91Wlan.trigger.sequence.time.rinterval.get() \n
		This command defines the repetition interval for the time trigger. \n
