...
class Auto:
	...
	def set(self, state: bool, inputIx=repcap.InputIx.Default) -> None:
		"""SCPI: INPut<Undef>:EATT:AUTO \n
		Snippet: driver.applications.k91Wlan.inputPy.eatt.auto.set(state = False, inputIx = repcap.InputIx.Default) \n
		This command turns automatic selection of the electronic attenuation on and off. If on, electronic attenuation reduces
		the mechanical attenuation whenever possible. This command requires the electronic attenuation hardware option.
	...
	def get(self, inputIx=repcap.InputIx.Default) -> bool:
		"""SCPI: INPut<Undef>:EATT:AUTO \n
		Snippet: value: bool = driver.applications.k91Wlan.inputPy.eatt.auto.get(inputIx = repcap.InputIx.Default) \n
		This command turns automatic selection of the electronic attenuation on and off. If on, electronic attenuation reduces
		the mechanical attenuation whenever possible. This command requires the electronic attenuation hardware option.
		This function is not available if the optional Digital Baseband Interface is active. \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
