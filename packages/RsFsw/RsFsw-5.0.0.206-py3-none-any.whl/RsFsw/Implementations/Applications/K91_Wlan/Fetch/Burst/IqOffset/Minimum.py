...
class Minimum:
	...
	def get(self) -> str:
		"""SCPI: FETCh:BURSt:IQOFfset:MINimum \n
		Snippet: value: str = driver.applications.k91Wlan.fetch.burst.iqOffset.minimum.get() \n
		...
		tolerance parameters'. \n
			:return: result: list"""
		response = self._core.io.query_str(f'FETCh:BURSt:IQOFfset:MINimum?')
