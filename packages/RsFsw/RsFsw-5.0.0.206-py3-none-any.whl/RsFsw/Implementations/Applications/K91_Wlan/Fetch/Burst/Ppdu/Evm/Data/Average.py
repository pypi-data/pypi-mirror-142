...
class Average:
	...
	def get(self) -> str:
		"""SCPI: FETCh:BURSt:PPDU:EVM:DATA:AVERage \n
		Snippet: value: str = driver.applications.k91Wlan.fetch.burst.ppdu.evm.data.average.get() \n
		...
		response = self._core.io.query_str(f'FETCh:BURSt:PPDU:EVM:DATA:AVERage?')
