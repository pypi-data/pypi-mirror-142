...
class Trace:
	"""Trace commands group definition. 13 total commands, 4 Subgroups, 0 group commands
	...
	@property
	def mode(self):
		"""mode commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def normalize(self):
		"""normalize commands group. 2 Sub-classes, 0 commands."""
