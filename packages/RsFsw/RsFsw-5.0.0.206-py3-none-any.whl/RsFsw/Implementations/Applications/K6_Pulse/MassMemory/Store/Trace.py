...
class Trace:
	...
	def set(self, trace: int, filename: str, store=repcap.Store.Default) -> None:
		...
		Snippet: driver.applications.k6Pulse.massMemory.store.trace.set(trace = 1, filename = '1', store = repcap.Store.Default) \n
		This command exports trace data from the specified window to an ASCII file. For details on the file format see
