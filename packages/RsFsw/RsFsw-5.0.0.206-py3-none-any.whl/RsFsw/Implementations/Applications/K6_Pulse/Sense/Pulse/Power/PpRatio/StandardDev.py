...
class StandardDev:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:POWer:PPRatio:SDEViation \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.power.ppRatio.standardDev.get(query_range = enums.SelectionRangeB.ALL) \n
		Returns the statistical value for the Pulse-to-Pulse Power Difference over the specified pulses. \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:POWer:PPRatio:SDEViation? {param}')
