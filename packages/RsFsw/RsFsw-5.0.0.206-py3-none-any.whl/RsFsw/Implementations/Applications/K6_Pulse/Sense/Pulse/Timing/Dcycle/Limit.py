...
class Limit:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:TIMing:DCYCle:LIMit \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.timing.dcycle.limit.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TIMing:DCYCle:LIMit? {param}')
