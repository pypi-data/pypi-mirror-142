...
class Minimum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:FREQuency:POINt:MINimum \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.frequency.point.minimum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:FREQuency:POINt:MINimum? {param}')
