...
class Minimum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:POWer:AMPLitude:MINimum \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.power.amplitude.minimum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:POWer:AMPLitude:MINimum? {param}')
