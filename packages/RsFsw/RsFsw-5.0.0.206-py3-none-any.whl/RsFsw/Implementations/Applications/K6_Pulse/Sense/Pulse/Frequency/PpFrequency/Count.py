...
class Count:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:FREQuency:PPFRequency:COUNt \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.frequency.ppFrequency.count.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:FREQuency:PPFRequency:COUNt? {param}')
