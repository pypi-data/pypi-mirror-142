...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:FREQuency:DEViation:AVERage \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.frequency.deviation.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:FREQuency:DEViation:AVERage? {param}')
