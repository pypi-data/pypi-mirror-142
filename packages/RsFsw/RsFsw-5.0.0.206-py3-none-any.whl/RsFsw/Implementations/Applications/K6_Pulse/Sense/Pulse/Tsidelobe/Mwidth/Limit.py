...
class Limit:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:TSIDelobe:MWIDth:LIMit \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.tsidelobe.mwidth.limit.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TSIDelobe:MWIDth:LIMit? {param}')
