...
class StandardDev:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:PHASe:POINt:SDEViation \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.phase.point.standardDev.get(query_range = enums.SelectionRangeB.ALL) \n
		Returns the statistical value for the phase at the measurement point over the specified pulses. \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:PHASe:POINt:SDEViation? {param}')
