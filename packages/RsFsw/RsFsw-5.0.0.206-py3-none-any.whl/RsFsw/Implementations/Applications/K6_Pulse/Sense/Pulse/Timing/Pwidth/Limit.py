...
class Limit:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:TIMing:PWIDth:LIMit \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.timing.pwidth.limit.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TIMing:PWIDth:LIMit? {param}')
