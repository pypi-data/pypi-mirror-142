...
class Auto:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k6Pulse.sense.frequency.center.step.auto.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: [SENSe]:FREQuency:CENTer:STEP:AUTO \n
		Snippet: value: bool = driver.applications.k6Pulse.sense.frequency.center.step.auto.get() \n
		This command couples or decouples the center frequency step size to the span. \n
