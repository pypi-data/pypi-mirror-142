...
class Time:
	...
	def set(self, time: float) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.trigger.sequence.holdoff.time.set(time = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: TRIGger[:SEQuence]:HOLDoff[:TIME] \n
		Snippet: value: float = driver.applications.k18AmplifierEt.trigger.sequence.holdoff.time.get() \n
		No command help available \n
