...
class Count:
	...
	def set(self, count: float) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.sweep.count.set(count = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:SWEep:COUNt \n
		Snippet: value: float = driver.applications.k18AmplifierEt.sense.sweep.count.get() \n
		No command help available \n
