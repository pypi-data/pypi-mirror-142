...
class Alternate:
	...
	def set(self, bandwidth: float, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SENSe]:POWer:ACHannel:SPACing:ALTernate<n> \n
		Snippet: driver.applications.k18AmplifierEt.sense.power.achannel.spacing.alternate.set(bandwidth = 1.0, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		"""SCPI: [SENSe]:POWer:ACHannel:SPACing:ALTernate<n> \n
		Snippet: value: float = driver.applications.k18AmplifierEt.sense.power.achannel.spacing.alternate.get(channel = repcap.Channel.Default) \n
		This command defines the distance from transmission channel to alternate channels. \n
			:param channel: optional repeated capability selector. Default value: Ch1 (settable in the interface 'Alternate')
