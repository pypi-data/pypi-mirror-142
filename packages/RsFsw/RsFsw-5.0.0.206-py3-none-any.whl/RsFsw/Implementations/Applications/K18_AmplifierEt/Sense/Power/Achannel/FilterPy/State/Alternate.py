...
class Alternate:
	...
	def set(self, value: bool, channel=repcap.Channel.Default) -> None:
		"""SCPI: [SENSe]:POWer:ACHannel:FILTer[:STATe]:ALTernate<n> \n
		Snippet: driver.applications.k18AmplifierEt.sense.power.achannel.filterPy.state.alternate.set(value = False, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> bool:
		"""SCPI: [SENSe]:POWer:ACHannel:FILTer[:STATe]:ALTernate<n> \n
		Snippet: value: bool = driver.applications.k18AmplifierEt.sense.power.achannel.filterPy.state.alternate.get(channel = repcap.Channel.Default) \n
		This command turns the weighting filter for an alternate channel on and off. \n
			:param channel: optional repeated capability selector. Default value: Ch1 (settable in the interface 'Alternate')
