...
class Threshold:
	...
	def set(self, arg_0: float) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.mixer.threshold.set(arg_0 = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:THReshold \n
		Snippet: value: float = driver.applications.k18AmplifierEt.sense.mixer.threshold.get() \n
		No command help available \n
