...
class Stop:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.mixer.frequency.stop.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:FREQuency:STOP \n
		Snippet: value: float = driver.applications.k18AmplifierEt.sense.mixer.frequency.stop.get() \n
		No command help available \n
