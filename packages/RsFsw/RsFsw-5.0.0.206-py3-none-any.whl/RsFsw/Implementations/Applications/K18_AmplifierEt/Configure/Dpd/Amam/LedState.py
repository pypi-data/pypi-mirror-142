...
class LedState:
	...
	def get(self) -> enums.LedState:
		"""SCPI: CONFigure:DPD:AMAM:LEDState \n
		Snippet: value: enums.LedState = driver.applications.k18AmplifierEt.configure.dpd.amam.ledState.get() \n
		This command queries the state of the calculation of the AM/AM distortion curve. \n
			:return: state: GREen Calculation was successful. GREY Unknown calculation state. RED Calculation was not successful."""
		response = self._core.io.query_str(f'CONFigure:DPD:AMAM:LEDState?')
