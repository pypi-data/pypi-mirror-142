...
class Connector:
	...
	def set(self, input_connectors: enums.InputConnector, inputIx=repcap.InputIx.Default) -> None:
		"""SCPI: INPut<ip>:CONNector \n
		Snippet: driver.applications.k18AmplifierEt.inputPy.connector.set(input_connectors = enums.InputConnector.AIQI, inputIx = repcap.InputIx.Default) \n
		...
		"""
		param = Conversions.enum_scalar_to_str(input_connectors, enums.InputConnector)
	...
	def get(self, inputIx=repcap.InputIx.Default) -> enums.InputConnector:
		"""SCPI: INPut<ip>:CONNector \n
		Snippet: value: enums.InputConnector = driver.applications.k18AmplifierEt.inputPy.connector.get(inputIx = repcap.InputIx.Default) \n
		Determines which connector the input for the measurement is taken from. For more information see 'Receiving Data Input
		and Providing Data Output'. \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
