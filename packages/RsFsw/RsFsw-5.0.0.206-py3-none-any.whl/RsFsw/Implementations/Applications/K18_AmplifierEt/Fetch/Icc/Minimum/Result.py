...
class Result:
	...
	def get(self) -> float:
		"""SCPI: FETCh:ICC:MINimum[:RESult] \n
		Snippet: value: float = driver.applications.k18AmplifierEt.fetch.icc.minimum.result.get() \n
		...
		response = self._core.io.query_str(f'FETCh:ICC:MINimum:RESult?')
