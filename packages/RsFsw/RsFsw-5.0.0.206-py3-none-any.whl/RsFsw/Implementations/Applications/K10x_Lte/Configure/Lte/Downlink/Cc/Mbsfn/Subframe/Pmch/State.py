...
class State:
	...
	def set(self, state: bool, carrierComponent=repcap.CarrierComponent.Default, subframe=repcap.Subframe.Default) -> None:
		...
		This command turns the PMCH in an MBSFN subframe on and off. Note that you first have to turn a subframe into an MBSFN
		subframe with method RsFsw.Applications.K10x_Lte.Configure.Lte.Downlink.Cc.Mbsfn.Subframe.State.set. \n
