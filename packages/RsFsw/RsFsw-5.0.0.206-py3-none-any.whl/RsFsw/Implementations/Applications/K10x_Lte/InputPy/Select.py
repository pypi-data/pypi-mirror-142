...
class Select:
	...
	def set(self, source: enums.BbInputSource, inputIx=repcap.InputIx.Default) -> None:
		...
		InputPy.TypePy.set. \n
			:param source: RF Radio Frequency ('RF INPUT' connector) FIQ I/Q data file (selected by method RsFsw.Applications.K6_Pulse.InputPy.File.Path.set) For details, see 'Basics on Input from I/Q Data Files'. Not available for Input2. DIQ Digital IQ data (only available with optional Digital Baseband Interface) For details on I/Q input see 'Digital Input'. Not available for Input2.
	...
	def get(self, inputIx=repcap.InputIx.Default) -> enums.BbInputSource:
		...
		InputPy.TypePy.set. \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
			:return: source: RF Radio Frequency ('RF INPUT' connector) FIQ I/Q data file (selected by method RsFsw.Applications.K6_Pulse.InputPy.File.Path.set) For details, see 'Basics on Input from I/Q Data Files'. Not available for Input2. DIQ Digital IQ data (only available with optional Digital Baseband Interface) For details on I/Q input see 'Digital Input'. Not available for Input2."""
		inputIx_cmd_val = self._cmd_group.get_repcap_cmd_value(inputIx, repcap.InputIx)
