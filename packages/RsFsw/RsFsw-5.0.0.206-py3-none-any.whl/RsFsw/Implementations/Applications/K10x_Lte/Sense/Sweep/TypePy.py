...
class TypePy:
	...
	def set(self, sweep_type: enums.SweepTypeNr5G) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.sweep.typePy.set(sweep_type = enums.SweepTypeNr5G.AUTO) \n
	...
	def get(self) -> enums.SweepTypeNr5G:
		"""SCPI: [SENSe]:SWEep:TYPE \n
		Snippet: value: enums.SweepTypeNr5G = driver.applications.k10Xlte.sense.sweep.typePy.get() \n
		No command help available \n
