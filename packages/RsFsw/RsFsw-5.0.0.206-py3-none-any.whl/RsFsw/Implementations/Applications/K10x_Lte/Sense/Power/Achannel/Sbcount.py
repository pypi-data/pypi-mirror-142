...
class Sbcount:
	...
	def set(self, number: float) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.power.achannel.sbcount.set(number = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:POWer:ACHannel:SBCount \n
		Snippet: value: float = driver.applications.k10Xlte.sense.power.achannel.sbcount.get() \n
		No command help available \n
