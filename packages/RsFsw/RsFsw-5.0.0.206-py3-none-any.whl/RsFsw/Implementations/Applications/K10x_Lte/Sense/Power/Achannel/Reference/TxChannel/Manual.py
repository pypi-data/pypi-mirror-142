...
class Manual:
	...
	def set(self, channel_number: float) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.power.achannel.reference.txChannel.manual.set(channel_number = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:POWer:ACHannel:REFerence:TXCHannel:MANual \n
		Snippet: value: float = driver.applications.k10Xlte.sense.power.achannel.reference.txChannel.manual.get() \n
		No command help available \n
