...
class Restore:
	...
	def set(self, subBlock=repcap.SubBlock.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.espectrum.preset.restore.set(subBlock = repcap.SubBlock.Default) \n
	...
	def set_with_opc(self, subBlock=repcap.SubBlock.Default, opc_timeout_ms: int = -1) -> None:
		subBlock_cmd_val = self._cmd_group.get_repcap_cmd_value(subBlock, repcap.SubBlock)
		"""SCPI: [SENSe]:ESPectrum<sb>:PRESet:RESTore \n
		Snippet: driver.applications.k10Xlte.sense.espectrum.preset.restore.set_with_opc(subBlock = repcap.SubBlock.Default) \n
		No command help available \n
