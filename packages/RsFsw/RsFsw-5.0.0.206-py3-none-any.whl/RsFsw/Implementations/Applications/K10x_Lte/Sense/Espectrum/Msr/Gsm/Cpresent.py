...
class Cpresent:
	...
	def set(self, state: bool, subBlock=repcap.SubBlock.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.espectrum.msr.gsm.cpresent.set(state = False, subBlock = repcap.SubBlock.Default) \n
	...
	def get(self, subBlock=repcap.SubBlock.Default) -> bool:
		"""SCPI: [SENSe]:ESPectrum<sb>:MSR:GSM:CPResent \n
		Snippet: value: bool = driver.applications.k10Xlte.sense.espectrum.msr.gsm.cpresent.get(subBlock = repcap.SubBlock.Default) \n
		No command help available \n
			:param subBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Espectrum')
