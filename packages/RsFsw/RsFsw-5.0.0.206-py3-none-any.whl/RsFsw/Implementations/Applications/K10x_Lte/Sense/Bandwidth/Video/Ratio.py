...
class Ratio:
	...
	def set(self, ratio: float) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.bandwidth.video.ratio.set(ratio = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:BWIDth:VIDeo:RATio \n
		Snippet: value: float = driver.applications.k10Xlte.sense.bandwidth.video.ratio.get() \n
		No command help available \n
