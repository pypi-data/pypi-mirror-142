...
class ClassPy:
	...
	def set(self, class_py: enums.RangeClass, subBlock=repcap.SubBlock.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.espectrum.msr.classPy.set(class_py = enums.RangeClass.LOCal, subBlock = repcap.SubBlock.Default) \n
	...
	def get(self, subBlock=repcap.SubBlock.Default) -> enums.RangeClass:
		"""SCPI: [SENSe]:ESPectrum<sb>:MSR:CLASs \n
		Snippet: value: enums.RangeClass = driver.applications.k10Xlte.sense.espectrum.msr.classPy.get(subBlock = repcap.SubBlock.Default) \n
		No command help available \n
			:param subBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Espectrum')
