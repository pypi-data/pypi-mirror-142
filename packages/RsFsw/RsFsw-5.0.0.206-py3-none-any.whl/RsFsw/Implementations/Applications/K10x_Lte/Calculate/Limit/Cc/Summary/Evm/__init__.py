...
class Evm:
	"""Evm commands group definition. 35 total commands, 27 Subgroups, 0 group commands"""
	...
	@property
	def dsqp(self):
		"""dsqp commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def dssf(self):
		"""dssf commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def dsst(self):
		"""dsst commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def dsts(self):
		"""dsts commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def ds1K(self):
		"""ds1K commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def psignal(self):
		"""psignal commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def sdqp(self):
		"""sdqp commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def sdst(self):
		"""sdst commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def uccd(self):
		"""uccd commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def ucch(self):
		"""ucch commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def upra(self):
		"""upra commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def usst(self):
		"""usst commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def usts(self):
		"""usts commands group. 1 Sub-classes, 0 commands."""
