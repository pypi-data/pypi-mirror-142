...
class Dsts:
	"""Dsts commands group definition. 3 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("dsts", core, parent)
	...
	def clone(self) -> 'Dsts':
		...
		new_group = Dsts(self._core, self._cmd_group.parent)
