...
class Rstp:
	"""Rstp commands group definition. 3 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("rstp", core, parent)
	...
	def clone(self) -> 'Rstp':
		...
		new_group = Rstp(self._core, self._cmd_group.parent)
