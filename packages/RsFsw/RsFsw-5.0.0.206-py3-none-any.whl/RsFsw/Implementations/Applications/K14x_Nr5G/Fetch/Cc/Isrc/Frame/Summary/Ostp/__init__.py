...
class Ostp:
	"""Ostp commands group definition. 3 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("ostp", core, parent)
	...
	def clone(self) -> 'Ostp':
		...
		new_group = Ostp(self._core, self._cmd_group.parent)
