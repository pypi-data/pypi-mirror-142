...
class Cc:
	"""Cc commands group definition. 125 total commands, 2 Subgroups, 0 group commands
	...
	@property
	def isrc(self):
		"""isrc commands group. 2 Sub-classes, 0 commands."""
		if not hasattr(self, '_isrc'):
			from .Isrc import Isrc
			self._isrc = Isrc(self._core, self._cmd_group)
		return self._isrc

	@property
	def plc(self):
		"""plc commands group. 1 Sub-classes, 0 commands."""
