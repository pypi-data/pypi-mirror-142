...
class Ss:
	"""Ss commands group definition. 3 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("ss", core, parent)
	...
	def clone(self) -> 'Ss':
		...
		new_group = Ss(self._core, self._cmd_group.parent)
