...
class All:
	...
	def get(self) -> float:
		"""SCPI: FETCh:ALL:SUMMary:EVM:ALL \n
		Snippet: value: float = driver.applications.k14Xnr5G.fetch.all.summary.evm.all.get() \n
		...
		response = self._core.io.query_str(f'FETCh:ALL:SUMMary:EVM:ALL?')
