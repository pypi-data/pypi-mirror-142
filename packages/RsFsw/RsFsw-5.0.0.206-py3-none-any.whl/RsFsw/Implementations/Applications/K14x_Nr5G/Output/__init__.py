...
class Output:
	"""Output commands group definition. 10 total commands, 3 Subgroups, 0 group commands
	...
	@property
	def ifreq(self):
		"""ifreq commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def trigger(self):
		"""trigger commands group. 4 Sub-classes, 1 commands."""
