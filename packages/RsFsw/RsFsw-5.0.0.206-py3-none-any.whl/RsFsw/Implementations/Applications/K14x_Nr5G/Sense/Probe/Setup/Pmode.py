...
class Pmode:
	...
	def set(self, mode: enums.ProbeMode, probe=repcap.Probe.Default) -> None:
		"""SCPI: [SENSe]:PROBe<p>:SETup:PMODe \n
		Snippet: driver.applications.k14Xnr5G.sense.probe.setup.pmode.set(mode = enums.ProbeMode.CM, probe = repcap.Probe.Default) \n
	...
	def get(self, probe=repcap.Probe.Default) -> enums.ProbeMode:
		"""SCPI: [SENSe]:PROBe<p>:SETup:PMODe \n
		Snippet: value: enums.ProbeMode = driver.applications.k14Xnr5G.sense.probe.setup.pmode.get(probe = repcap.Probe.Default) \n
		No command help available \n
			:param probe: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Probe')
