...
class Ratio:
	...
	def set(self, ratio: float) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.bandwidth.resolution.ratio.set(ratio = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:BWIDth[:RESolution]:RATio \n
		Snippet: value: float = driver.applications.k14Xnr5G.sense.bandwidth.resolution.ratio.get() \n
		No command help available \n
