...
class Band:
	...
	def set(self, range_py: enums.LowHigh, subBlock=repcap.SubBlock.Default) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.espectrum.msr.band.set(range_py = enums.LowHigh.HIGH, subBlock = repcap.SubBlock.Default) \n
	...
	def get(self, subBlock=repcap.SubBlock.Default) -> enums.LowHigh:
		"""SCPI: [SENSe]:ESPectrum<sb>:MSR:BAND \n
		Snippet: value: enums.LowHigh = driver.applications.k14Xnr5G.sense.espectrum.msr.band.get(subBlock = repcap.SubBlock.Default) \n
		No command help available \n
			:param subBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Espectrum')
