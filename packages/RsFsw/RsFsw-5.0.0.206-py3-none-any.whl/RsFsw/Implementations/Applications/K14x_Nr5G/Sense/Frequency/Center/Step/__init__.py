...
class Step:
	...
	def set(self, stepsize: float) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.frequency.center.step.set(stepsize = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:FREQuency:CENTer:STEP \n
		Snippet: value: float = driver.applications.k14Xnr5G.sense.frequency.center.step.get() \n
		This command defines the center frequency step size. \n
