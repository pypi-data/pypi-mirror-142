...
class Sense:
	"""Sense commands group definition. 293 total commands, 15 Subgroups, 0 group commands"""
	...
	@property
	def espectrum(self):
		"""espectrum commands group. 10 Sub-classes, 0 commands."""
	...
	@property
	def nr5G(self):
		"""nr5G commands group. 14 Sub-classes, 0 commands."""
	...
	@property
	def sweep(self):
		"""sweep commands group. 9 Sub-classes, 0 commands."""
