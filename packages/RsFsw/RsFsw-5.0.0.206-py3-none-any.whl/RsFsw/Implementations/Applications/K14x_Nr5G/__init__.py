...
class K14x_Nr5G:
	"""K14x_Nr5G commands group definition. 1204 total commands, 18 Subgroups, 0 group commands"""
	...
	@property
	def inputPy(self):
		"""inputPy commands group. 14 Sub-classes, 0 commands."""
	...
	@property
	def sense(self):
		"""sense commands group. 15 Sub-classes, 0 commands."""
	...
	def clone(self) -> 'K14x_Nr5G':
		"""Clones the group by creating new object from it and its whole existing subgroups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = K14x_Nr5G(self._core, self._cmd_group.parent)
