...
class State:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.inputPy.filterPy.yig.state.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: INPut:FILTer:YIG[:STATe] \n
		Snippet: value: bool = driver.applications.k14Xnr5G.inputPy.filterPy.yig.state.get() \n
		Enables or disables the YIG filter. \n
