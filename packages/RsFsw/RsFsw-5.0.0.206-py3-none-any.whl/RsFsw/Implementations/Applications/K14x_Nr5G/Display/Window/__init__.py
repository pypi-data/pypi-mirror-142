...
class Window:
	"""Window commands group definition. 27 total commands, 8 Subgroups, 0 group commands
	...
	@property
	def subwindow(self):
		"""subwindow commands group. 7 Sub-classes, 0 commands."""
	...
	@property
	def tab(self):
		"""tab commands group. 1 Sub-classes, 0 commands."""
		if not hasattr(self, '_tab'):
			from .Tab import Tab
			self._tab = Tab(self._core, self._cmd_group)
		return self._tab
	...
	@property
	def tpoo(self):
		"""tpoo commands group. 1 Sub-classes, 0 commands."""
		if not hasattr(self, '_tpoo'):
			from .Tpoo import Tpoo
			self._tpoo = Tpoo(self._core, self._cmd_group)
		return self._tpoo
