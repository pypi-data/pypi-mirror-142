...
class Slope:
	...
	def set(self, type_py: enums.SlopeType) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.trigger.sequence.slope.set(type_py = enums.SlopeType.NEGative) \n
	...
	def get(self) -> enums.SlopeType:
		"""SCPI: TRIGger[:SEQuence]:SLOPe \n
		Snippet: value: enums.SlopeType = driver.applications.k14Xnr5G.trigger.sequence.slope.get() \n
		This command selects the trigger slope. \n
