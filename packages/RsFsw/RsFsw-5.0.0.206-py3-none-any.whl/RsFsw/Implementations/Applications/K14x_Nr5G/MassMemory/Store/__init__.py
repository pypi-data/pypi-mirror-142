...
class Store:
	"""Store commands group definition. 11 total commands, 7 Subgroups, 0 group commands
	...
	@property
	def mservice(self):
		"""mservice commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_mservice'):
			from .Mservice import Mservice
			self._mservice = Mservice(self._core, self._cmd_group)
		return self._mservice
