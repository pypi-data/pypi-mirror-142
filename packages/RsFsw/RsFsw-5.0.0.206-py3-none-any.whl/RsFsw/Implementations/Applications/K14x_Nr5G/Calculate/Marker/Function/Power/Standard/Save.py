...
class Save:
	...
	def set(self, standard: str, window=repcap.Window.Default, marker=repcap.Marker.Default) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.calculate.marker.function.power.standard.save.set(standard = '1', window = repcap.Window.Default, marker = repcap.Marker.Default) \n
