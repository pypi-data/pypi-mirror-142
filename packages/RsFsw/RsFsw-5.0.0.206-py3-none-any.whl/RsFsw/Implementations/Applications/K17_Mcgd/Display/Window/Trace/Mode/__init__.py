...
class Mode:
	...
	def set(self, mode: enums.TraceModeC, window=repcap.Window.Default, trace=repcap.Trace.Default) -> None:
		...
		average trace mode, you can set the number of single measurements with 'Sweep Count'. Note that synchronization to the
		end of the measurement is possible only in single sweep mode. For more information see 'Analyzing Several Traces - Trace
		Mode'. \n
