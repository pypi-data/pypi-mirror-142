...
class TypePy:
	...
	def set(self, trace_1: enums.TraceModeA, trace_2: enums.TraceModeA, trace_3: enums.TraceModeA) -> None:
		"""SCPI: [SENSe]:ADEMod:SPECtrum:PHASe:TYPE \n
		Snippet: driver.applications.k17Mcgd.sense.ademod.spectrum.phase.typePy.set(trace_1 = enums.TraceModeA.AVERage, trace_2 = enums.TraceModeA.AVERage, trace_3 = enums.TraceModeA.AVERage) \n
		This command sets the modes of the first three traces of phase windows. Note that this command is maintained for
		compatibility reasons only. Use method RsFsw.Display.Window.Trace.Mode.set for new remote control programs. \n
		...
		self._core.io.write(f'SENSe:ADEMod:SPECtrum:PHASe:TYPE {param}'.rstrip())
	...
	def get(self) -> TypePyStruct:
		"""SCPI: [SENSe]:ADEMod:SPECtrum:PHASe:TYPE \n
		Snippet: value: TypePyStruct = driver.applications.k17Mcgd.sense.ademod.spectrum.phase.typePy.get() \n
		This command sets the modes of the first three traces of phase windows. Note that this command is maintained for
		compatibility reasons only. Use method RsFsw.Display.Window.Trace.Mode.set for new remote control programs. \n
			:return: structure: for return value, see the help for TypePyStruct structure arguments."""
		return self._core.io.query_struct(f'SENSe:ADEMod:SPECtrum:PHASe:TYPE?', self.__class__.TypePyStruct())
