...
class Mtime:
	...
	def set(self, meas_time: float) -> None:
		...
		This command queries or sets the measurement time. Note that this command is maintained for compatibility reasons only.
		Use [SENSe:]MTIMe for new remote control programs. \n
