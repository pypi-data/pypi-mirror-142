...
class Window:
	...
	def set(self, window_name: str, window_type: enums.WindowTypeK17) -> None:
		"""SCPI: LAYout:REPLace[:WINDow] \n
		Snippet: driver.applications.k17Mcgd.layout.replace.window.set(window_name = '1', window_type = enums.WindowTypeK17.Gain=GAIN) \n
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('window_name', window_name, DataType.String), ArgSingle('window_type', window_type, DataType.EnumExt, enums.WindowTypeK17))
