...
class Mode:
	...
	def set(self, auto_auto_level: enums.AutoManualMode) -> None:
		...
		This command selects the way the R&S FSW determines the length of the measurement . \n
			:param auto_auto_level: AUTO The R&S FSW determines the measurement length automatically according to the current input data. MANual The R&S FSW uses the measurement length defined by [SENSe:]ADJust:CONFigure:LEVel:DURation.
		"""
