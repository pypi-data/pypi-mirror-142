...
class Adroop:
	...
	def get(self, result_type: enums.ResultTypeStat, window=repcap.Window.Default, marker=repcap.Marker.Default) -> float:
		...
		This command queries the results of the amplitude droop error measurement performed for digital demodulation. The output
		values are the same as those provided in the Modulation Accuracy table (see 'Result summary') . \n
