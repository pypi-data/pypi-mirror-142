...
class Ports:
	...
	def set(self, port_type: int) -> None:
		...
		Snippet: driver.applications.k30NoiseFigure.sense.mixer.ports.set(port_type = 1) \n
	...
	def get(self) -> int:
		"""SCPI: [SENSe]:MIXer:PORTs \n
		Snippet: value: int = driver.applications.k30NoiseFigure.sense.mixer.ports.get() \n
		This command selects the mixer type. \n
