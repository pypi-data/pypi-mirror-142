...
class Low:
	...
	def set(self, arg_0: str) -> None:
		...
		Snippet: driver.applications.k40PhaseNoise.sense.mixer.loss.table.low.set(arg_0 = '1') \n
	...
	def get(self) -> str:
		"""SCPI: [SENSe]:MIXer:LOSS:TABLe[:LOW] \n
		Snippet: value: str = driver.applications.k40PhaseNoise.sense.mixer.loss.table.low.get() \n
		No command help available \n
