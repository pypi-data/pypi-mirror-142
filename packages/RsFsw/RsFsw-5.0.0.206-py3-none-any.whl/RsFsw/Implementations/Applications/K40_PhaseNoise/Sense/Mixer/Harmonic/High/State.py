...
class State:
	...
	def set(self, arg_0: bool) -> None:
		...
		Snippet: driver.applications.k40PhaseNoise.sense.mixer.harmonic.high.state.set(arg_0 = False) \n
	...
	def get(self) -> bool:
		"""SCPI: [SENSe]:MIXer:HARMonic:HIGH:STATe \n
		Snippet: value: bool = driver.applications.k40PhaseNoise.sense.mixer.harmonic.high.state.get() \n
		No command help available \n
