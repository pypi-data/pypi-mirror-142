...
class FormatPy:
	"""FormatPy commands group definition. 6 total commands, 2 Subgroups, 0 group commands"""
	...
	@property
	def dexport(self):
		"""dexport commands group. 5 Sub-classes, 0 commands."""
	...
	def dimport(self):
		...
		if not hasattr(self, '_dimport'):
			...
			self._dimport = Dimport(self._core, self._cmd_group)
