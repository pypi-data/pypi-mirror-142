...
class Coupling:
	...
	def set(self, coupling_type: enums.CouplingTypeA) -> None:
		"""SCPI: INPut:COUPling \n
		Snippet: driver.applications.k40PhaseNoise.inputPy.coupling.set(coupling_type = enums.CouplingTypeA.AC) \n
	...
	def get(self) -> enums.CouplingTypeA:
		"""SCPI: INPut:COUPling \n
		Snippet: value: enums.CouplingTypeA = driver.applications.k40PhaseNoise.inputPy.coupling.get() \n
		This command selects the coupling type of the RF input. \n
