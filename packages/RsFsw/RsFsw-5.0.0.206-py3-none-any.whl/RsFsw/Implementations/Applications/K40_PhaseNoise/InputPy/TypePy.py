...
class TypePy:
	...
	def set(self, input_py: enums.InputSelect, inputIx=repcap.InputIx.Default) -> None:
		"""SCPI: INPut<Undef>:TYPE \n
		Snippet: driver.applications.k40PhaseNoise.inputPy.typePy.set(input_py = enums.InputSelect.INPut1, inputIx = repcap.InputIx.Default) \n
	...
	def get(self, inputIx=repcap.InputIx.Default) -> enums.InputSelect:
		"""SCPI: INPut<Undef>:TYPE \n
		Snippet: value: enums.InputSelect = driver.applications.k40PhaseNoise.inputPy.typePy.get(inputIx = repcap.InputIx.Default) \n
		No command help available \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
