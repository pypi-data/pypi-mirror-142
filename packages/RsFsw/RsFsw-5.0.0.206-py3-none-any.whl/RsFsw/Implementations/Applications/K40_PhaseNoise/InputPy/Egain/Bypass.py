...
class Bypass:
	...
	def set(self, arg_0: bool, inputIx=repcap.InputIx.Default) -> None:
		"""SCPI: INPut<1|2>:EGAin:BYPass \n
		Snippet: driver.applications.k40PhaseNoise.inputPy.egain.bypass.set(arg_0 = False, inputIx = repcap.InputIx.Default) \n
	...
	def get(self, inputIx=repcap.InputIx.Default) -> bool:
		"""SCPI: INPut<1|2>:EGAin:BYPass \n
		Snippet: value: bool = driver.applications.k40PhaseNoise.inputPy.egain.bypass.get(inputIx = repcap.InputIx.Default) \n
		No command help available \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
