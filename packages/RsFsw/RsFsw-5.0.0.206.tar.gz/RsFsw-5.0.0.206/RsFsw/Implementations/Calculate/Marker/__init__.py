...
class Marker:
	"""Marker commands group definition. 151 total commands, 16 Subgroups, 0 group commands
	...
	@property
	def maximum(self):
		"""maximum commands group. 5 Sub-classes, 0 commands."""
	...
	@property
	def minimum(self):
		"""minimum commands group. 5 Sub-classes, 0 commands."""
	...
	@property
	def search(self):
		"""search commands group. 0 Sub-classes, 1 commands."""
	...
	@property
	def function(self):
		"""function commands group. 19 Sub-classes, 0 commands."""
