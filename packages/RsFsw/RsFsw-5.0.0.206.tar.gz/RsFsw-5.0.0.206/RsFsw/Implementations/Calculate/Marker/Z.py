...
class Z:
	...
	def get(self, window=repcap.Window.Default, marker=repcap.Marker.Default) -> float:
		...
		This command queries the z-axis value of the indicated marker in the persistence spectrum result display. You can select
		whether to query the results of the persistence trace or the maxhold trace with method RsFsw.Applications.K10x_Lte.
		Calculate.DeltaMarker.Trace.set. \n
