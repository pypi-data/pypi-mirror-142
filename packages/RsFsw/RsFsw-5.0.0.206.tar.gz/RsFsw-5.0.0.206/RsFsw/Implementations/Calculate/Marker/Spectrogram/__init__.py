...
class Spectrogram:
	"""Spectrogram commands group definition. 13 total commands, 4 Subgroups, 0 group commands"""
	...
	@property
	def y(self):
		"""y commands group. 3 Sub-classes, 0 commands."""
	...
	def xy(self):
		...
		if not hasattr(self, '_xy'):
			from .Xy import Xy
			self._xy = Xy(self._core, self._cmd_group)
		return self._xy
	...
	def sarea(self):
		...
		if not hasattr(self, '_sarea'):
			from .Sarea import Sarea
			self._sarea = Sarea(self._core, self._cmd_group)
		return self._sarea
