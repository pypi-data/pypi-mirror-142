...
class Cstate:
	...
	def get(self) -> enums.ControlState:
		"""SCPI: CONFigure:GENerator:NPRatio:STATe:CSTate \n
		Snippet: value: enums.ControlState = driver.configure.generator.npratio.state.cstate.get() \n
		...
		response = self._core.io.query_str(f'CONFigure:GENerator:NPRatio:STATe:CSTate?')
