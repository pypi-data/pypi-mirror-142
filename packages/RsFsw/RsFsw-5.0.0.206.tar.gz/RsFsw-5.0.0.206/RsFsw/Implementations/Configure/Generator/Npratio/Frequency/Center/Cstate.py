...
class Cstate:
	...
	def get(self) -> enums.ControlState:
		"""SCPI: CONFigure:GENerator:NPRatio:FREQuency:CENTer:CSTate \n
		Snippet: value: enums.ControlState = driver.configure.generator.npratio.frequency.center.cstate.get() \n
		...
		response = self._core.io.query_str(f'CONFigure:GENerator:NPRatio:FREQuency:CENTer:CSTate?')
