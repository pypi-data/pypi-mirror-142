...
class Cstate:
	...
	def get(self) -> enums.ControlState:
		"""SCPI: CONFigure:GENerator:NPRatio:POWer:LEVel:OFFSet:CSTate \n
		Snippet: value: enums.ControlState = driver.configure.generator.npratio.power.level.offset.cstate.get() \n
		...
		response = self._core.io.query_str(f'CONFigure:GENerator:NPRatio:POWer:LEVel:OFFSet:CSTate?')
