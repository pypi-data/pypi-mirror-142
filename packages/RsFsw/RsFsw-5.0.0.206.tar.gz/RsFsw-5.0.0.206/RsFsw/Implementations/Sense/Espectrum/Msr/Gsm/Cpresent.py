...
class Cpresent:
	...
	def set(self, state: bool, subBlock=repcap.SubBlock.Default) -> None:
		...
		This command defines whether a GSM/Edge carrier is located at the edge of the specified RF bandwidth. In this case, the
		specification demands specific limits for the SEM ranges. This command is only available for band category 2 (see
