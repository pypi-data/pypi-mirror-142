...
class Frequency:
	...
	def set(self, frequency: float, powerMeter=repcap.PowerMeter.Default) -> None:
		"""SCPI: [SENSe]:PMETer<p>:FREQuency \n
		Snippet: driver.sense.pmeter.frequency.set(frequency = 1.0, powerMeter = repcap.PowerMeter.Default) \n
		This command defines the frequency of the power sensor. \n
			:param frequency: The available value range is specified in the data sheet of the power sensor in use. Unit: HZ
	...
	def get(self, powerMeter=repcap.PowerMeter.Default) -> float:
		"""SCPI: [SENSe]:PMETer<p>:FREQuency \n
		Snippet: value: float = driver.sense.pmeter.frequency.get(powerMeter = repcap.PowerMeter.Default) \n
		This command defines the frequency of the power sensor. \n
			:param powerMeter: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Pmeter')
			:return: frequency: The available value range is specified in the data sheet of the power sensor in use. Unit: HZ"""
		powerMeter_cmd_val = self._cmd_group.get_repcap_cmd_value(powerMeter, repcap.PowerMeter)
