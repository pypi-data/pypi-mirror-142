...
class Channel:
	...
	def set(self, bandwidth: float, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.sense.power.achannel.bandwidth.channel.set(bandwidth = 1.0, channel = repcap.Channel.Default) \n
		This command defines the channel bandwidth of the transmission channels. Steep-edged channel filters are available for
		fast ACLR measurements. \n
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		"""SCPI: [SENSe]:POWer:ACHannel:BWIDth[:CHANnel<ch>] \n
		Snippet: value: float = driver.sense.power.achannel.bandwidth.channel.get(channel = repcap.Channel.Default) \n
		This command defines the channel bandwidth of the transmission channels. Steep-edged channel filters are available for
		fast ACLR measurements. \n
			:param channel: optional repeated capability selector. Default value: Ch1 (settable in the interface 'Channel')
