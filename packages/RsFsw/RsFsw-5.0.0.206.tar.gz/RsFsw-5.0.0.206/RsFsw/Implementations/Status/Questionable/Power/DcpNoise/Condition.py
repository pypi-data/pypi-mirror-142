...
class Condition:
	...
	def get(self) -> str:
		...
		Snippet: value: str = driver.status.questionable.power.dcpNoise.condition.get() \n
		No command help available \n
			:return: channel_name: No help available"""
		response = self._core.io.query_str(f'STATus:QUEStionable:POWer:DCPNoise:CONDition?')
