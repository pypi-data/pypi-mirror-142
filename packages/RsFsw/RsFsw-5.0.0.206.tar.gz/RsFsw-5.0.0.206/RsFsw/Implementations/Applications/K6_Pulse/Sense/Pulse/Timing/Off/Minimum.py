...
class Minimum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:TIMing:OFF:MINimum \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.timing.off.minimum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TIMing:OFF:MINimum? {param}')
