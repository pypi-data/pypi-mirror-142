...
class Point:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:PHASe:POINt \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.phase.point.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:PHASe:POINt? {param}')
