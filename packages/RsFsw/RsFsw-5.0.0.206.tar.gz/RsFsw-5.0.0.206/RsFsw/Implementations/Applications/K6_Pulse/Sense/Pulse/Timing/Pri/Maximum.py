...
class Maximum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:TIMing:PRI:MAXimum \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.timing.pri.maximum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TIMing:PRI:MAXimum? {param}')
