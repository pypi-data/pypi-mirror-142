...
class SymbolRate:
	...
	def get(self, outputConnector=repcap.OutputConnector.Default) -> int:
		"""SCPI: OUTPut<up>:IQHS:SRATe \n
		Snippet: value: int = driver.applications.k6Pulse.output.iqhs.symbolRate.get(outputConnector = repcap.OutputConnector.Default) \n
