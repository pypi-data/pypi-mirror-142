...
class StandardDev:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:PHASe:PPPHase:SDEViation \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.phase.ppPhase.standardDev.get(query_range = enums.SelectionRangeB.ALL) \n
		Returns the statistical value for the Pulse-Pulse Phase Difference over the specified pulses. \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:PHASe:PPPHase:SDEViation? {param}')
