...
class Start:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k6Pulse.sense.mixer.frequency.start.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:FREQuency:STARt \n
		Snippet: value: float = driver.applications.k6Pulse.sense.mixer.frequency.start.get() \n
		This command sets or queries the frequency at which the external mixer band starts. \n
