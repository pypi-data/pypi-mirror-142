...
class Low:
	...
	def set(self, freq_low: float) -> None:
		...
		Snippet: driver.applications.k6Pulse.sense.mixer.harmonic.low.set(freq_low = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:HARMonic[:LOW] \n
		Snippet: value: float = driver.applications.k6Pulse.sense.mixer.harmonic.low.get() \n
		This command specifies the harmonic order to be used for the low (first) range. \n
