...
class Perror:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:PHASe:PERRor \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.phase.perror.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:PHASe:PERRor? {param}')
