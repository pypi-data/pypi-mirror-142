...
class Pwidth:
	"""Pwidth commands group definition. 7 total commands, 6 Subgroups, 1 group commands"""
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:TIMing:PWIDth \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.timing.pwidth.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TIMing:PWIDth? {param}')
