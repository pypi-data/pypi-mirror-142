...
class Maximum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:POWer:RIPPle:DB:MAXimum \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.power.ripple.db.maximum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:POWer:RIPPle:DB:MAXimum? {param}')
