...
class Pcorrelation:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		...
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.tsidelobe.pcorrelation.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TSIDelobe:PCORrelation? {param}')
