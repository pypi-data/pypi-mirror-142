...
class Maximum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> str:
		"""SCPI: [SENSe]:PULSe:TIMing:FALL:MAXimum \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.timing.fall.maximum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:TIMing:FALL:MAXimum? {param}')
