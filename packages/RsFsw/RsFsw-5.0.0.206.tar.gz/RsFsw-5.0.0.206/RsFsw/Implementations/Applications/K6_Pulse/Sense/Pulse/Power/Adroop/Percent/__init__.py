...
class Percent:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:POWer:ADRoop[:PERCent] \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.power.adroop.percent.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:POWer:ADRoop:PERCent? {param}')
