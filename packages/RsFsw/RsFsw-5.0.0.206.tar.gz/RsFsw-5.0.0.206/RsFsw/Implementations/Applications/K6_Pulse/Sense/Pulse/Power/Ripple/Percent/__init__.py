...
class Percent:
	...
	def get(self, query_range: enums.SelectionRange) -> str:
		"""SCPI: [SENSe]:PULSe:POWer:RIPPle[:PERCent] \n
		Snippet: value: str = driver.applications.k6Pulse.sense.pulse.power.ripple.percent.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:PULSe:POWer:RIPPle:PERCent? {param}')
