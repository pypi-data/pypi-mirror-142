...
class Calibration:
	"""Calibration commands group definition. 2 total commands, 1 Subgroups, 0 group commands"""
	...
	@property
	def mcgd(self):
		"""mcgd commands group. 1 Sub-classes, 1 commands."""
		if not hasattr(self, '_mcgd'):
			from .Mcgd import Mcgd
			self._mcgd = Mcgd(self._core, self._cmd_group)
		return self._mcgd
