...
class State:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k17Mcgd.configure.generator.rfOutput.state.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: CONFigure:GENerator:RFOutput[:STATe] \n
		Snippet: value: bool = driver.applications.k17Mcgd.configure.generator.rfOutput.state.get() \n
		This command enables or disables RF output on the connected generator. \n
