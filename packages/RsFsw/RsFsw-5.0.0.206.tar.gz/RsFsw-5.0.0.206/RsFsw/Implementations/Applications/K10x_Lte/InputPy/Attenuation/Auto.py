...
class Auto:
	...
	def set(self, state: bool, inputIx=repcap.InputIx.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.inputPy.attenuation.auto.set(state = False, inputIx = repcap.InputIx.Default) \n
	...
	def get(self, inputIx=repcap.InputIx.Default) -> bool:
		"""SCPI: INPut<ip>:ATTenuation:AUTO \n
		Snippet: value: bool = driver.applications.k10Xlte.inputPy.attenuation.auto.get(inputIx = repcap.InputIx.Default) \n
		This command couples and decouples the RF attenuation to the reference level. \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
