...
class Gap:
	"""Gap commands group definition. 1 total commands, 1 Subgroups, 0 group commands
	...
	@property
	def msize(self):
		"""msize commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_msize'):
			from .Msize import Msize
			self._msize = Msize(self._core, self._cmd_group)
		return self._msize
