...
class Cc:
	"""Cc commands group definition. 3 total commands, 2 Subgroups, 0 group commands
	...
	def demodSetting(self):
		"""demodSetting commands group. 0 Sub-classes, 1 commands."""
	...
	@property
	def tmod(self):
		"""tmod commands group. 2 Sub-classes, 0 commands."""
