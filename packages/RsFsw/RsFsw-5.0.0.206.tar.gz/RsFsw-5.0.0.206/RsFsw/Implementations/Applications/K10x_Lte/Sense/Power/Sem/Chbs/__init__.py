...
class Chbs:
	"""Chbs commands group definition. 2 total commands, 1 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("chbs", core, parent)
	...
	def clone(self) -> 'Chbs':
		...
		new_group = Chbs(self._core, self._cmd_group.parent)
