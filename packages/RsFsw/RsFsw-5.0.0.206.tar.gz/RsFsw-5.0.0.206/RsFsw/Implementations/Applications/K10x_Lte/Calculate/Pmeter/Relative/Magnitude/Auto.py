...
class Auto:
	...
	def set(self, once: enums.EventOnce, window=repcap.Window.Default, powerMeter=repcap.PowerMeter.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.calculate.pmeter.relative.magnitude.auto.set(once = enums.EventOnce.ONCE, window = repcap.Window.Default, powerMeter = repcap.PowerMeter.Default) \n
