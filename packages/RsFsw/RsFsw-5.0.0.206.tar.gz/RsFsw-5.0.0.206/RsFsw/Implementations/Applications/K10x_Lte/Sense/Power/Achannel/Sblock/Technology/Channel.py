...
class Channel:
	...
	def set(self, standard: enums.StandardNr5G, subBlock=repcap.SubBlock.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.power.achannel.sblock.technology.channel.set(standard = enums.StandardNr5G.GSM, subBlock = repcap.SubBlock.Default, channel = repcap.Channel.Default) \n
	...
	def get(self, subBlock=repcap.SubBlock.Default, channel=repcap.Channel.Default) -> enums.StandardNr5G:
		"""SCPI: [SENSe]:POWer:ACHannel:SBLock<sb>:TECHnology[:CHANnel<ch>] \n
		Snippet: value: enums.StandardNr5G = driver.applications.k10Xlte.sense.power.achannel.sblock.technology.channel.get(subBlock = repcap.SubBlock.Default, channel = repcap.Channel.Default) \n
		No command help available \n
			:param subBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Sblock')
			:param channel: optional repeated capability selector. Default value: Ch1 (settable in the interface 'Channel')
