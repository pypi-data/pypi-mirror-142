...
class Sequence:
	"""Sequence commands group definition. 18 total commands, 12 Subgroups, 0 group commands"""
	...
	@property
	def level(self):
		"""level commands group. 6 Sub-classes, 0 commands."""
	...
	@property
	def smSetting(self):
		"""smSetting commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_smSetting'):
			from .SmSetting import SmSetting
			self._smSetting = SmSetting(self._core, self._cmd_group)
		return self._smSetting
