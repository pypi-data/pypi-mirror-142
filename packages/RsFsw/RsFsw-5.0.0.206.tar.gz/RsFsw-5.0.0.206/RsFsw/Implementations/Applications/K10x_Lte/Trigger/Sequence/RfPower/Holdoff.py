...
class Holdoff:
	...
	def set(self, time: float) -> None:
		...
		Snippet: driver.applications.k10Xlte.trigger.sequence.rfPower.holdoff.set(time = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: TRIGger[:SEQuence]:RFPower:HOLDoff \n
		Snippet: value: float = driver.applications.k10Xlte.trigger.sequence.rfPower.holdoff.get() \n
		No command help available \n
