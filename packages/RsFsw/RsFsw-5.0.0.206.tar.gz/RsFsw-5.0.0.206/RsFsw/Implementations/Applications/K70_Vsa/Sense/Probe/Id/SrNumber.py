...
class SrNumber:
	...
	def get(self, probe=repcap.Probe.Default) -> str:
		...
		Snippet: value: str = driver.applications.k70Vsa.sense.probe.id.srNumber.get(probe = repcap.Probe.Default) \n
		Queries the serial number of the probe. \n
			:param probe: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Probe')
			:return: serial_number: 1..n Selects the connector: 1 = Baseband Input I 2 = Baseband Input Q 3 = RF"""
