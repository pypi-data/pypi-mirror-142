...
class InputPy:
	"""InputPy commands group definition. 30 total commands, 14 Subgroups, 0 group commands
	...
	def lisn(self):
		...
		if not hasattr(self, '_lisn'):
			from .Lisn import Lisn
			self._lisn = Lisn(self._core, self._cmd_group)
		return self._lisn
	...
	@property
	def eatt(self):
		"""eatt commands group. 2 Sub-classes, 0 commands."""
