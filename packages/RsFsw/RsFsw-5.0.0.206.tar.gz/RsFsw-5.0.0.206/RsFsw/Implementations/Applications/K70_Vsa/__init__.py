...
class K70_Vsa:
	"""K70_Vsa commands group definition. 566 total commands, 14 Subgroups, 0 group commands"""
	...
	@property
	def sense(self):
		"""sense commands group. 12 Sub-classes, 0 commands."""
	...
	def clone(self) -> 'K70_Vsa':
		"""Clones the group by creating new object from it and its whole existing subgroups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = K70_Vsa(self._core, self._cmd_group.parent)
