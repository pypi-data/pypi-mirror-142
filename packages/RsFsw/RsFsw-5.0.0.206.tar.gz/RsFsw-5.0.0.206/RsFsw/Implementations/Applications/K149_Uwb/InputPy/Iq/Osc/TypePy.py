...
class TypePy:
	...
	def set(self, type_py: enums.IqType, inputIx=repcap.InputIx.Default) -> None:
		...
		Snippet: driver.applications.k149Uwb.inputPy.iq.osc.typePy.set(type_py = enums.IqType.Ipart=I, inputIx = repcap.InputIx.Default) \n
	...
	def get(self, inputIx=repcap.InputIx.Default) -> enums.IqType:
		"""SCPI: INPut<ip>:IQ:OSC:TYPE \n
		Snippet: value: enums.IqType = driver.applications.k149Uwb.inputPy.iq.osc.typePy.get(inputIx = repcap.InputIx.Default) \n
		No command help available \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
