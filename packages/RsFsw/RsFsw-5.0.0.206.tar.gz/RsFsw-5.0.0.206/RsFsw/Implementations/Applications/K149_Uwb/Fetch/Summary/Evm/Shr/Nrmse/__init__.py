...
class Nrmse:
	...
	def get(self, window=repcap.Window.Default) -> float:
		"""SCPI: FETCh<n>:SUMMary:EVM:SHR:NRMSe \n
		Snippet: value: float = driver.applications.k149Uwb.fetch.summary.evm.shr.nrmse.get(window = repcap.Window.Default) \n
		...
		response = self._core.io.query_str(f'FETCh{window_cmd_val}:SUMMary:EVM:SHR:NRMSe?')
