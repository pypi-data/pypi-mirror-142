...
class Passed:
	...
	def get(self, window=repcap.Window.Default) -> str:
		"""SCPI: FETCh<n>:SUMMary:SPECtrum:MASK:PASSed \n
		Snippet: value: str = driver.applications.k149Uwb.fetch.summary.spectrum.mask.passed.get(window = repcap.Window.Default) \n
		...
		response = self._core.io.query_str(f'FETCh{window_cmd_val}:SUMMary:SPECtrum:MASK:PASSed?')
