...
class Handover:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.mixer.frequency.handover.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:FREQuency:HANDover \n
		Snippet: value: float = driver.applications.k14Xnr5G.sense.mixer.frequency.handover.get() \n
		No command help available \n
