...
class State:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.power.ncorrection.calibration.state.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: [SENSe]:POWer:NCORrection:CALibration:STATe \n
		Snippet: value: bool = driver.applications.k14Xnr5G.sense.power.ncorrection.calibration.state.get() \n
		No command help available \n
