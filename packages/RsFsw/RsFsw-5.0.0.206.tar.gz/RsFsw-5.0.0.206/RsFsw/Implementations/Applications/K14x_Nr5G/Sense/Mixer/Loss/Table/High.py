...
class High:
	...
	def set(self, filename: str) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.mixer.loss.table.high.set(filename = '1') \n
	...
	def get(self) -> str:
		"""SCPI: [SENSe]:MIXer:LOSS:TABLe:HIGH \n
		Snippet: value: str = driver.applications.k14Xnr5G.sense.mixer.loss.table.high.get() \n
		No command help available \n
