...
class Level:
	...
	def set(self, level: float) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.demod.squelch.level.set(level = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:DEMod:SQUelch:LEVel \n
		Snippet: value: float = driver.applications.k14Xnr5G.sense.demod.squelch.level.get() \n
		No command help available \n
