...
class State:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.calibration.aiq.haTiming.state.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: CALibration:AIQ:HATiming[:STATe] \n
		Snippet: value: bool = driver.applications.k14Xnr5G.calibration.aiq.haTiming.state.get() \n
		Activates a mode with enhanced timing accuracy between analog baseband, RF and external trigger signals.
		For more information see 'High-accuracy timing'. \n
