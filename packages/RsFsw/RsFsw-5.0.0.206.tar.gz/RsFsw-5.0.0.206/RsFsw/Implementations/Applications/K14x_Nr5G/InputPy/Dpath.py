...
class Dpath:
	...
	def set(self, state: enums.AutoOrOff) -> None:
		"""SCPI: INPut:DPATh \n
		Snippet: driver.applications.k14Xnr5G.inputPy.dpath.set(state = enums.AutoOrOff.AUTO) \n
	...
	def get(self) -> enums.AutoOrOff:
		"""SCPI: INPut:DPATh \n
		Snippet: value: enums.AutoOrOff = driver.applications.k14Xnr5G.inputPy.dpath.get() \n
		Enables or disables the use of the direct path for frequencies close to 0 Hz. \n
