...
class Start:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.mixer.frequency.start.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:FREQuency:STARt \n
		Snippet: value: float = driver.applications.k14Xnr5G.sense.mixer.frequency.start.get() \n
		No command help available \n
