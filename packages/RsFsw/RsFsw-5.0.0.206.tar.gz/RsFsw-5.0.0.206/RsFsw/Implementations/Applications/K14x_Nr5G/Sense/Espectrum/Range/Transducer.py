...
class Transducer:
	...
	def set(self, transducer: str, subBlock=repcap.SubBlock.Default, rangePy=repcap.RangePy.Default) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.espectrum.range.transducer.set(transducer = '1', subBlock = repcap.SubBlock.Default, rangePy = repcap.RangePy.Default) \n
	...
	def get(self, subBlock=repcap.SubBlock.Default, rangePy=repcap.RangePy.Default) -> str:
		"""SCPI: [SENSe]:ESPectrum<sb>:RANGe<range>:TRANsducer \n
		Snippet: value: str = driver.applications.k14Xnr5G.sense.espectrum.range.transducer.get(subBlock = repcap.SubBlock.Default, rangePy = repcap.RangePy.Default) \n
		No command help available \n
			:param subBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Espectrum')
			:param rangePy: optional repeated capability selector. Default value: Ix1 (settable in the interface 'Range')
