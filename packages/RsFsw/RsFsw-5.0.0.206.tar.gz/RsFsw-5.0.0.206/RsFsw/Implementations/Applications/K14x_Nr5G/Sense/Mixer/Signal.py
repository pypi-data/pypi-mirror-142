...
class Signal:
	...
	def set(self, state: enums.State) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.mixer.signal.set(state = enums.State.ALL) \n
	...
	def get(self) -> enums.State:
		"""SCPI: [SENSe]:MIXer:SIGNal \n
		Snippet: value: enums.State = driver.applications.k14Xnr5G.sense.mixer.signal.get() \n
		No command help available \n
