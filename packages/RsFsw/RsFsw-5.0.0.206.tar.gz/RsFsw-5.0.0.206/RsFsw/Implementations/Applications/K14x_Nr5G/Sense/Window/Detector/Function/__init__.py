...
class Function:
	...
	def set(self, detector: enums.Detector, window=repcap.Window.Default, trace=repcap.Trace.Default) -> None:
	...
	def get(self, window=repcap.Window.Default, trace=repcap.Trace.Default) -> enums.Detector:
		"""SCPI: [SENSe][:WINDow<n>]:DETector<t>[:FUNCtion] \n
