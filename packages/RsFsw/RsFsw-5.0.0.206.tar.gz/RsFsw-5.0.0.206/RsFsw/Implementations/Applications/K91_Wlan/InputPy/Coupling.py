...
class Coupling:
	...
	def set(self, coupling_type: enums.CouplingTypeA, inputIx=repcap.InputIx.Default) -> None:
		...
		Snippet: driver.applications.k91Wlan.inputPy.coupling.set(coupling_type = enums.CouplingTypeA.AC, inputIx = repcap.InputIx.Default) \n
	...
	def get(self, inputIx=repcap.InputIx.Default) -> enums.CouplingTypeA:
		"""SCPI: INPut<Undef>:COUPling \n
		Snippet: value: enums.CouplingTypeA = driver.applications.k91Wlan.inputPy.coupling.get(inputIx = repcap.InputIx.Default) \n
		This command selects the coupling type of the RF input. \n
			:param inputIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'InputPy')
