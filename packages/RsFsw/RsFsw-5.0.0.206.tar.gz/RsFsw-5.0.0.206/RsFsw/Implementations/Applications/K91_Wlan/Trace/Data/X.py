...
class X:
	...
	def get(self, trace_type: enums.TraceTypeNumeric, window=repcap.Window.Default) -> List[float]:
		"""SCPI: TRACe<n>[:DATA]:X \n
		Snippet: value: List[float] = driver.applications.k91Wlan.trace.data.x.get(trace_type = enums.TraceTypeNumeric.TRACe1, window = repcap.Window.Default) \n
		...
		x-values, e.g. for SEM or Spurious Emissions measurements. \n
