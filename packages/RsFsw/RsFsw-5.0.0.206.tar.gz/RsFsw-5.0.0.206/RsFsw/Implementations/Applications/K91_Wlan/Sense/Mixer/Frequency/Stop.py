...
class Stop:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k91Wlan.sense.mixer.frequency.stop.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:FREQuency:STOP \n
		Snippet: value: float = driver.applications.k91Wlan.sense.mixer.frequency.stop.get() \n
		This command sets or queries the frequency at which the external mixer band stops. \n
