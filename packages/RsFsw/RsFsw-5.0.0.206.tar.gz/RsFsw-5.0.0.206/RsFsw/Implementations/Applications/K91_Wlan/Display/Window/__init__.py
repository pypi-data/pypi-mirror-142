...
class Window:
	"""Window commands group definition. 45 total commands, 6 Subgroups, 0 group commands
	...
	@property
	def subwindow(self):
		"""subwindow commands group. 4 Sub-classes, 0 commands."""
	...
	@property
	def flags(self):
		"""flags commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_flags'):
			from .Flags import Flags
			self._flags = Flags(self._core, self._cmd_group)
		return self._flags
