...
class Auto:
	...
	def set(self, ref_channel: enums.RefChannel) -> None:
		...
		Snippet: driver.applications.k91Wlan.sense.power.achannel.reference.txChannel.auto.set(ref_channel = enums.RefChannel.LHIGhest) \n
	...
	def get(self) -> enums.RefChannel:
		"""SCPI: [SENSe]:POWer:ACHannel:REFerence:TXCHannel:AUTO \n
		Snippet: value: enums.RefChannel = driver.applications.k91Wlan.sense.power.achannel.reference.txChannel.auto.get() \n
		No command help available \n
