...
class Ieee:
	"""Ieee commands group definition. 3 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("ieee", core, parent)
	...
	def clone(self) -> 'Ieee':
		...
		new_group = Ieee(self._core, self._cmd_group.parent)
