...
class Alternate:
	...
	def set(self, spacing: float, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.applications.k91Wlan.sense.power.achannel.spacing.alternate.set(spacing = 1.0, channel = repcap.Channel.Default) \n
	...
	def get(self, channel=repcap.Channel.Default) -> float:
		"""SCPI: [SENSe]:POWer:ACHannel:SPACing:ALTernate<ch> \n
		Snippet: value: float = driver.applications.k91Wlan.sense.power.achannel.spacing.alternate.get(channel = repcap.Channel.Default) \n
		No command help available \n
			:param channel: optional repeated capability selector. Default value: Ch1 (settable in the interface 'Alternate')
