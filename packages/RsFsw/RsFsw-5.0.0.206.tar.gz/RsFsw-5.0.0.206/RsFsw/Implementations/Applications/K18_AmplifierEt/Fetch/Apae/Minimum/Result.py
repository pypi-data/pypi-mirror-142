...
class Result:
	...
	def get(self) -> float:
		"""SCPI: FETCh:APAE:MINimum[:RESult] \n
		Snippet: value: float = driver.applications.k18AmplifierEt.fetch.apae.minimum.result.get() \n
		...
		response = self._core.io.query_str(f'FETCh:APAE:MINimum:RESult?')
