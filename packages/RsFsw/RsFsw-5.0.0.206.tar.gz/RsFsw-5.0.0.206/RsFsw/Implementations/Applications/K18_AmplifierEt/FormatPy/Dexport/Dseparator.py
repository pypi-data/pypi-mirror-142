...
class Dseparator:
	...
	def set(self, separator: enums.Separator) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.formatPy.dexport.dseparator.set(separator = enums.Separator.COMMa) \n
	...
	def get(self) -> enums.Separator:
		"""SCPI: FORMat:DEXPort:DSEParator \n
		Snippet: value: enums.Separator = driver.applications.k18AmplifierEt.formatPy.dexport.dseparator.get() \n
		This command selects the decimal separator for data exported in ASCII format. \n
