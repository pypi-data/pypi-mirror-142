...
class Vfirmware:
	...
	def set(self, valid_device: bool) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.system.communicate.rdevice.oscilloscope.vfirmware.set(valid_device = False) \n
	...
	def get(self) -> bool:
		"""SCPI: SYSTem:COMMunicate:RDEVice:OSCilloscope:VFIRmware \n
		Snippet: value: bool = driver.applications.k18AmplifierEt.system.communicate.rdevice.oscilloscope.vfirmware.get() \n
		No command help available \n
