...
class Handover:
	...
	def set(self, arg_0: float) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.mixer.frequency.handover.set(arg_0 = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:FREQuency:HANDover \n
		Snippet: value: float = driver.applications.k18AmplifierEt.sense.mixer.frequency.handover.get() \n
		No command help available \n
