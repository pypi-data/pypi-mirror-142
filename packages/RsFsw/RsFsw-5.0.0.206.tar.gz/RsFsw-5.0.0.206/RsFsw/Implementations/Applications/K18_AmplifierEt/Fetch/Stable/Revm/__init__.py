...
class Revm:
	"""Revm commands group definition. 15 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("revm", core, parent)
	...
	def clone(self) -> 'Revm':
		...
		new_group = Revm(self._core, self._cmd_group.parent)
