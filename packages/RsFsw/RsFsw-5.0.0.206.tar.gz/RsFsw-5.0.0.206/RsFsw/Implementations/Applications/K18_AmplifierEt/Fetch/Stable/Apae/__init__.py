...
class Apae:
	"""Apae commands group definition. 15 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("apae", core, parent)
	...
	def clone(self) -> 'Apae':
		...
		new_group = Apae(self._core, self._cmd_group.parent)
