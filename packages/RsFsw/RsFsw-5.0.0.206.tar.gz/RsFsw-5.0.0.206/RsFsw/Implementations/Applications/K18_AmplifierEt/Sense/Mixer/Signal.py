...
class Signal:
	...
	def set(self, arg_0: enums.State) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.mixer.signal.set(arg_0 = enums.State.ALL) \n
	...
	def get(self) -> enums.State:
		"""SCPI: [SENSe]:MIXer:SIGNal \n
		Snippet: value: enums.State = driver.applications.k18AmplifierEt.sense.mixer.signal.get() \n
		No command help available \n
