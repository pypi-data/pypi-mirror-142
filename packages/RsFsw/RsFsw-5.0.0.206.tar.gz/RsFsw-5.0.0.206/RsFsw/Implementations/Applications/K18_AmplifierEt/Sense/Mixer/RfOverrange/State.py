...
class State:
	...
	def set(self, arg_0: bool) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.mixer.rfOverrange.state.set(arg_0 = False) \n
	...
	def get(self) -> bool:
		"""SCPI: [SENSe]:MIXer:RFOVerrange[:STATe] \n
		Snippet: value: bool = driver.applications.k18AmplifierEt.sense.mixer.rfOverrange.state.get() \n
		No command help available \n
