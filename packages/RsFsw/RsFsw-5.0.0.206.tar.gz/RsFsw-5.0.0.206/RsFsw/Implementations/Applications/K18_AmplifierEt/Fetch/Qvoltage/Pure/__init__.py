...
class Pure:
	"""Pure commands group definition. 3 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("pure", core, parent)
	...
	def clone(self) -> 'Pure':
		...
		new_group = Pure(self._core, self._cmd_group.parent)
