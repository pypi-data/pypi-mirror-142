...
class Falignment:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.system.communicate.rdevice.oscilloscope.alignment.falignment.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: SYSTem:COMMunicate:RDEVice:OSCilloscope:ALIGnment:FALignment \n
		Snippet: value: bool = driver.applications.k18AmplifierEt.system.communicate.rdevice.oscilloscope.alignment.falignment.get() \n
		No command help available \n
