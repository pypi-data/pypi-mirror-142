...
class Low:
	...
	def set(self, arg_0: float) -> None:
		...
		Snippet: driver.applications.k18AmplifierEt.sense.mixer.harmonic.low.set(arg_0 = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:HARMonic[:LOW] \n
		Snippet: value: float = driver.applications.k18AmplifierEt.sense.mixer.harmonic.low.get() \n
		No command help available \n
