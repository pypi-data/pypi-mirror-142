...
class Configure:
	"""Configure commands group definition. 5 total commands, 3 Subgroups, 0 group commands"""
	...
	@property
	def edmg(self):
		"""edmg commands group. 3 Sub-classes, 0 commands."""
		if not hasattr(self, '_edmg'):
			from .Edmg import Edmg
			self._edmg = Edmg(self._core, self._cmd_group)
		return self._edmg
