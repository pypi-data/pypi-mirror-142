...
class Auto:
	...
	def set(self, arg_0: enums.EventOnce, powerMeter=repcap.PowerMeter.Default) -> None:
		"""SCPI: CALibration:PMETer<p>:ZERO:AUTO \n
		Snippet: driver.applications.k9X11Ad.calibration.pmeter.zero.auto.set(arg_0 = enums.EventOnce.ONCE, powerMeter = repcap.PowerMeter.Default) \n
