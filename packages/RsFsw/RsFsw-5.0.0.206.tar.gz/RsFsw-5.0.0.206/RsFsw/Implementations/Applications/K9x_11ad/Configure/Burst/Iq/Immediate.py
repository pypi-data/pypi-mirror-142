...
class Immediate:
	...
	def set(self) -> None:
		...
		Snippet: driver.applications.k9X11Ad.configure.burst.iq.immediate.set() \n
		No command help available \n
		"""
		self._core.io.write(f'CONFigure:BURSt:IQ:IMMediate')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: CONFigure:BURSt:IQ[:IMMediate] \n
		Snippet: driver.applications.k9X11Ad.configure.burst.iq.immediate.set_with_opc() \n
		No command help available \n
