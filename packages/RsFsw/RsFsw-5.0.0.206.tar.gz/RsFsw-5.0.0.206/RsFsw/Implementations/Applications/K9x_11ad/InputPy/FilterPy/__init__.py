...
class FilterPy:
	...
	@property
	def achannels(self):
		"""achannels commands group. 1 Sub-classes, 0 commands."""
		if not hasattr(self, '_achannels'):
			from .Achannels import Achannels
			self._achannels = Achannels(self._core, self._cmd_group)
