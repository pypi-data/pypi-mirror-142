...
class Slope:
	...
	def set(self, slope: enums.SlopeType) -> None:
		...
		Snippet: driver.applications.k9X11Ad.trigger.sequence.slope.set(slope = enums.SlopeType.NEGative) \n
	...
	def get(self) -> enums.SlopeType:
		"""SCPI: TRIGger[:SEQuence]:SLOPe \n
		Snippet: value: enums.SlopeType = driver.applications.k9X11Ad.trigger.sequence.slope.get() \n
		No command help available \n
