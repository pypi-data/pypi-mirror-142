...
class State:
	...
	def set(self, rf_overrange_state: bool) -> None:
		...
		Snippet: driver.applications.k9X11Ad.sense.mixer.rfOverrange.state.set(rf_overrange_state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: [SENSe]:MIXer:RFOVerrange[:STATe] \n
		Snippet: value: bool = driver.applications.k9X11Ad.sense.mixer.rfOverrange.state.get() \n
		If enabled, the band limits are extended beyond 'RF Start' and 'RF Stop' due to the capabilities of the used harmonics. \n
