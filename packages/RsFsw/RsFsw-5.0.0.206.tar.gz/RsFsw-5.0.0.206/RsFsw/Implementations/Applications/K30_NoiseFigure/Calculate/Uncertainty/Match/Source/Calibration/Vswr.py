...
class Vswr:
	...
	def set(self, vswr: float, window=repcap.Window.Default) -> None:
		...
		This command defines the VSWR at the calibration noise source output.
		This command is available when [SENSe:]CORRection:ENR:COMMon and method RsFsw.Applications.K30_NoiseFigure.Calculate.
		Uncertainty.Common.set are off. If a smart noise source is used, the VSWR values defined in the SNS table are used. \n
			:param vswr: 1..n
