...
class Low:
	...
	def set(self, average: float) -> None:
		...
		Snippet: driver.applications.k30NoiseFigure.sense.mixer.loss.low.set(average = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:LOSS[:LOW] \n
		Snippet: value: float = driver.applications.k30NoiseFigure.sense.mixer.loss.low.get() \n
		This command defines the average conversion loss to be used for the entire low (first) range. \n
