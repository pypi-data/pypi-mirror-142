...
class Low:
	...
	def set(self, harm_order: float) -> None:
		...
		Snippet: driver.applications.k30NoiseFigure.sense.mixer.harmonic.low.set(harm_order = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:HARMonic[:LOW] \n
		Snippet: value: float = driver.applications.k30NoiseFigure.sense.mixer.harmonic.low.get() \n
		This command specifies the harmonic order to be used for the low (first) range. \n
