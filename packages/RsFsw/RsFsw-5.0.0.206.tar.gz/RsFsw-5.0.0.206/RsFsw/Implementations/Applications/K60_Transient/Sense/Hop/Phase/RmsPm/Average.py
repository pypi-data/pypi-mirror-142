...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:HOP:PHASe:RMSPm:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.phase.rmsPm.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:PHASe:RMSPm:AVERage? {param}')
