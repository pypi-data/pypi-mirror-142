...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:PHASe:MAXPm:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.phase.maxPm.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:PHASe:MAXPm:AVERage? {param}')
