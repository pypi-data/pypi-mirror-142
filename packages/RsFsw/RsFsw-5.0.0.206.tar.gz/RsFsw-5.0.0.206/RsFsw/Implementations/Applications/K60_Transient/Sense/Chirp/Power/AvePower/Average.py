...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:POWer:AVEPower:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.power.avePower.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:POWer:AVEPower:AVERage? {param}')
