...
class Minimum:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:FREQuency:RMSFm:MINimum \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.frequency.rmsFm.minimum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:FREQuency:RMSFm:MINimum? {param}')
