...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:HOP:FREQuency:MAXFm:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.frequency.maxFm.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:FREQuency:MAXFm:AVERage? {param}')
