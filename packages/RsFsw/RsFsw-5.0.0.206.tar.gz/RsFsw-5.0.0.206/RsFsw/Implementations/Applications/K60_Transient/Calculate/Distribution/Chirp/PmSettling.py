...
class PmSettling:
	...
	def set(self, xaxis: enums.XaXisPmSettling, yaxis: enums.YaXisItems, window=repcap.Window.Default) -> None:
		"""SCPI: CALCulate<n>:DISTribution:CHIRp:PMSettling \n
		Snippet: driver.applications.k60Transient.calculate.distribution.chirp.pmSettling.set(xaxis = enums.XaXisPmSettling.PMSLength, yaxis = enums.YaXisItems.COUNt, window = repcap.Window.Default) \n
		Configures the Parameter Distribution result display for chirp PM settling parameters. \n
		...
		self._core.io.write(f'CALCulate{window_cmd_val}:DISTribution:CHIRp:PMSettling {param}'.rstrip())
