...
class Y:
	...
	def set(self, yaxis: enums.XaXisPmSettling, window=repcap.Window.Default) -> None:
		"""SCPI: CALCulate<n>:TRENd:CHIRp:PMSettling:Y \n
		Snippet: driver.applications.k60Transient.calculate.trend.chirp.pmSettling.y.set(yaxis = enums.XaXisPmSettling.PMSLength, window = repcap.Window.Default) \n
		Configures the y-axis of the Parameter Trend result display for chirp PM settling parameters. \n
		...
		self._core.io.write(f'CALCulate{window_cmd_val}:TRENd:CHIRp:PMSettling:Y {param}')
