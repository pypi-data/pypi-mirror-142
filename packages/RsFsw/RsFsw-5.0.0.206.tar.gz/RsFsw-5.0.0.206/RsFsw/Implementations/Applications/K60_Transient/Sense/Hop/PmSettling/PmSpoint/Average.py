...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:HOP:PMSettling:PMSPoint:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.pmSettling.pmSpoint.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:PMSettling:PMSPoint:AVERage? {param}')
