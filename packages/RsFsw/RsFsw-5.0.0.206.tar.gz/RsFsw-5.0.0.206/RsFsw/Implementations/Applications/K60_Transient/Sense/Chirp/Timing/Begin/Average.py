...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:TIMing:BEGin:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.timing.begin.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:TIMing:BEGin:AVERage? {param}')
