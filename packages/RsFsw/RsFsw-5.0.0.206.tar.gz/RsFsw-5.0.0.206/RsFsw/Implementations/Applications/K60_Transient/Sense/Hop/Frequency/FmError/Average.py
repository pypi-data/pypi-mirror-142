...
class Average:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:HOP:FREQuency:FMERror:AVERage \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.frequency.fmError.average.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:FREQuency:FMERror:AVERage? {param}')
