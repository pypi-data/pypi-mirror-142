...
class StandardDev:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:FMSettling:FMSPoint:SDEViation \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.fmSettling.fmSpoint.standardDev.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:FMSettling:FMSPoint:SDEViation? {param}')
