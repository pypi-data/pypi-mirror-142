...
class Power:
	...
	def set(self, xaxis: enums.AxisPower, yaxis: enums.YaXisItems, window=repcap.Window.Default) -> None:
		...
		Snippet: driver.applications.k60Transient.calculate.distribution.hop.power.set(xaxis = enums.AxisPower.AVGPower, yaxis = enums.YaXisItems.COUNt, window = repcap.Window.Default) \n
		...
		self._core.io.write(f'CALCulate{window_cmd_val}:DISTribution:HOP:POWer {param}'.rstrip())
