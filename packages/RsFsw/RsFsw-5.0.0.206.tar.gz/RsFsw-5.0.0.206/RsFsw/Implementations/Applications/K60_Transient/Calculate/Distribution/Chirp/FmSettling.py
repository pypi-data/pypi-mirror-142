...
class FmSettling:
	...
	def set(self, xaxis: enums.AxisFmSettling, yaxis: enums.YaXisItems, window=repcap.Window.Default) -> None:
		"""SCPI: CALCulate<n>:DISTribution:CHIRp:FMSettling \n
		Snippet: driver.applications.k60Transient.calculate.distribution.chirp.fmSettling.set(xaxis = enums.AxisFmSettling.FMSLength, yaxis = enums.YaXisItems.COUNt, window = repcap.Window.Default) \n
		Configures the Parameter Distribution result display for chirp FM settling parameters. \n
		...
		self._core.io.write(f'CALCulate{window_cmd_val}:DISTribution:CHIRp:FMSettling {param}'.rstrip())
