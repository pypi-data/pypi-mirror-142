...
class AvgPm:
	...
	def get(self, query_range: enums.SelectionRange) -> float:
		"""SCPI: [SENSe]:HOP:PHASe:AVGPm \n
		Snippet: value: float = driver.applications.k60Transient.sense.hop.phase.avgPm.get(query_range = enums.SelectionRange.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:HOP:PHASe:AVGPm? {param}')
