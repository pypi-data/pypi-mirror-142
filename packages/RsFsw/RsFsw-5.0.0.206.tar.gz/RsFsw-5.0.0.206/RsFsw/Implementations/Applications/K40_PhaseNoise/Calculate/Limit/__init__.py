...
class Limit:
	"""Limit commands group definition. 18 total commands, 11 Subgroups, 2 group commands
	...
	def copy(self, line: int, window=repcap.Window.Default, limitIx=repcap.LimitIx.Default) -> None:
		"""SCPI: CALCulate<n>:LIMit<li>:COPY \n
		Snippet: driver.applications.k40PhaseNoise.calculate.limit.copy(line = 1, window = repcap.Window.Default, limitIx = repcap.LimitIx.Default) \n
	...
	def delete(self, window=repcap.Window.Default, limitIx=repcap.LimitIx.Default) -> None:
		...
		Snippet: driver.applications.k40PhaseNoise.calculate.limit.delete(window = repcap.Window.Default, limitIx = repcap.LimitIx.Default) \n
	...
	def delete_with_opc(self, window=repcap.Window.Default, limitIx=repcap.LimitIx.Default, opc_timeout_ms: int = -1) -> None:
		...
		limitIx_cmd_val = self._cmd_group.get_repcap_cmd_value(limitIx, repcap.LimitIx)
		"""SCPI: CALCulate<n>:LIMit<li>:DELete \n
		Snippet: driver.applications.k40PhaseNoise.calculate.limit.delete_with_opc(window = repcap.Window.Default, limitIx = repcap.LimitIx.Default) \n
		This command deletes a limit line. \n
