...
class Low:
	...
	def set(self, arg_0: float) -> None:
		...
		Snippet: driver.applications.k40PhaseNoise.sense.mixer.bias.low.set(arg_0 = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:MIXer:BIAS[:LOW] \n
		Snippet: value: float = driver.applications.k40PhaseNoise.sense.mixer.bias.low.get() \n
		No command help available \n
