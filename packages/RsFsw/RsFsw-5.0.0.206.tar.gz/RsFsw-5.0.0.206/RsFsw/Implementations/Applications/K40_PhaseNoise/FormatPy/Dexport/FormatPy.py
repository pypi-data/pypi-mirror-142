...
class FormatPy:
	...
	def set(self, file_format: enums.FileFormat) -> None:
		...
		Snippet: driver.applications.k40PhaseNoise.formatPy.dexport.formatPy.set(file_format = enums.FileFormat.CSV) \n
	...
	def get(self) -> enums.FileFormat:
		"""SCPI: FORMat:DEXPort:FORMat \n
		Snippet: value: enums.FileFormat = driver.applications.k40PhaseNoise.formatPy.dexport.formatPy.get() \n
		No command help available \n
