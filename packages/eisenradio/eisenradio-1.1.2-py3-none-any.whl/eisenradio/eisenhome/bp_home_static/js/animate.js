...
function rotateVisualiserGradient(){
    ...
    gradient.addColorStop("0.18", paletteArray[rndOmNum][1]);
    gradient.addColorStop("0.24", paletteArray[rndOmNum][2]);
    gradient.addColorStop("0.3", 'black');
    gradient.addColorStop("0.4", 'rgb(10,10,10,1)');
    gradient.addColorStop("0.5", 'rgb(2,2,2,1)');
    gradient.addColorStop("0.7", 'black');
    gradient.addColorStop("0.75", paletteArray[rndOmNum][3]);
