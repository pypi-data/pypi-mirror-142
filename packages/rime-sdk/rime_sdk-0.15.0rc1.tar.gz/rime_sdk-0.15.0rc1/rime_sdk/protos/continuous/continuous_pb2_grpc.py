...
class CTServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFirewallRules = channel.unary_unary(
                '/rime.CTService/GetFirewallRules',
                request_serializer=protos_dot_continuous_dot_continuous__pb2.GetFirewallRulesRequest.SerializeToString,
                response_deserializer=protos_dot_continuous_dot_continuous__pb2.GetFirewallRulesResponse.FromString,
                )
...
class CTServiceServicer(object):
    ...
    def GetFirewallRules(self, request, context):
        """Temp hack. Add endpoint for fetching FW rule to unblock ML.
        Needed for the simulated FW for V15 (which works on top of old CT).
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CTServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFirewallRules': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_continuous_dot_continuous__pb2.GetFirewallRulesRequest.FromString,
                    response_serializer=protos_dot_continuous_dot_continuous__pb2.GetFirewallRulesResponse.SerializeToString,
            ),
    }
...
class CTService(object):
    ...
    def GetFirewallRules(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rime.CTService/GetFirewallRules',
            protos_dot_continuous_dot_continuous__pb2.GetFirewallRulesRequest.SerializeToString,
            protos_dot_continuous_dot_continuous__pb2.GetFirewallRulesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
