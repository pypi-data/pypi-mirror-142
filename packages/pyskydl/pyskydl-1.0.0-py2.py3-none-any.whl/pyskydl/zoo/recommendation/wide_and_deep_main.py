...
from pyskydl.zoo.recommendation.wide_and_deep_model import WideAndDeepModel
...
def run_model():
    ...
    """
    # 加载数据集
    train_dataset, validation_dataset, evaluate_dataset, tag_index_count = WideAndDeepModel().load_data()
    # 定义inputs, outputs
    feature_columns = []
