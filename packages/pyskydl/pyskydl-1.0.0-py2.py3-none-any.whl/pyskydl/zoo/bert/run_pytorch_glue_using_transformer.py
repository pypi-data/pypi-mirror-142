...
重写predict和main执行逻辑：
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        from skydl_mixin.models_zoo.bert.api import SentimentAnalyzer
...
from skydl_mixin.models_zoo.bert.custom_classifier_processor import CustomClassifierProcessor
