...
from pyskydl.examples.pytorch.lit_auto_encoder.lit_auto_encoder_net import LitAutoEncoderNet


class LitAutoEncoderModel(DefaultTorchLightningModel):
    """lit auto encoder pytorch model"""
    def adjust_parse_args_value(self):
        ...
        self.parser_args.model_version = '20210826001'
    ...
    def build_network(self):
        return LitAutoEncoderNet(self.name, self.parser_args)
