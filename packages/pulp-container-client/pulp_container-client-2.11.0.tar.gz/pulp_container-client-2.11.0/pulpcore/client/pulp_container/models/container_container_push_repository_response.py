...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, manifest_signing_service=None, pulp_labels=None, name=None, retain_repo_versions=None, description=None, pulp_created=None, pulp_href=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
