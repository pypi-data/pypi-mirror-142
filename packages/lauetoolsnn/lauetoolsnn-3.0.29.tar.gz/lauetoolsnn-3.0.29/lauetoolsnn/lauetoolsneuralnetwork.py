...
class Window(QMainWindow):
    ...
    def load_config_from_file(self, configFile):
        ...
        if detectorfile == "ZnCuOCl":
            detectorfile = resource_path(r"examples\ZnCUOCl\calib.det",  verbose=0)
        elif detectorfile == "GaN":
            detectorfile = resource_path(r"examples\GaN_Si\calib.det",  verbose=0)
        ...
        if expfile_global == "ZnCuOCl":
            expfile_global = resource_path(r"examples\ZnCUOCl",  verbose=0)
        elif expfile_global == "GaN":
            expfile_global = resource_path(r"examples\GaN_Si",  verbose=0)
