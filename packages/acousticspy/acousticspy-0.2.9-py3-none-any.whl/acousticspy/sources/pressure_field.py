...
def pressure_field(positions,frequencies,
    ...
    #     if not directivity_only:
    #         pressure_field = get_field(positions,frequencies,strengths,velocities,phases,field_points,time)
    ...
    #     if not dimensions == 1:
    #         directivity_points, theta = define_arc(directivity_distance,num_directivity_points)
    #         directivity = np.abs(get_field(positions,frequencies,strengths,velocities,phases,directivity_points,time))
    #         directivity = directivity / np.max(directivity)
