...
class RunModel:
    ...
    # may be removed and wrapped into parameters later
    model: str
    ...
    # Run Model migration management
    version: str  # Hardcoded/set for now
    ...
    def from_partial_run_model(cls, partial_run_model: PartialRunModel) -> RunModel:
        ...
        # Fill in default initial values for RunModel
