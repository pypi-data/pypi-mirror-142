...
def sg_short_term_feature_engineering(df_usep, df_adv, targetvariable = 'USEP', no_of_period = 12, divideby =10):
...
def shandong_feature_engineering(df_shandong, feature_columns, label_column):
