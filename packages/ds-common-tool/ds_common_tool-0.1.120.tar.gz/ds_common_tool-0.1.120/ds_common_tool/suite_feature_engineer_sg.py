...
def sg_long_term_feature_engineer(df, brent_df, gas_df, weather_df, filter_columns, target_column):
...
def sg_short_term_feature_engineer(df_usep, df_adv, targetvariable = 'USEP', no_of_period = 12, divideby =10):
    ...
    main_features = [targetvariable, becomefeature,'LOAD_SHORTFALL', 'RES_SHORTFALL',
       ...
       'PRICE_REVISION', 'PROVISIONAL_PRICES','DEMAND'] 
