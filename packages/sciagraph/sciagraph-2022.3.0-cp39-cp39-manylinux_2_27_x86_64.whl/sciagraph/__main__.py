...
More documentation is available at https://pythonspeed.com/fil/docs/
...
PARSER.add_argument(
    ...
    dest="output_path",
    action="store",
    default="sciagraph-result/" + datetime.now(timezone.utc).isoformat(),
...
def main():
    ...
    environ["__SCIAGRAPH_OUTPUT_PATH"] = args.output_path
