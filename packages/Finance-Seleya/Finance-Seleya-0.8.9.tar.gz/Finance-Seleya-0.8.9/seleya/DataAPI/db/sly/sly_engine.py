...
class FetchSLYEngine(FetchEngine):
    ...
    def esg_metrics_detail(self, codes, key, columns): 
        table = self._base.classes['esg_metrics_detail_new']
    ...
    def index_components(self, codes=None, key='code', category='sp500', columns=None):
        table = self._base.classes['index_components_new']
        if codes is None:
            clause_list = and_(table.flag == 1,
    ...
    def industry(self, codes=None, key='code', category='GICS', columns=None):
        table = self._base.classes['industry_new']
        if codes is None:
            clause_list = and_(table.flag == 1,
                               table.is_primary==1,
    ...
    def company(self, codes=None, primary=[1], key='code', columns=None):
        table = self._base.classes['company_new']
        if codes is None:
            clause_list = and_(table.flag == 1,
    ...
    def sasb_mapdom(self, codes, key, values):
        Industry = self._base.classes['industry_new']
        SASB = self._base.classes['sasb_mapdom']
        Detail = self._base.classes['esg_metrics_detail_new']
    ...
    def sasb_relationship(self, codes):
        sasb_mapdom = self._base.classes['sasb_mapdom_new']
    ...
    def sasb_metrics(self, codes, column_name, begin_date, end_date):
        metrics_tables = [self._base.classes['esg_metrics_environmental_new'],
                          self._base.classes['esg_metrics_fundamental_new'],
                          self._base.classes['esg_metrics_governance_new'],
                          self._base.classes['esg_metrics_social_new'],
                          self._base.classes['esg_metrics_internal_new'],
                          self._base.classes['esg_metrics_credit_new']]
