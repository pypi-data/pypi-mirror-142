...
from phidata.workflow.py import PythonWorkflowBase, PythonWorkflowBaseArgs


class DownloadUrlToFileArgs(PythonWorkflowBaseArgs):
    file: File
    url: str


class DownloadUrlToFile(PythonWorkflowBase):
    def __init__(
        self,
        file: File,
        url: str,
...
def download_url_to_file(**kwargs) -> bool:
    ...
    args: DownloadUrlToFileArgs = DownloadUrlToFileArgs(**kwargs)
    # logger.debug("DownloadUrlToFileArgs: {}".format(args))
