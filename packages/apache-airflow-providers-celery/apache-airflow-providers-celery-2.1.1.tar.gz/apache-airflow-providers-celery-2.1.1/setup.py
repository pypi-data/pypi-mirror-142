...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0', 'celery~=5.1,>=5.1.2', 'celery>=5.2.3', 'flower>=1.0.0'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-celery/2.1.1/',
