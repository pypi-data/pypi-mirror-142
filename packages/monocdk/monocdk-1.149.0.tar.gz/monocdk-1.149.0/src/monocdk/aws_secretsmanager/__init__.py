...
class CfnSecret(
    ...
    For information about retrieving a secret from Secrets Manager, see `Retrieve secrets from Secrets Manager <https://docs.aws.amazon.com/secretsmanager/latest/userguide/retrieving-secrets.html>`_ .
