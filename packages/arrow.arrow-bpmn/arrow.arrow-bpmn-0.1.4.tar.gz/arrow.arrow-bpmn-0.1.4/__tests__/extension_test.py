...
class ExtensionTest(unittest.TestCase):
    ...
    def test_initiate_expression(self):
        ...
        ref = engine.deploy(Path(__file__).parent / "diagrams/extension/initiate_expression.bpmn")[0]
    ...
    def test_continue_expression(self):
        engine = SequentialBpmnEngine()
        ref = engine.deploy(Path(__file__).parent / "diagrams/extension/continue_expression.bpmn")[0]
    ...
    def test_complete_expression(self):
        engine = SequentialBpmnEngine()
        ref = engine.deploy(Path(__file__).parent / "diagrams/extension/complete_expression.bpmn")[0]
