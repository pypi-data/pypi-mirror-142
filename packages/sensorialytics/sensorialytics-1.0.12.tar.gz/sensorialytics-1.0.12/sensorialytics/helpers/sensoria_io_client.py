...
class SensoriaIoClient:
    ...
    def authenticate(username: str = None, password: str = None):
        if SensoriaIoClient.__has_token():
            return
        ...
        if username is not None and password is not None:
            ...
            SensoriaIoClient.__get_token_attempts()
    ...
    @staticmethod
    def __get_token_attempts():
        n_attempts = 0

        while n_attempts < N_MAX_AUTH_ATTEMPTS:
            n_attempts += 1
            ...
            try:
                ...
                logging.error(f'{e}. {N_MAX_AUTH_ATTEMPTS - n_attempts} '
