...
from .utils._decorators import mutually_exclusive, check_props
...
class Fluid(BaseConsumerClass):
    ...
    def density(self, props: Dict[str, NDArrayOrFloat] = None, **kwargs):
        ...
        Inputs to temp, pres, props must be constants or have the same shape.
    ...
    def modulus(self, props: Dict[str, NDArrayOrFloat] = None, **kwargs):
...
class Water(Fluid):
    ...
    def bulk_modulus(
        ...
        return bw92.wat_bulkmod(
            self.density(props["temp"], props["pres"]),
            self.velocity(props["temp"], props["pres"]),
        )
