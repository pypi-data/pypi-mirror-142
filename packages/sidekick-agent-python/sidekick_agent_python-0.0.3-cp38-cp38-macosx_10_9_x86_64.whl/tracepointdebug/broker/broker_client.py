...
class BrokerConnection:
    ...
    def __init__(self, host, port, broker_credentials, message_callback, tracepoints_request_to_broker):
        ...
        self.tracepoints_request_to_broker = tracepoints_request_to_broker
    ...
    def on_open(self, ws):
        ...
        if connection_set:
            self.tracepoints_request_to_broker()
