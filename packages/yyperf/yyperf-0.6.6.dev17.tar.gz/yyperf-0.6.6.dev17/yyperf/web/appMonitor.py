...
DATA_TITLE = "TimeStamp,app CPU Load(%),Total CPU(%),Memory(MB),Native(MB),Dalvik(MB),totalTraffic(Kb/s),trafficUp,trafficDown,GPU Load [%],Threads,virtual Mem(MB),Activities,FPS,mediasvrd CPU(%),wakeups"
            ...
            try:
                ...
                for key,value in datalist.items():
                    ...
                    if (float(value)<0 or (key in ['upflow','downflow','flow'] and value>100000)) and key in list(pre_data.keys()):
                        ...
                        pre_data[key] = value
                write_str = "%s,%5s,%5s,%6s,%6s,%6s,%6s,%6s,%6s,%5s,%5s,%.2f,%5s,%.2f,-1,%s" % (
