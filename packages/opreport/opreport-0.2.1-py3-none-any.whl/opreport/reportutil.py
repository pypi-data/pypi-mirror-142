...
from opreport import network_utilization_report, utilization_comparison_report, patch_management_report, remote_control_usage_report, hardware_inventory_report
