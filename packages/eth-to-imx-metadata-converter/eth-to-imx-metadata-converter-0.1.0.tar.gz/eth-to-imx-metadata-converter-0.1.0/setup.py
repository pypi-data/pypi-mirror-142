...
setup(
    ...
    author_email='d.gmiterko@gmail.com',
    description='Tool for converting ERC-721 metadata format into Immutable X compatible format',
    ...
    entry_points={
        'console_scripts': [
            'eth2imx-meta=eth_to_imx_metadata_converter.cli:main',
        ],
    },
    classifiers=[
