...
class LoggerFilterAllInOneInstagramBotOnly(logging.Filter):
    def filter(self, record: LogRecord):
        return record.name.startswith("AllInOneInstagramBot")
...
def create_log_file_handler(filename):
    ...
    file_handler.addFilter(LoggerFilterAllInOneInstagramBotOnly())
    return file_handler
...
def configure_logger(debug, username):
    ...
    console_handler.addFilter(LoggerFilterAllInOneInstagramBotOnly())
