...
from AllInOneInstagramBot.core.config import Config
from AllInOneInstagramBot.core.device_facade import create_device, get_device_info
from AllInOneInstagramBot.core.filter import Filter
from AllInOneInstagramBot.core.filter import load_config as load_filter
from AllInOneInstagramBot.core.interaction import load_config as load_interaction
from AllInOneInstagramBot.core.log import (
    configure_logger,
    is_log_file_updated,
    update_log_file_name,
)
from AllInOneInstagramBot.core.navigation import check_if_english
from AllInOneInstagramBot.core.persistent_list import PersistentList
from AllInOneInstagramBot.core.report import print_full_report
from AllInOneInstagramBot.core.session_state import SessionState, SessionStateEncoder
from AllInOneInstagramBot.core.storage import Storage
...
from AllInOneInstagramBot.core.utils import load_config as load_utils
from AllInOneInstagramBot.core.utils import (
...
from AllInOneInstagramBot.core.views import AccountView, ProfileView, TabBarView, UniversalActions
from AllInOneInstagramBot.core.views import load_config as load_views
...
def start_bot(**kwargs):
    ...
    if not kwargs:
        if "--config" not in configs.args:
            logger.info(
                "It's strongly recommend to use a config.yml file. Follow these links for more details: https://docs.AllInOneInstagramBot.org/#/configuration and https://github.com/AllInOneInstagramBot/bot/tree/master/config-examples",
