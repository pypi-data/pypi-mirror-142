            ...
            if cos_type:
                ...
                if self.type == 'data_asset':
                    try:
                        ...
                        if self.auto_pipeline_params.get('excel_sheet') and \
                                attachment_details['connection_path'].endswith("/"+str(self.auto_pipeline_params.get('excel_sheet'))):
    ...
    def _upload_data_via_flight_service(self,
        ...
        if remote_name:
            if dict_connection.get('location', {}).get('path'):
                dict_connection['location']['path'] = dict_connection['location']['path'] + '/' + remote_name
                dict_connection['location']['path'] = dict_connection['location']['path'].replace('//', '/')
                ...
                if actual_path:
                    dict_connection['location']['path'] = actual_path + '/' + remote_name
                    dict_connection['location']['path'] = dict_connection['location']['path'].replace('//', '/')
                else:
                    dict_connection['location']['path'] = remote_name
            else:
                dict_connection['location']['path'] = remote_name
        elif dict_connection.get('location', {}).get('file_name'):
