...
DEFINE_FLAG(int, amp_reg, 0, "Auto mix-precision control registers, bit 0: prefer 32; bit 1: prefer 16; bit 2: keep reduce type; bit 3 keep white list type; bit 4: array like op prefer too");
...
static void init_ns() {
    dsize_map["float16"] = __builtin_ffs(sizeof(int16))-1;
