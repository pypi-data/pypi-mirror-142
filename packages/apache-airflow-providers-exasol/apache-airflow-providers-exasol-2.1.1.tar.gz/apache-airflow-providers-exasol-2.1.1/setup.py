...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0', 'pandas>=0.17.1, <1.4', 'pyexasol>=0.5.1'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-exasol/2.1.1/',
