...
class Client(ABC):
    ...
    @abstractmethod
    async def get_value(
        self, hm_interface: str, channel_address: str, parameter: str
    ) -> Any:
    ...
    async def get_paramset(
        self, hm_interface: str, channel_address: str, paramset_key: str
    ) -> Any:
    ...
    async def get_value_by_paramset_key(
        self, hm_interface: str, channel_address: str, paramset_key: str, parameter: str
    ) -> Any:
...
class ClientCCU(Client):
    ...
    async def get_value(
        ...
        if not self._has_credentials:
            _LOGGER.warning(
                "get_value: You have to set username ans password to get a system variable via JSON-RPC"
            )
            return value
