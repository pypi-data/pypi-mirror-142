...
class PGS3CH:
    ...
    def sync_tables(self, tables_to_exclude=None):
        ...
        :return: tuple : (list of tables need to create or recreate,  list of tables need to remove)
        """
    ...
    def save_sync_tables(self, save_table_name, tables_to_exclude):
        """
        ...
        for row in tables_pg:
            rr = {"client_description": "learning tt",
                  "table_name_ch": row,
                  "table_name_pg": row,
