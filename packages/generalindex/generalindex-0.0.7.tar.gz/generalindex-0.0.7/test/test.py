# for easy testing, bring this file out of the test folder, rename folder to generalindex_sdk:
#import generalindex_sdk as ng
import generalindex_python_sdk.generalindex as ng
