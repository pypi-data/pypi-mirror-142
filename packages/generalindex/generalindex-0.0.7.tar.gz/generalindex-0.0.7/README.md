...
- a single python script that is ran thanks to the GX Python Runner task within a pipeline in the GX application
...
- NG_API_ENDPOINT → the URL to the GX platform API (by default, the url is set to https://api.generalindex.com)
...
### Who do I talk to? ###
* Admin: NorthGravity info@generalindex.com