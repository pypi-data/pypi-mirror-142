...
class RepositoriesMavenVersionsApi(object):
    ...
    def repair(self, maven_maven_repository_version_href, repository_version, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair(maven_maven_repository_version_href, repository_version, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repair_with_http_info(maven_maven_repository_version_href, repository_version, **kwargs)  # noqa: E501

    def repair_with_http_info(self, maven_maven_repository_version_href, repository_version, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair_with_http_info(maven_maven_repository_version_href, repository_version, async_req=True)
        >>> result = thread.get()
