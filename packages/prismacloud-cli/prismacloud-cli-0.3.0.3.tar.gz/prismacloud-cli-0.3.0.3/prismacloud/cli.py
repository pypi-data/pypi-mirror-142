...
@click.command(cls=PrismaCloudCLI, context_settings=CONTEXT_SETTINGS)
...
@pass_environment
def cli(ctx, verbose, configuration, output):
    """A PrismaCloud command line interface."""
    ctx.verbose = verbose
...
def output(data):
    ...
    try:
        ...
        # We have a dataframe, output here
