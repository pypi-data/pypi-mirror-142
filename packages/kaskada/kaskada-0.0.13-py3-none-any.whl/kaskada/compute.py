...
def query(query: str, with_tables: List[pb.WithTable] = [], with_views: List[pb.WithView] = [], result_behavior: str = 'all-results', response_as: str = 'parquet', data_token_id: str = None, dry_run: bool = False, resume_token: str = None, changed_since_time: Union[str, datetime.datetime, None] = None, limits: pb.QueryRequest.Limits = None, slice_filter: SliceFilter = None, client: Client = None) -> pb.QueryResponse:
    """
    Performs a query
