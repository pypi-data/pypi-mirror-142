...
def send(engine, key, context,
    ...
    if engine == "qa":
        ...
        if num_title < 1:
            num_title = 1
        url = url_pre + "paas/model/v1/open/engines/titleKey_generation/txl-general-engine-v1"
        params = {
            "inputText": context["prompt"],
            "numTitle": num_title
        }
        ...
        if num_title < 1:
            num_title = 1
        url = url_pre + "paas/model/v1/open/engines/titleDes_generation/txl-general-engine-v1"
        params = {
            "inputText": context["prompt"],
            "numTitle": num_title
        }
