...
rport	 = os.getenv("dskdm_port", 6666)
rdb		 = os.getenv("dskdm_db", 0)
...
# docker run -d --restart=always --name kvrocks -p 6666:6666 -v /ftp/db:/var/lib/kvrocks/db kvrocks/kvrocks