...
fire.es		= Elasticsearch([ dskes_host ]) 
...
# docker run -d --rm --name es -p 9200:9200 -p 5601:5601 -v /ftp/es-9200-eevsnts:/home/elasticsearch/elasticsearch-7.15.1/data -e "discovery.type=single-node" nshou/elasticsearch-kibana
