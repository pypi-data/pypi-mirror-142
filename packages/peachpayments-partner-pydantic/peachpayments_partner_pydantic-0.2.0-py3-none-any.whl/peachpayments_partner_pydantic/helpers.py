...
def str_type_check(value: Any):
    """Utility function that checks whether a value is not None and is a string."""
...
class Timestamp(OutboundTimestamp, InboundTimestamp):
    ...
    @classmethod
    def timestamp_type_check(cls, values) -> str:
        """Validates that timestamp is a string."""
        str_type_check(values.get("__root__"))
        return values
