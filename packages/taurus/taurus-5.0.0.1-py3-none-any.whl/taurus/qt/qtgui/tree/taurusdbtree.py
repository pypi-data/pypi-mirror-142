...
class TaurusDbTreeWidget(TaurusBaseTreeWidget):
    ...
    :class:`taurus.core.taurusauthority.TaurusAuthority` model. It can show the
    list of database elements in four different perspectives:
    ...
    Filters can be inserted into this widget to restrict the tree nodes that
    are seen.
    """
    ...
    KnownPerspectives = {
        ...
        "PlainDevice": {
            ...
            "icon": getElementTypeIconName(TaurusElementType.Device),
            "tooltip": (
                "View by plain device tree (it may take a long time "
