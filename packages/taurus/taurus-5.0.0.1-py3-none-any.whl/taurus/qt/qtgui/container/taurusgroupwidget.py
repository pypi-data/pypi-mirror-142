...
class TaurusGroupWidget(QGroupWidget, TaurusBaseContainer):
    """This is a :class:`taurus.qt.qtgui.container.QGroupWidget` that
    additionally accepts a model property. This type of taurus container
    classes are specially useful if you define a parent taurus model to them
    and set all contained taurus widgets to use parent model. Example::
