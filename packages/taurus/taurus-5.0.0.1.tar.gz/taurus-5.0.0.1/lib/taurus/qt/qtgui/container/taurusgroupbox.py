...
class TaurusGroupBox(Qt.QGroupBox, TaurusBaseContainer):
    """This is a Qt.QGroupBox that additionally accepts a model property. This
    type of taurus container classes are specially useful if you define a
    parent taurus model to them and set all contained taurus widgets to use
    ...
    showText = Qt.pyqtProperty(
        "bool",
        TaurusBaseContainer.getShowText,
        TaurusBaseContainer.setShowText,
        TaurusBaseContainer.resetShowText,
    )

    prefixText = Qt.pyqtProperty(
        "QString", getPrefixText, setPrefixText, doc="prefix text (optional)"
    )

    suffixText = Qt.pyqtProperty(
        "QString", getSuffixText, setSuffixText, doc="suffix text (optional)"
    )
