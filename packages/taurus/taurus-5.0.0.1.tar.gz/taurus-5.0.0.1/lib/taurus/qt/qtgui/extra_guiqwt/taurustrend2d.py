    ...
    def __init__(
        ...
        **kwargs
        ...
        self.registerConfigDelegate(
            self.trendItem or BaseConfigurableClass(), name="trendItem"
        )
        self.registerConfigDelegate(
            self.get_tool(AutoScrollTool), name="AutoScrollTool"
        )
        self.registerConfigDelegate(
            self.get_tool(AutoScaleXTool), name="AutoScaleXTool"
        )
        self.registerConfigDelegate(
            self.get_tool(AutoScaleYTool), name="AutoScaleYTool"
        )
        self.registerConfigDelegate(
            self.get_tool(AutoScaleZTool), name="AutoScaleZTool"
        )
        self.registerConfigProperty(
            self.getStackMode, self.setStackMode, "stackMode"
        )
        self.registerConfigProperty(
