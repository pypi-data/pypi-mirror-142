...
class SigmaView extends base_1.DOMWidgetView {
    ...
    render() {
        super.render();
        this.rng = (0, seedrandom_1.default)('ipysigma');
        ...
        this.displayed.then(() => {
            ...
            const nodePalette = nodePaletteBuilder === null || nodePaletteBuilder === void 0 ? void 0 : nodePaletteBuilder.build();
            ...
            const edgePalette = edgePaletteBuilder === null || edgePaletteBuilder === void 0 ? void 0 : edgePaletteBuilder.build();
