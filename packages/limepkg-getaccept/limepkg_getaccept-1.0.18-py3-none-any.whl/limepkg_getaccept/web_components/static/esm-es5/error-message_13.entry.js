...
import { r as registerInstance, h, g as getElement, c as createEvent } from './index-b43c2292.js';
import { E as EnumViews } from './EnumViews-26a35d6d.js';
import { c as fetchDocumentDetails, d as removeDocument, e as fetchTemplates, g as fetchLimeDocuments, h as fetchTemplateFields, P as PlatformServiceName, u as uploadFile, s as switchEntity, i as uploadDocument, j as createDocument, k as sealDocument, l as fetchVideos } from './index-5a6ec4f6.js';
...
var LayoutSelectRecipient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.selectedRecipientList.length < 1)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.fetchCurrentPersons()];
                    case 1:
                        currentPersons = _a.sent();
                        currentPersons.forEach(function (recipient) {
    ...
    class_3.prototype.fetchCurrentPersons = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, record_id, limetype, options, currentPersons;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.context, record_id = _a.id, limetype = _a.limetype;
                    ...
                    case 1:
                        currentPersons = _b.sent();
                        // eslint-disable-next-line sonarjs/no-identical-functions
                        return [2 /*return*/, currentPersons.map(function (person) { return ({
                                email: person.email,
                                name: person.name,
                                mobile: person.mobilephone || person.phone,
                                limetype: 'person',
...
var LayoutSendDocument = /** @class */ (function () {
    ...
    class_4.prototype.fileName = function () {
    ...
    class_4.prototype.handleChangeDocumentName = function (event) {
        this.setNewDocumentName.emit(event.detail);
    };
    class_4.prototype.handleChangeValue = function (event) {
        this.setDocumentValue.emit(event.detail);
    };
    class_4.prototype.handleChangeSmartReminder = function (event) {
        this.setSmartReminder.emit(event.detail);
    };
    class_4.prototype.handleChangeSendLinkBySms = function (event) {
        this.setIsSmsSending.emit(event.detail);
    };
    class_4.prototype.handleAddVideo = function () {
        // should open select video view
        this.changeView.emit(EnumViews.videoLibrary);
    };
    class_4.prototype.handleChange = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, success;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        console.log('onChange', this.fileValue);
                        return [4 /*yield*/, uploadFile(this.platform, this.session, this.fileValue)];
                    case 1:
    ...
    class_4.prototype.handleRemoveVideo = function () {
...
var LayoutSettings = /** @class */ (function () {
    ...
    class_5.prototype.renderLoader = function () {
        return h("ga-loader", { class: "full-width" });
    };
    class_5.prototype.renderContent = function () {
        return [
    ...
    class_5.prototype.renderError = function (error) {
        return error ? h("span", { class: "error" }, error) : '';
    };
    class_5.prototype.onChangeEntity = function (event) {
        return __awaiter(this, void 0, void 0, function () {
...
var LayoutValidateDocument = /** @class */ (function () {
    ...
    class_6.prototype.hasTemplateRoles = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, roles, e_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    class_6.prototype.handleUploadDocument = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, success;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.handleCreateDocument = function (send, openDocument) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_6.prototype.sealDocument = function (documentId, attempt) {
    ...
    class_6.prototype.haveSigner = function () {
        var signers = this.document.recipients.filter(function (recipient) { return recipient.role === 'signer'; });
        return signers.length > 0;
    };
    class_6.prototype.recipientsWithOnlyPhoneExists = function () {
        return this.document.recipients.some(function (recipient) { return !recipient.email && recipient.mobile !== ''; });
    };
    class_6.prototype.recipientMissingEmailAndPhoneExists = function () {
        return this.document.recipients.some(function (recipient) { return !recipient.email && !recipient.mobile; });
    };
    class_6.prototype.hasProperty = function (value) {
        return value ? 'Yes' : 'No';
    };
    class_6.prototype.openInNewTab = function (url) {
        this.toggleLoading(false);
    ...
    class_6.prototype.toggleLoading = function (value) {
...
var LayoutVideoLibrary = /** @class */ (function () {
    ...
    class_7.prototype.loadVideos = function () {
        return __awaiter(this, void 0, void 0, function () {
            var videos;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    class_7.prototype.handelClose = function () {
