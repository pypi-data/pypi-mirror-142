...
const index = require('./index-29d08e41.js');
const EnumViews = require('./EnumViews-bbc19da7.js');
const index$1 = require('./index-49fc3afa.js');
...
const LayoutSendDocument = class {
    ...
    async handleChange(event) {
        ...
        const { data, success } = await index$1.uploadFile(this.platform, this.session, this.fileValue);
