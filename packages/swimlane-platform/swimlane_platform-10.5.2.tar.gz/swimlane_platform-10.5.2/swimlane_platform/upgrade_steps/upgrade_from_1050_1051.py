...
class UpgradeFrom1050To1051(UpgradeStep):
    FROM = semver.parse_version_info('10.5.0')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.5.1')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.5.0 To 10.5.1')
    def process(self):
        # type: () -> None
