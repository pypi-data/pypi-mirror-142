...
class UpgradeFrom1051To1052(UpgradeStep):
    FROM = semver.parse_version_info('10.5.1')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.5.2')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.5.1 To 10.5.2')
    def process(self):
        # type: () -> None
