...
class Table:
    def __init__(
        ...
        *,
        ...
        primary_key: typing.Optional[PrimaryKey] = None,
    ) -> None:
        '''
...
class User:
    def __init__(
        ...
        *,
        name: builtins.str,
        grants: typing.Optional[typing.Sequence[Grant]] = None,
