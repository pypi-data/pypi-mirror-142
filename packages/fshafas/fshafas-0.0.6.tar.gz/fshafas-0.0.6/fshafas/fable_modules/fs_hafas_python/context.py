...
from .types_hafas_client import (FeatureCollection, Icon, Line, Operator, Operator_reflection, Line_reflection, Icon_reflection, FeatureCollection_reflection, ProductType, JourneysOptions, Alternative, Journey, Leg, Movement, StopOver, Trip, IndexMap_2, Warning)
...
CommonData_reflection = expr_289
...
ParsedWhen_reflection = expr_290
