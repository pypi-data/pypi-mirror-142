...
RawPltf_reflection = expr_158

def expr_159() -> TypeInfo:
...
RawTrnCmpSX_reflection = expr_159

def expr_160() -> TypeInfo:
...
RawCrd_reflection = expr_173

def expr_174() -> TypeInfo:
    return record_type("FsHafas.Raw.RawFreq", [], RawFreq, lambda: [("min_c", option_type(int32_type)), ("max_c", option_type(int32_type)), ("num_c", option_type(int32_type)), ("jny_l", option_type(array_type(RawJny_reflection())))])


class RawFreq(Record):
    def __init__(self, min_c: Optional[int], max_c: Optional[int], num_c: Optional[int], jny_l: Optional[List[RawJny]]) -> None:
        super().__init__()
        self.min_c = min_c
        self.max_c = max_c
        self.num_c = num_c
...
RawJny_reflection = expr_175

def expr_176() -> TypeInfo:
    return record_type("FsHafas.Raw.RawGis", [], RawGis, lambda: [("dist", option_type(int32_type)), ("deps_s", option_type(string_type))])


class RawGis(Record):
    def __init__(self, dist: Optional[int], deps_s: Optional[str]) -> None:
        super().__init__()
        self.dist = dist
        self.deps_s = deps_s
    

RawGis_reflection = expr_176
...
RawSotCtxt_reflection = expr_178
...
RawFareSet_reflection = expr_184
...
RawTrfRes_reflection = expr_185

def expr_186() -> TypeInfo:
    return record_type("FsHafas.Raw.RawOutCon", [], RawOutCon, lambda: [("cid", string_type), ("date", string_type), ("dur", string_type), ("chg", int32_type), ("s_days", RawSDays_reflection()), ("dep", RawDep_reflection()), ("arr", RawArr_reflection()), ("sec_l", array_type(RawSec_reflection())), ("ctx_recon", string_type), ("trf_res", option_type(RawTrfRes_reflection())), ("con_subscr", string_type), ("res_state", option_type(string_type)), ("res_recommendation", option_type(string_type)), ("rec_state", string_type), ("sot_rating", option_type(int32_type)), ("is_sot_con", option_type(bool_type)), ("show_arslink", option_type(bool_type)), ("sot_ctxt", option_type(RawSotCtxt_reflection())), ("cksum", string_type), ("msg_l", option_type(array_type(RawMsg_reflection()))), ("freq", option_type(RawFreq_reflection()))])


class RawOutCon(Record):
    def __init__(self, cid: str, date: str, dur: str, chg: int, s_days: RawSDays, dep: RawDep, arr: RawArr, sec_l: List[RawSec], ctx_recon: str, trf_res: Optional[RawTrfRes], con_subscr: str, res_state: Optional[str], res_recommendation: Optional[str], rec_state: str, sot_rating: Optional[int], is_sot_con: Optional[bool], show_arslink: Optional[bool], sot_ctxt: Optional[RawSotCtxt], cksum: str, msg_l: Optional[List[RawMsg]], freq: Optional[RawFreq]) -> None:
        super().__init__()
        self.cid = cid
        self.date = date
        self.dur = dur
...
RawProdCtx_reflection = expr_190
...
RawOp_reflection = expr_191

def expr_192() -> TypeInfo:
    return record_type("FsHafas.Raw.RawProd", [], RawProd, lambda: [("name", string_type), ("number", option_type(string_type)), ("ico_x", option_type(int32_type)), ("opr_x", option_type(int32_type)), ("prod_ctx", option_type(RawProdCtx_reflection())), ("cls", option_type(int32_type)), ("line", option_type(string_type)), ("add_name", option_type(string_type))])


class RawProd(Record):
    def __init__(self, name: str, number: Optional[str], ico_x: Optional[int], opr_x: Optional[int], prod_ctx: Optional[RawProdCtx], cls: Optional[int], line: Optional[str], add_name: Optional[str]) -> None:
        super().__init__()
        self.name = name
        self.number = number
        self.ico_x = ico_x
...
RawHimMsgCat_reflection = expr_197
...
RawHimMsgEdge_reflection = expr_199
...
RawHimMsgEvent_reflection = expr_200
...
RawCommon_reflection = expr_201

def expr_202() -> TypeInfo:
    return record_type("FsHafas.Raw.RawMatch", [], RawMatch, lambda: [("field", option_type(string_type)), ("state", option_type(string_type)), ("loc_l", array_type(RawLoc_reflection()))])


class RawMatch(Record):
    def __init__(self, field: Optional[str], state: Optional[str], loc_l: List[RawLoc]) -> None:
        super().__init__()
        self.field = field
        self.state = state
        self.loc_l = loc_l
...
RawLine_reflection = expr_204

def expr_205() -> TypeInfo:
    return record_type("FsHafas.Raw.RawResult", [], RawResult, lambda: [("common", option_type(RawCommon_reflection())), ("msg_l", option_type(array_type(RawHim_reflection()))), ("type", option_type(string_type)), ("jny_l", option_type(array_type(RawJny_reflection()))), ("out_con_l", option_type(array_type(RawOutCon_reflection()))), ("out_ctx_scr_b", option_type(string_type)), ("out_ctx_scr_f", option_type(string_type)), ("planrt_ts", option_type(string_type)), ("match", option_type(RawMatch_reflection())), ("loc_l", option_type(array_type(RawLoc_reflection()))), ("journey", option_type(RawJny_reflection())), ("fp_e", option_type(string_type)), ("s_d", option_type(string_type)), ("s_t", option_type(string_type)), ("fp_b", option_type(string_type)), ("pos_l", option_type(array_type(RawPos_reflection()))), ("line_l", option_type(array_type(RawLine_reflection())))])


class RawResult(Record):
    def __init__(self, common: Optional[RawCommon], msg_l: Optional[List[RawHim]], type: Optional[str], jny_l: Optional[List[RawJny]], out_con_l: Optional[List[RawOutCon]], out_ctx_scr_b: Optional[str], out_ctx_scr_f: Optional[str], planrt_ts: Optional[str], match: Optional[RawMatch], loc_l: Optional[List[RawLoc]], journey: Optional[RawJny], fp_e: Optional[str], s_d: Optional[str], s_t: Optional[str], fp_b: Optional[str], pos_l: Optional[List[RawPos]], line_l: Optional[List[RawLine]]) -> None:
        super().__init__()
        self.common = common
        self.msg_l = msg_l
        self.type = type
...
RawResult_reflection = expr_205

def expr_206() -> TypeInfo:
    return record_type("FsHafas.Raw.SvcRes", [], SvcRes, lambda: [("meth", string_type), ("err", option_type(string_type)), ("err_txt", option_type(string_type)), ("res", RawResult_reflection())])


class SvcRes(Record):
    def __init__(self, meth: str, err: Optional[str], err_txt: Optional[str], res: RawResult) -> None:
        super().__init__()
        self.meth = meth
        self.err = err
...
RawResponse_reflection = expr_207
...
LocViaInput_reflection = expr_210
...
LocMatchInput_reflection = expr_211
...
LocMatchRequest_reflection = expr_212
...
LineMatchRequest_reflection = expr_213
...
JourneyDetailsRequest_reflection = expr_214
...
StationBoardRequest_reflection = expr_218
...
HimSearchRequest_reflection = expr_219
...
ReconstructionRequest_reflection = expr_220
...
SearchOnTripRequest_reflection = expr_222
...
TripSearchRequest_reflection = expr_223
...
JourneyMatchRequest_reflection = expr_224
...
LocGeoPosRequest_reflection = expr_227
...
LocGeoReachRequest_reflection = expr_228
...
LocDetailsRequest_reflection = expr_229
...
JourneyGeoPosRequest_reflection = expr_231
...
RawRequestClient_reflection = expr_233
...
RawRequestAuth_reflection = expr_234
...
RawRequest_reflection = expr_235
