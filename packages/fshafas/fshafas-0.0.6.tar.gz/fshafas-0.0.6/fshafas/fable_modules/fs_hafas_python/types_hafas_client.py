...
from typing import (Any, TypeVar, Optional, Generic, MutableSequence, List, Protocol)
from ..fable_library.reflection import (TypeInfo, class_type, string_type, option_type, record_type, int32_type, array_type, bool_type, float64_type, obj_type)
...
def expr_237(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
IndexMap_2_reflection = expr_237
...
ProductType_reflection = expr_239
...
ReisezentrumOpeningHours_reflection = expr_241
...
ArrivalDeparture_reflection = expr_248
...
FeatureCollection_reflection = expr_259
...
Alternative_reflection = expr_263
...
Journeys_reflection = expr_266

def expr_267() -> TypeInfo:
    return record_type("FsHafas.Client.Duration", [], Duration, lambda: [("duration", option_type(int32_type)), ("stations", array_type(obj_type))])


class Duration(Record):
    def __init__(self, duration: Optional[int], stations: List[Any]) -> None:
        super().__init__()
        self.duration = duration
        self.stations = stations
    

Duration_reflection = expr_267
...
Movement_reflection = expr_269

def expr_270() -> TypeInfo:
    return record_type("FsHafas.Client.ServerInfo", [], ServerInfo, lambda: [("timetable_start", option_type(string_type)), ("timetable_end", option_type(string_type)), ("server_time", option_type(string_type)), ("realtime_data_updated_at", option_type(int32_type))])


class ServerInfo(Record):
    def __init__(self, timetable_start: Optional[str], timetable_end: Optional[str], server_time: Optional[str], realtime_data_updated_at: Optional[int]) -> None:
        super().__init__()
...
JourneysOptions_reflection = expr_272
...
JourneysFromTripOptions_reflection = expr_273
...
LocationsOptions_reflection = expr_274
...
TripOptions_reflection = expr_275
...
StopOptions_reflection = expr_276
...
DeparturesArrivalsOptions_reflection = expr_277
...
RefreshJourneyOptions_reflection = expr_278
...
NearByOptions_reflection = expr_279
...
ReachableFromOptions_reflection = expr_280
...
BoundingBox_reflection = expr_281
...
RadarOptions_reflection = expr_282
...
TripsByNameOptions_reflection = expr_284
...
RemarksOptions_reflection = expr_285
...
LinesOptions_reflection = expr_286

def expr_287() -> TypeInfo:
    return record_type("FsHafas.Client.ServerOptions", [], ServerOptions, lambda: [("language", option_type(string_type))])
...
ServerOptions_reflection = expr_287
