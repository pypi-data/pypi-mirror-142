...
from ...fs_hafas_python.types_hafas_client import Log_Print

_A_ = TypeVar("_A_")

def expr_301() -> TypeInfo:
...
HttpClient_reflection = expr_301
...
def HttpClient__PostAsync(__: HttpClient, url: str, salt: str, json: str) -> Async[str]:
    ...
    def arrow_302(__: HttpClient=__, url: str=url, salt: str=salt, json: str=json) -> Async[str]:
    ...
    return singleton.Delay(arrow_302)
