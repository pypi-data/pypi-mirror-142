...
class CfnUserPoolClient(
    ...
    def __init__(
        ...
        *,
        ...
        :param analytics_configuration: The Amazon Pinpoint analytics configuration for collecting metrics for this user pool. .. epigraph:: In AWS Regions where Amazon Pinpoint isn't available, User Pools only supports sending events to Amazon Pinpoint projects in AWS Region us-east-1. In Regions where is available, User Pools will support sending events to Amazon Pinpoint projects within that same Region.
