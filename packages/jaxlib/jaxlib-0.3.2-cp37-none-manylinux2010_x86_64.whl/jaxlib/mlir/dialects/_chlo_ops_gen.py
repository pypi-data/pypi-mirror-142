...
class BroadcastAddOp(_ods_ir.OpView):
  ...
  def __init__(self, result, lhs, rhs, broadcast_dimensions, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class BroadcastCompareOp(_ods_ir.OpView):
  ...
  def __init__(self, result, lhs, rhs, broadcast_dimensions, comparison_direction, compare_type, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class BroadcastSelectOp(_ods_ir.OpView):
  ...
  def __init__(self, result, pred, on_true, on_false, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
