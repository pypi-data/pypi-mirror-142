_ytmdl_complete()
{
    ...
    type_list="--SONG-NAME --quiet --output-dir --song --choice --artist --album --disable-metaadd --skip-meta --manual-meta --itunes-id --spotify-id --disable-sort --ask-meta-name --on-meta-error --proxy --url --list --nolocal --format --trim --get-opts --keep-chapter-name --download-archive --ignore-chapters --ytdl-config --pl-start --pl-end --pl-items --ignore-errors --title-as-name --level --disable-file --list-level"
