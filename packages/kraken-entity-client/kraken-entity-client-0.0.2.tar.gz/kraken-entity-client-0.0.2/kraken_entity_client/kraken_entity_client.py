...
class Kraken_entity_client:
    ...
    def new(self):
        """
        Returns an empty entity with same type and id 
        """
        return self._new()
    ...
    def email(self, value):
        self.record['schema:email'] = value
    ...
    def _new(self):
        ...
        Returns an empty entity with same type and id 
        """
        e = Kraken_entity_client()
        e.record_type = self.record_type
        e.record_id = self.record_id
        return e
