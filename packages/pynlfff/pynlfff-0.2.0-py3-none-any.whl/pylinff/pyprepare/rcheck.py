"""
Purpose:   [1] this project, pylinff , may not use all function in computer machine
...
class RCheck():
    """
    check pylinff some function needed module is install or not
    """

    def __init__(self, version="0.2", print_try_log=True):
        """
    ...
    def help(self):
        ...
        :return: None
        """
        help_str = """This module is to test some module, for pylinff which function you need, is install or not.
