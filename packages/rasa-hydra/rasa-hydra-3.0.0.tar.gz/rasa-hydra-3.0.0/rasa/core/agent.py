...
async def load_agent(
    ...
    try:
        if model_server is not None:
            server_model = await load_from_server(
                Agent(
            ...
            model_english = Agent.load_local_model(
            ...
            model_spanish = Agent.load_local_model(
                "models/models_spanish",
                interpreter=interpreter,
                generator=generator,
                tracker_store=tracker_store,
                lock_store=lock_store,
            ...
            return [model_english, model_spanish]
