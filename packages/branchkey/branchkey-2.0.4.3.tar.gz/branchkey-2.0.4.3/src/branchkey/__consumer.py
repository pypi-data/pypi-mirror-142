...
class Consumer:
    def __init__(self, config: dict, msg_queue: Queue):
        ...
        self.queue_name = rabbitmq_config['branch_id'] + '_' + rabbitmq_config['leaf_name']
        ...
        self.channel.queue_declare(
            self.queue_name, durable=True, arguments={'x-expires': 30000})

        self.channel.queue_bind(
            self.queue_name, self.exchange)
