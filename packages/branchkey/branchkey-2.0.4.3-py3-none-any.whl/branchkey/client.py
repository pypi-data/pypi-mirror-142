...
class Client:
    def __init__(self,
        ...
        consumer = Consumer(credentials, self.queue)
    ...
    def login(self):
        try:
            ...
            try:
                ...
                self.__logged_in = login_data["logged_in"]
    ...
    def logout(self):
        if not self.__logged_in or not self.__access_token:
        ...
        try:
            ...
            if resp.status_code != HTTPStatus.OK:
                raise Exception(f"Error with login: status code {resp.status_code}")
