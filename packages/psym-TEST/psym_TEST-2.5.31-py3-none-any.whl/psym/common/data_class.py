...
class resourceType(NamedTuple):
    ...
    :param id: ID
    :type id: str
    :param resourceTypeClass: resourceTypeClass
    :type resourceTypeClass: `~psym.common.data_class.resourceTypeClass`
    :param resourceTypeBaseType: resourceTypeBaseType
    :type resourceTypeBaseType: `~psym.common.data_class.resourceTypeBaseType`
    """
...
class resourceSpecification(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: ID
    ...
    :type resourceType: `~psym.common.data_class.resourceType`
    :param propertyTypes: propertyTypes sequence
    :type propertyTypes: Sequence[ :class:`~psym.graphql.fragment.property.PropertyFragment` ]
    """

    id: str
    name: str
    resourceType: Optional[str]
    propertyTypes: Sequence[PropertyDefinition]
 
class resourceTypeRelationship(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: ID
    :type id: str
    :param resourceRelationshipMultiplicity: resourceRelationshipMultiplicity
    :type resourceRelationshipMultiplicity: `~psym.graphql.enum.resourceRelationshipMultiplicityKind`
    :param resourceRelationshipType: resourceRelationshipType
    :type resourceRelationshipType: `~psym.graphql.enum.resourceRelationshipTypeKind`
    :param resourceTypeA: resourceTypeA
    :type resourceTypeA: `~psym.common.data_class.resourceRelationship`
    :param resourceTypeB: resourceTypeB
    :type resourceTypeB: `~psym.common.data_class.resourceRelationship`
    :param LocationType: LocationType
    :type LocationType: `~psym.common.data_class.LocationType`
    """
...
class resourceSpecificationRelationship(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: ID
    ...
    :type resourceSpecification: `~psym.common.data_class.resourceSpecification`
    """

    id: str
    name: str
    resourceSpecification: Optional[str]


class ResourceSpecificationItems(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: ID
    ...
    :param resourceType: resourceType
    :type resourceType: `~psym.common.data_class.resourceType`
    :param resourceSpecificationRelationship: resourceSpecificationRelationship
    :type resourceSpecificationRelationship: `~psym.common.data_class.resourceSpecificationRelationship`
    """

    id: str
    resourceSpecification: Optional[str]
    resourceSpecificationRelationship: Optional[str]
