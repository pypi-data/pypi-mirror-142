...
from ..enum.resource_relationship_order_field import ResourceRelationshipOrderField


@dataclass(frozen=True)
class ResourceRelationshipOrder(DataClassJsonMixin):
    direction: OrderDirection = _field(metadata=enum_field_metadata(OrderDirection))
    field: Optional[ResourceRelationshipOrderField] = None
