...
class PsymClient(SymphonyClient):
    ...
    from.api.resource_type_relationship import(
        add_resource_type_relationship,
        edit_resource_type_relationship,
        get_resource_type_relationship_by_id,
        get_resource_type_relationships,
        delete_resource_type_relationship
    )
    from.api.resource_specification import (
        add_resource_specification,
        edit_resource_specification,
        get_resource_specifications,
        delete_resource_specification
        )
    from.api.resource_specification_relationship import (
        add_resource_specification_relationship,
        edit_resource_specification_relationship,
        get_resource_specification_relationships,
        delete_resource_specification_relationship
