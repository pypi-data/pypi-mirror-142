...
class ModelMetaData(BaseModel):
    ...
    # TODO: This is related to US 246028 and need to have a second iteration.
    modelVersion: str
    modelName: str
    modelExperimentId: str
    dataSetId: str = "TODO"
    hasValidator: bool
    subscriptionId: str = "TODO"
    resourceGroupId: str = "TODO"
    workspaceId: str = "TODO"
