    ...
    render() {
        return (React.createElement(UseSignal, { signal: this._menu.profileChanged }, () => {
            ...
            return (React.createElement("div", null,
                React.createElement(Button, { appearance: "stealth", "aria-label": `User Menu: ${profile.name}`, onClick: this._onClick }, isAnonymous ? (React.createElement(avatarIcon.react, { className: "anonymous-icon", tag: "span", width: "28px", height: "28px" })) : (React.createElement(Avatar, { src: profile.avatar_url, shape: "circle", alt: `${profile.name.slice(0, 2).toLocaleUpperCase()}` })))));
        }));
    }
}
/**
