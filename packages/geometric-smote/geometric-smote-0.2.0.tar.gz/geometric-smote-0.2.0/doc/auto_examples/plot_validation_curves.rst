...
.. "auto_examples/plot_validation_curves.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_plot_validation_curves.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_validation_curves.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_001.png
         :alt: K Neighbors
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_002.png
         :alt: Truncation Factor
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_003.png
         :alt: Deformation Factor
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_004.png
         :alt: Selection Strategy
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_004.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_005.png
         :alt: K Neighbors
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_005.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_006.png
         :alt: Truncation Factor
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_006.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_007.png
         :alt: Deformation Factor
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_007.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_validation_curves_008.png
         :alt: Selection Strategy
         :srcset: /auto_examples/images/sphx_glr_plot_validation_curves_008.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_examples_plot_validation_curves.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_validation_curves.py <plot_validation_curves.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_validation_curves.ipynb <plot_validation_curves.ipynb>`
