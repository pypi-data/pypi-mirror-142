...
code_text = 'code\n简介:TopFintech服务器接受的证券代码格式一般为 "{官方交易代码}.{后缀}"，例如: "000001.SZ"。股票、ETF代码后缀包括:SH,SZ,BJ(证券挂牌市场),中国市场指数代码一般为"CNi".' 
