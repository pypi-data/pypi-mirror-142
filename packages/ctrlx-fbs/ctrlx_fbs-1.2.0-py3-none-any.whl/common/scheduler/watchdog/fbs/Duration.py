...
def AddTime(builder, time):
    return DurationAddTime(builder, time)
...
def AddErrorReaction(builder, errorReaction):
    return DurationAddErrorReaction(builder, errorReaction)
