...
def FrameStatisticResetRequestStart(builder): builder.StartObject(7)
def Start(builder):
...
def FrameStatisticResetRequestAddNumLostFrames(builder, numLostFrames): builder.PrependBoolSlot(2, numLostFrames, 0)
def AddNumLostFrames(builder, numLostFrames):
    return FrameStatisticResetRequestAddNumLostFrames(builder, numLostFrames)
def FrameStatisticResetRequestAddNumCyclicFrames(builder, numCyclicFrames): builder.PrependBoolSlot(3, numCyclicFrames, 0)
...
def FrameStatisticResetRequestAddNumCyclicDatagrams(builder, numCyclicDatagrams): builder.PrependBoolSlot(4, numCyclicDatagrams, 0)
...
def FrameStatisticResetRequestAddNumAcyclicFrames(builder, numAcyclicFrames): builder.PrependBoolSlot(5, numAcyclicFrames, 0)
...
def FrameStatisticResetRequestAddNumAcyclicDatagrams(builder, numAcyclicDatagrams): builder.PrependBoolSlot(6, numAcyclicDatagrams, 0)
