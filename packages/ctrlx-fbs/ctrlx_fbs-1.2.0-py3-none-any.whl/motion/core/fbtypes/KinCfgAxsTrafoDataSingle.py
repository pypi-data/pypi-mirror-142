...
def Start(builder):
    return KinCfgAxsTrafoDataSingleStart(builder)
...
def AddName(builder, name):
    return KinCfgAxsTrafoDataSingleAddName(builder, name)
...
def AddDescription(builder, description):
    return KinCfgAxsTrafoDataSingleAddDescription(builder, description)
...
def AddImage(builder, image):
    return KinCfgAxsTrafoDataSingleAddImage(builder, image)
...
def AddDocRef(builder, docRef):
    return KinCfgAxsTrafoDataSingleAddDocRef(builder, docRef)
...
def AddVersion(builder, version):
    return KinCfgAxsTrafoDataSingleAddVersion(builder, version)
def KinCfgAxsTrafoDataSingleAddPow(builder, pow): builder.PrependInt8Slot(5, pow, 1)
def AddPow(builder, pow):
    return KinCfgAxsTrafoDataSingleAddPow(builder, pow)
...
def AddParameters(builder, parameters):
    return KinCfgAxsTrafoDataSingleAddParameters(builder, parameters)
