...
def KinCfgStart(builder): builder.StartObject(7)
def Start(builder):
...
import motion.core.fbtypes.KinCfgAxsTrafoAllSets
...
class KinCfgT(object):
    ...
    def __init__(self):
        ...
        self.mcs = None  # type: Optional[motion.core.fbtypes.KinCfgAxsTrafoAllSets.KinCfgAxsTrafoAllSetsT]
    ...
    def _UnPack(self, kinCfg):
        ...
        if kinCfg.Mcs() is not None:
            self.mcs = motion.core.fbtypes.KinCfgAxsTrafoAllSets.KinCfgAxsTrafoAllSetsT.InitFromObj(kinCfg.Mcs())
