...
def Start(builder):
    return KinCfgAxsTrafoDataAllParamStart(builder)
...
def AddAxsAssignment(builder, axsAssignment):
    return KinCfgAxsTrafoDataAllParamAddAxsAssignment(builder, axsAssignment)
def KinCfgAxsTrafoDataAllParamStartAxsAssignmentVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartAxsAssignmentVector(builder, numElems):
    return KinCfgAxsTrafoDataAllParamStartAxsAssignmentVector(builder, numElems)
...
def AddParameter(builder, parameter):
    return KinCfgAxsTrafoDataAllParamAddParameter(builder, parameter)
...
def StartParameterVector(builder, numElems):
    return KinCfgAxsTrafoDataAllParamStartParameterVector(builder, numElems)
...
class KinCfgAxsTrafoDataAllParamT(object):
    ...
    def Pack(self, builder):
        if self.axsAssignment is not None:
            ...
            axsAssignment = builder.EndVector()
