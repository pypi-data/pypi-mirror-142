...
def Start(builder):
    return KinCfgAxsTrafoDataStart(builder)
...
def AddAxsTrafoData(builder, axsTrafoData):
    return KinCfgAxsTrafoDataAddAxsTrafoData(builder, axsTrafoData)
def KinCfgAxsTrafoDataStartAxsTrafoDataVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartAxsTrafoDataVector(builder, numElems):
    return KinCfgAxsTrafoDataStartAxsTrafoDataVector(builder, numElems)
...
class KinCfgAxsTrafoDataT(object):
    ...
    def Pack(self, builder):
        if self.axsTrafoData is not None:
            ...
            axsTrafoData = builder.EndVector()
