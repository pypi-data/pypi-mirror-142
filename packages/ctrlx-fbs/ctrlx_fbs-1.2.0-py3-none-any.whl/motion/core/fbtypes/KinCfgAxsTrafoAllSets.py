...
def Start(builder):
    return KinCfgAxsTrafoAllSetsStart(builder)
...
def AddAxsTrafoSets(builder, axsTrafoSets):
    return KinCfgAxsTrafoAllSetsAddAxsTrafoSets(builder, axsTrafoSets)
...
def StartAxsTrafoSetsVector(builder, numElems):
    return KinCfgAxsTrafoAllSetsStartAxsTrafoSetsVector(builder, numElems)
