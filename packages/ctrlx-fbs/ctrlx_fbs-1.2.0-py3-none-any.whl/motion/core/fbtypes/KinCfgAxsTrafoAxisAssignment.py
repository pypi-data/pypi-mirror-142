...
def Start(builder):
    return KinCfgAxsTrafoAxisAssignmentStart(builder)
...
def AddAssignment(builder, assignment):
    return KinCfgAxsTrafoAxisAssignmentAddAssignment(builder, assignment)
...
def StartAssignmentVector(builder, numElems):
    return KinCfgAxsTrafoAxisAssignmentStartAssignmentVector(builder, numElems)
