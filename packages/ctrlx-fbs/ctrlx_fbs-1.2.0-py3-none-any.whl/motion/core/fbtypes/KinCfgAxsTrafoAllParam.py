...
def Start(builder):
    return KinCfgAxsTrafoAllParamStart(builder)
...
def AddAxisAssignment(builder, axisAssignment):
    return KinCfgAxsTrafoAllParamAddAxisAssignment(builder, axisAssignment)
...
def AddGroups(builder, groups):
    return KinCfgAxsTrafoAllParamAddGroups(builder, groups)
...
def StartGroupsVector(builder, numElems):
    return KinCfgAxsTrafoAllParamStartGroupsVector(builder, numElems)
...
def AddGeneral(builder, general):
    return KinCfgAxsTrafoAllParamAddGeneral(builder, general)
