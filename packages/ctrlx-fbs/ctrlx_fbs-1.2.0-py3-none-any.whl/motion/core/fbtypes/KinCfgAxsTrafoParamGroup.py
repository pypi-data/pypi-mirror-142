...
def Start(builder):
    return KinCfgAxsTrafoParamGroupStart(builder)
...
def AddName(builder, name):
    return KinCfgAxsTrafoParamGroupAddName(builder, name)
...
def AddParam(builder, param):
    return KinCfgAxsTrafoParamGroupAddParam(builder, param)
...
def StartParamVector(builder, numElems):
    return KinCfgAxsTrafoParamGroupStartParamVector(builder, numElems)
