...
def Start(builder):
    return KinCfgAxsTrafoSingleAxisAssignmentStart(builder)
...
def AddAxisName(builder, axisName):
    return KinCfgAxsTrafoSingleAxisAssignmentAddAxisName(builder, axisName)
...
def AddIndexACS(builder, indexACS):
    return KinCfgAxsTrafoSingleAxisAssignmentAddIndexACS(builder, indexACS)
