...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL("""
            create function is_permission_not_default(permission_to_check integer)
            returns boolean
            security definer
            language sql
            as
            $$
                ...
                WHERE id = permission_to_check
            $$;
        """, reverse_sql="drop function is_permission_not_default(integer);"),
        migrations.RunSQL("""alter function is_permission_not_default(integer) owner to postgres;"""),
        ...
        #             privileged_user_has_group(current_user, group_id)
        #             AND
        #             is_permission_not_default(permission_id)
        #         );
