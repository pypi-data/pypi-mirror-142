...
class LinkModelDataSet:
	...
	def stepsPerEpoch(self,stepsPerEpoch:int):
		...
		if type(stepsPerEpoch) == int and stepsPerEpoch >= 15:
			...
			print("Invalid input type or value less than 15 given for stepsPerEpoch\n\n")
	...
	def validationSteps(self,validationSteps:int):
		...
		if type(validationSteps) == int and validationSteps >= 15:
			...
			print("Invalid input type or value less than 15 given for validationSteps\n\n")
	...
	def layersFreeze(self,layersFreeze:list):
		...
		default: None
		'''
		if type(layersFreeze)== list and all(isinstance(sub, str) for sub in layersFreeze):
	...
	def setLearningRateSchedulerCallback(self, factor:float, patience:int):
		...
		if type(factor)== float and type(patience)==int:
			...
			print("Invalid datatype for arguments given for setLearningRateSchedulerCallback\n\n")
	...
	def modelCheckpointCallback(self, monitor:str, save_best_only:bool):
		...
		if type(monitor)== str and type(save_best_only)==bool:
			...
			print("Invalid datatype for arguments given for modelCheckpointCallback\n\n")
