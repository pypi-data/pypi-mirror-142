...
class BackTestingEngine:
    ...
    def multidim_backtest(self, shift=None, benchmark=None, groups=None, plotit=False,
                          perf_cal_return="gross_return", name=None, save_to: str=None, fig_size=(12, 12), os_date=None):
        ...
        if plotit:
            self.plot_pnl(ls_pnl, lsidx_pnl, group_pnl, name=name, size=fig_size, save_to=save_to, os_date=os_date)
    ...
    def combo_backtest(self, shift=None, benchmark=None, plotit=False, perf_cal_return="gross_return",
                       name=None, save_to=None, fig_size=(12, 12), os_date=None):
        if shift is None:
            shift = self.ctx.shift
        if benchmark is None:
            benchmark = self.ctx.benchmark
    ...
    @staticmethod
    def plot_pnl(ls, lsidx, gprtr, name=None, size=(12, 12), save_to=None, os_date=None):
    ...
    @staticmethod
    def plot_comb_pnl(l_pnl, lsidx_pnl, name=None, size=(12, 12), save_to=None, os_date=None):
        dateFmt = mdate.DateFormatter('%Y%m%d')
        plt.figure(figsize=size)
