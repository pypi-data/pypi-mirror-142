...
from fib_py.fib_calcs.fib_nums import calculate_numbers


class Test(TestCase):
    @patch("fib_py.fib_calcs.fib_nums.recurring_fibonacci_number")
    def test_calculate_numbers(self, mock_fib_calc):
        expected_outcome = [mock_fib_calc.return_value, mock_fib_calc.return_value]
        self.assertEqual(expected_outcome, calculate_numbers([3, 4]))
    ...
    def test_functional(self):
        self.assertEqual([2, 3, 5], calculate_numbers([3, 4, 5]))
