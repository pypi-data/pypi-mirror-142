...
from lino.core.constants import CHOICES_BLANK_FILTER_VALUE, DISPLAY_MODE_STORY
...
class CommentsByRFC(CommentsByX):
    ...
    display_mode_slave = constants.DISPLAY_MODE_SUMMARY
...
class RepliesByComment(CommentsByX):
    ...
    stay_in_grid = True
    # display_mode_main = DISPLAY_MODE_STORY
    # title = _("Replies")
    label = _("Replies")
    simple_slavegrid_header = True
