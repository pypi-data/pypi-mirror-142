...
def hash_(StringToHash:str, hash_code:str, return_type="hex") -> str: # tested
    """
...
def gen_random_password(length:int) -> str: # tested
    """
...
def generate_key(password:str, salt:bytes, dkLen:int) -> bytes:
    if len(password) == 0:
        return 1
    pass
...
class Ciphers: # tested
    ...
    def generate_symmetric_key(self, salt=None) -> 'tuple[bytes, bytes]': # tested
