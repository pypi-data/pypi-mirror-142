...
# ci = ConnectionInfo(dialect="esapi", name="es", host="120.92.209.197", port=9210, user="zhengyang",
#                     password="158022", enable=True)
# pool = EsPool(ci).create_pool()
# es = EsHelper(pool)
# res = es.format_es_return([], ["_id"], "core.company_lite", None, 100, 0, False)
# print(res)
