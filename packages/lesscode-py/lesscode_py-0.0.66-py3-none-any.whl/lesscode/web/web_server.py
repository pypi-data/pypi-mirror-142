...
define("app_name", default="", type=str, help="app name")
define("instance_ip", default="", type=str, help="项目实例ip或者域名")
# 日志初始化配置，配置文件中可修改设置
...
class WebServer:
    ...
    def start(self, num_processes: Optional[int] = 1, max_restarts: int = None):
        if options.eureka_enable:
            ...
            app_name = options.app_name if options.app_name else options.application_name
            instance_ip = options.instance_ip if options.instance_ip else "127.0.0.1"
