...
from  enaptorch import is_in_jupyter_notebook
    ...
    *,
    ...
    Args:
        history (Union[List[Dict[str, Union[float, int]]], pandas.DataFrame]): The training history to plot. Can be
            either a list of dictionary as returned by :func:`~ enaptorch.Model.fit()` or a Pandas DataFrame as read from a
            CSV output by the :class:`~ enaptorch.CSVLogger` callback.
