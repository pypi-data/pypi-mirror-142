...
class LambdaCallback(Callback):
    ...
    Args:
        kwargs: The arguments of this class are keyword arguments with the same names as the methods in the
            :class:`~ enaptorch.Callback` class. The values are lambdas or functions taking the same arguments as the
            corresponding methods in :class:`~ enaptorch.Callback`.

    See:
        :class:`~ enaptorch.Callback`

    Example:
        .. code-block:: python

            from  enaptorch import LambdaCallback
