...
class ModelCheckpoint(PeriodicSaveCallback):
    ...
    :class:`~ enaptorch.PeriodicSaveCallback` for the arguments' descriptions.

    See:
        :class:`~ enaptorch.PeriodicSaveCallback`
    """
...
class OptimizerCheckpoint(PeriodicSaveCallback):
    ...
    See :class:`~ enaptorch.PeriodicSaveCallback` for the arguments' descriptions.
