...
class NotificationCallback(Callback):
    ...
    Args:
        notificator (~ enaptorch.Notificator): The notification channel to send the message.
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from  enaptorch.framework.callbacks.notification import NotificationCallback
