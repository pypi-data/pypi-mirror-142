...
def acc(y_pred, y_true, *, ignore_index=-100, reduction='mean'):
    ...
    This is a functional version of :class:`~ enaptorch.Accuracy`.

    See :class:`~ enaptorch.Accuracy` for details.
    """
...
def bin_acc(y_pred, y_true, *, threshold=0.0, reduction='mean'):
    ...
    This is a functional version of :class:`~ enaptorch.BinaryAccuracy`.

    See :class:`~ enaptorch.BinaryAccuracy` for details.
    """
...
def topk(y_pred, y_true, k, *, ignore_index=-100, reduction='mean'):
    ...
    This is a functional version of :class:`~ enaptorch.TopKAccuracy`.

    See :class:`~ enaptorch.TopKAccuracy` for details.
    """
