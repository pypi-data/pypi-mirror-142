...
class Plugin(AbstractPlugin):
    ...
    def downMusic(self, keyword):
        ...
        ffmpeg.run(ffmpeg.output(ffmpeg.input(Constants.TEMP_PATH + 'music.mp3'),
                                 Constants.TEMP_PATH + 'music.wav'), quiet=True, overwrite_output=True)
    ...
    def handle(self, query):
        try:
            ...
            self.playThread(Constants.TEMP_PATH + 'music.wav')
        except:
            pass
