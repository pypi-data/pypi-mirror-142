...
setup(
    ...
    packages=[
        ...
        "masonite_permission.constants",
        "masonite_permission.controllers",
        "masonite_permission.drivers",
        "masonite_permission.providers",
        "masonite_permission.routes",
        "masonite_permission.resources",
        "masonite_permission.templates",
    ],
    package_dir={"": "src"},
