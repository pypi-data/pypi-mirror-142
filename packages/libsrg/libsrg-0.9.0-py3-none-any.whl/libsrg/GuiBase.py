...
class GuiBase(libsrg.LoggingAppBase):
    logger = logging.getLogger("GuiBase")

    def __init__(self, appcontrol, guirequests):
        ...
        me = Path(sys.argv[0])
        self.here = me.parent
        logfile = str(self.here / "GuiBase.log")
        ###
        libsrg.LoggingAppBase.__init__(self, logfile=logfile)
        ###
        # print("Hello\n")
