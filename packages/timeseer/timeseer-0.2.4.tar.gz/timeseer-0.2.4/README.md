...
```
> docker run --rm -v $pwd\docs\source\kukur:/documents/source/kukur curlimages/curl --config /documents/source/kukur/urls.curl
> docker run --rm -v $pwd\docs\source:/documents/source -v $pwd\timeseer\web\templates\docs:/documents/timeseer/out asciidoctor/docker-asciidoctor asciidoctor -r asciidoctor-diagram --destination-dir timeseer/out --no-header-footer source/*.asciidoc
