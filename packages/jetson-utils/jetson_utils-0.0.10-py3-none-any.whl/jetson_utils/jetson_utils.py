...
class JetsonUtils:
    ...
    def get_serial_uuid(self):
        serial_uuid = os.system("cat /proc/device-tree/chosen/uuid")
        return str(serial_uuid)

    def get_cpu_temperature(self) -> int:
        return os.system("cat /sys/class/thermal/thermal_zone1/temp")
        # return (float(cpu_temp) / 1000)

    def get_gpu_temperature(self) -> int:
        return os.system("cat /sys/class/thermal/thermal_zone2/temp")
