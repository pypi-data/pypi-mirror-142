...
def direct_property_check(tar_file, extension):
    ...
    error_message = {
        "IDError":"Invalid Direct Property ID. It MUST end with / and SHOULD be ./",
        "TypeError": "Invalid Type Value at Direct Property ./",
        "DateError": "datePublished of Direct Property ./ is not in ISO 8601 date format or not Provided"
    }
   https://spdx.org/licenses/CC-BY-NC-SA-4.0 
    ...
    context, metadata = rocrate.read_metadata("ro-crate-metadata.json")
    ...
    try:
        ...
        if type_property(direct_property_entity, type):
            ...
            return Result(NAME, code = -1, message = "TypeError")
    except:
        return Result(NAME, code = -1, message = "IDError")
