...
def run_cmd(cmd, workingdir=".", netcdf_format="CF", cmd_header=None, prefix=""):
    ...
    script = script.format(
        workingdir=workingdir, cmd=cmd, netcdf_format=netcdf_format, prefix=prefix
    )
    popen = Popen("bash", stdout=PIPE, stderr=PIPE, stdin=PIPE, universal_newlines=True)
