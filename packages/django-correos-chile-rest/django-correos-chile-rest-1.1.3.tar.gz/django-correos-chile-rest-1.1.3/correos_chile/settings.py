"""
Settings for Linets with correos chile courier are all namespaced in the LINETS setting.
...
DJANGO_CORREOS_CHILE = {
    'CORREOS_CHILE': {
        ...
        'LABEL_TYPE': '<CORREOS_CHILE_LABEL_TYPE>',
    },
    'SENDER': {
...
DEFAULTS = {
    'CORREOS_CHILE': {
        'BASE_URL': '<CORREOS_CHILE_BASE_URL>',
        'USER': '<CORREOS_CHILE_USER>',
        'PASSWORD': '<CORREOS_PASSWORD>',
        'TOKEN': '<CORREOS_CHILE_TOKEN>',
        'COD_SERVICIO': '<CORREOS_CHILE_COD_SERVICIO>',
        'COD_REF': '<CORREOS_CHILE_COD_REF>',
        'TYPE_POR': '<CORREOS_CHILE_TYPE_FOR>',
        'DEV_CON': '<CORREOS_CHILE_DEV_CON>',
        'LABEL_TYPE': '<CORREOS_CHILE_LABEL_TYPE>',
    },
    'SENDER': {
