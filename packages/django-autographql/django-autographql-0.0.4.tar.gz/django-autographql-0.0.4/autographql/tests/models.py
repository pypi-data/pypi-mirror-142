...
from autographql.models import GraphQLModel


class Region(GraphQLModel):
...
class Territories(GraphQLModel):
...
class CustomerDemographics(GraphQLModel):
...
class OrderDetails(GraphQLModel):
