...
class Neutralizer:
    def init_neutralization_rxns(self, reactants_products={'[$([O-]);!$([O-][#7])]': 'O'}):
    ...
    def neutralize_charges(self, mols, reactants_products={'[$([O-]);!$([O-][#7])]': 'O'}):
        ...
        """
        reactions = self.init_neutralization_rxns(reactants_products=reactants_products)
