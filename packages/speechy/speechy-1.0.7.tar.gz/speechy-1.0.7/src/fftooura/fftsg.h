...
// member variables
private:
  double *SinusTable[18];
	double *CosinusTable[18];
	int powertwo[18]; // mdb bugfix. was [14] 
public:

  __inline void cftbsub(int n, float* a)
  {
  ...
  __inline void cdft(int n, int isgn, float *a)
  {
  ...
  __inline void rdft(int n, int isgn, float *a)
  {
      /*void cftfsub(int n, float *a);
      void cftbsub(int n, float *a);
  ...
  __inline void ddct(int n, int isgn, float *a)
  {
      /*void cftfsub(int n, float *a);
      void cftbsub(int n, float *a);
      void rftfsub(int n, float *a);
  ...
  __inline void ddst(int n, int isgn, float *a)
  {
      /*void cftfsub(int n, float *a);
      void cftbsub(int n, float *a);
      void rftfsub(int n, float *a);
  ...
  __inline void dfct(int n, float *a)
  {
  ...
  __inline void dfst(int n, float *a)
  {
  ...
  __inline void cftfsub(int n, float *a)
  {
  ...
  __inline void bitrv2(int n, float *a)
  {
  ...
  __inline void bitrv2conj(int n, float *a)
  {
      int j0, k0, j1, k1, l, m, i, j, k, nh;
      float xr, xi, yr, yi;
  ...
  __inline void bitrv216(float *a)
  {
  ...
  __inline void bitrv216neg(float *a)
  {
      float x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, 
  ...
  __inline void bitrv208(float *a)
  {
  ...
  __inline void bitrv208neg(float *a)
  {
      float x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, 
  ...
  __inline void bitrv1(int n, float *a)
  {
      int j0, k0, j1, k1, l, m, i, j, k, nh;
      float x;
  ...
  __inline void cftb1st(int n, float *a)
  {
  ...
  __inline void cftrec4_th(int n, float *a)
  {
  ...
  __inline void *cftrec1_th(void *p)
  {
  ...
  __inline void *cftrec2_th(void *p)
  {
      int cfttree(int n, int j, int k, float *a);
      void cftleaf(int n, int isplt, float *a);
  ...
  __inline void cftrec4(int n, float *a)
  {
      /*int cfttree(int n, int j, int k, float *a);
      void cftleaf(int n, int isplt, float *a);
      void cftmdl1(int n, float *a);*/
  ...
  __inline int cfttree(int n, int j, int k, float *a)
  {
      /*void cftmdl1(int n, float *a);
      void cftmdl2(int n, float *a);*/
      int i, isplt, m;
  ...
  __inline void cftleaf(int n, int isplt, float *a)
  {
      /*void cftmdl1(int n, float *a);
      void cftmdl2(int n, float *a);
      void cftf161(float *a);
  ...
  __inline void cftmdl1(int n, float *a)
  {
      int i, i0, j, j0, j1, j2, j3, m, mh;
      float ew, w1r, w1i, wk1r, wk1i, wk3r, wk3i, 
          wd1r, wd1i, wd3r, wd3i, ss1, ss3;
  ...
  __inline void cftmdl2(int n, float *a)
  {
      int i, i0, j, j0, j1, j2, j3, m, mh;
  ...
  __inline void cftfx41(int n, float *a)
  {
      /*void cftf161(float *a);
      void cftf162(float *a);
      void cftf081(float *a);
  ...
  __inline void rftfsub(int n, float *a)
  {
      int i, i0, j, k;
  ...
  __inline void rftbsub(int n, float *a)
  {
      int i, i0, j, k;
      float ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
  ...
  __inline void dctsub(int n, float *a)
  {
      int i, i0, j, k, m;
      float ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
  ...
  __inline void dstsub(int n, float *a)
  {
      int i, i0, j, k, m;
      float ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
  ...
  __inline void dctsub4(int n, float *a)
  {
      int m;
  ...
  __inline void dstsub4(int n, float *a)
  {
      int m;
      float wki, wdr, wdi, xr;
