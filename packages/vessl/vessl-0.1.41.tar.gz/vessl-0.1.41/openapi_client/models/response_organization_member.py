...
class ResponseOrganizationMember(object):
    ...
    def __init__(self, created_dt=None, display_name=None, email=None, id=None, permission=None, status=None, updated_dt=None, username=None, local_vars_configuration=None):  # noqa: E501
