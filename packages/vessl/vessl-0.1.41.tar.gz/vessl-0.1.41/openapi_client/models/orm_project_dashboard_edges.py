...
class OrmProjectDashboardEdges(object):
    ...
    def __init__(self, chart_sections=None, created_by=None, field_configs=None, filters=None, last_updated_by=None, project=None, sorts=None, starred_users=None, local_vars_configuration=None):  # noqa: E501
