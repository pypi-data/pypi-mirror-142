...
class OrmOrganization(object):
    ...
    def __init__(self, aws_external_id=None, created_dt=None, credit_balance=None, default_region=None, description=None, display_name=None, edges=None, id=None, immutable_slug=None, is_public=None, name=None, organization_default_storage=None, organization_default_volume=None, organization_primary_owner=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
