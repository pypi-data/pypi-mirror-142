...
class OrmExperimentEdges(object):
    ...
    def __init__(self, access_token=None, created_by=None, model_generated_experiments=None, models=None, plot_volume=None, project=None, sweep=None, tags=None, workloads=None, local_vars_configuration=None):  # noqa: E501
