...
class matrix_operations:
    ...
    def orthonormalize(self, a, rank=None):
        ...
        # Call C-accessible Fortran wrapper.
        clib.c_orthonormalize(ctypes.byref(a_dim_1), ctypes.byref(a_dim_2), ctypes.c_void_p(a.ctypes.data), ctypes.byref(rank_present), ctypes.byref(rank))
    
        # Return final results, 'INTENT(OUT)' arguments only.
        return a, (rank.value if rank_present else None)
