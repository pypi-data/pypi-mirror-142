...
class BuildConfig:
    c_compiler = r""
    cxx_compiler = r"C:/Program Files/Microsoft Visual Studio/2022/Enterprise/VC/Tools/MSVC/14.31.31103/bin/Hostx64/x64/cl.exe"
    llvm_symbolizer = r"C:/Users/VssAdministrator/.conan/data/RoboCodeLLVM/llvmorg-13.0.1/admin/stable/package/0a420ff5c47119e668867cdb51baff0eca1fdb68/bin/llvm-symbolizer.exe"
    llvm_custom_path = r""
    use_libcxx = r"OFF"
