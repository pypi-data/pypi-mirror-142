...
from ingestor.common.constants import CONTENT_ID, YEAR, DURATION_MINUTE, CATEGORY_ID, \
    ...
    CONTENT_CORE, PACKAGES, PRODUCTS, PACKAGE_ID, PRODUCT_ID, TAG_ID, SEASON_ID, ID_CONTENT, TITLE, SYNOPSIS_BH, \
    SYNOPSIS_EN, TYPE, STATUS, IS_FREE, IS_ORIGINAL, IS_EXCLUSIVE, IS_BRANDED, IS_GEO_BLOCK, START_DATE, MODIFIED_ON, \
    END_DATE
...
class CommonUtils:
    ...
    def fetch_prepare_synopsis(content_df,df_content):
        content_df[SYNOPSIS_BH] = [str(df_content[SYNOPSIS_BH].loc[0])]
        return content_df
    @staticmethod
