...
from rusty_python_fib.fib_calcs.fib_number import recurring_fibonacci_number


class RecurringFibonacciNumber(TestCase):
    def test_zero(self):
    ...
    def test_negative(self):
        ...
        self.assertEqual(
            "Fibonacci has to be equal or greater than zero",
