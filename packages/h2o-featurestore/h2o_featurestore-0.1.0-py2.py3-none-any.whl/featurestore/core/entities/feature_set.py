...
class FeatureSet:
    def __init__(self, stub, feature_set):
        ...
        self._stub = stub
        self._feature_set_header = OnlineApi.FeatureSetHeader()
...
class TimeToLive:
    ...
    def ttl_offline_interval(self):
        return TimeToLiveApi.Offline.TimeToLiveInterval.Name(
            self._ttl.ttl_offline_interval
        )
    ...
    def ttl_offline_interval(self, value):
        ...
        if value.upper() in valid_units:
            self._ttl.ttl_offline_interval = TimeToLiveApi.Offline.TimeToLiveInterval.Value(
                value.upper()
            )
        else:
            raise Exception(
    ...
    def ttl_online_interval(self, value):
        ...
        if value.upper() in valid_units:
            self._ttl.ttl_online_interval = TimeToLiveApi.Online.TimeToLiveInterval.Value(
                value.upper()
            )
        else:
            raise Exception(
