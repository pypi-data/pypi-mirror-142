...
class FeatureSet:
    ...
    def special_data(self):
        return SpecialData(self._stub, self)
...
class SpecialData:
    ...
    def spi(self, value):
        ...
        update_request.new_value = value
        update_request.header.CopyFrom(self._fs._feature_set_header)
        self._stub.UpdateFeatureSetSpecialDataSpi(update_request)
        self._fs.refresh()
    ...
    def pci(self, value):
        ...
        update_request.new_value = value
        update_request.header.CopyFrom(self._fs._feature_set_header)
        self._stub.UpdateFeatureSetSpecialDataPci(update_request)
        self._fs.refresh()
    ...
    def rpi(self, value):
        ...
        update_request.new_value = value
        update_request.header.CopyFrom(self._fs._feature_set_header)
        self._stub.UpdateFeatureSetSpecialDataRpi(update_request)
        self._fs.refresh()
    ...
    def demographic(self, value):
        ...
        update_request.new_value = value
        update_request.header.CopyFrom(self._fs._feature_set_header)
        self._stub.UpdateFeatureSetSpecialDataDemographic(update_request)
        self._fs.refresh()
    ...
    def __repr__(self):
        return Utils.pretty_print_proto(self._fs._feature_set._special_data)
...
class Legal:
    ...
    def approved(self, value):
        ...
        update_request.new_value = value
        update_request.header.CopyFrom(self._fs._feature_set_header)
        self._stub.UpdateLegalApproved(update_request)
        self._fs.refresh()
    ...
    def notes(self, value):
        ...
        update_request.new_value = value
        update_request.header.CopyFrom(self._fs._feature_set_header)
        self._stub.UpdateLegalApprovedNotes(update_request)
        self._fs.refresh()
