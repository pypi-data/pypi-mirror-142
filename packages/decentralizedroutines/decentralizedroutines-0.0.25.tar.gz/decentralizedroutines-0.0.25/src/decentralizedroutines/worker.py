...
try:
    Logger.log.info('Initializing decentralizedroutines worker %s version %s...' % \
        (username,version('decentralizedroutines')))
except:
...
try:
    Logger.log.info('Initializing decentralizedroutines worker %s version %s STARTED!' % \
        (username,version('decentralizedroutines')))
except:
