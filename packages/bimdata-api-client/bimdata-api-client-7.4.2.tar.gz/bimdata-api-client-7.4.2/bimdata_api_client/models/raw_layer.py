...
class RawLayer(object):
    ...
    def __init__(self, id=None, name=None, description=None, identifier=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this RawLayer.  # noqa: E501


        :return: The id of this RawLayer.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this RawLayer.


        :param id: The id of this RawLayer.  # noqa: E501
        :type: int
        """
