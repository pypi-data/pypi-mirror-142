...
class Simulator(object):
    ...
    def __init__(self, history=None, minphase=2520, maxphase=None):
    ...
    def run_rollouts(self, n_rollouts, n_iters=0, until_height=None, until_time=None):
        ...
        if until_time is not None:
            ...
            if isinstance(until_time, str):
                until_time = dateparser.parse(until_time, settings={'PREFER_DATES_FROM': 'future'})

            if hasattr(until_time, 'timestamp'):
