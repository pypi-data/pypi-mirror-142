...
def brush_select(sculpt_tool: str = 'DRAW', vertex_tool: str = 'DRAW', weight_tool: str = 'DRAW', image_tool: str = 'DRAW', gpencil_tool: str = 'DRAW', gpencil_vertex_tool: str = 'DRAW', gpencil_sculpt_tool: str = 'SMOOTH', gpencil_weight_tool: str = 'WEIGHT', curves_sculpt_tool: str = 'TEST1', toggle: bool = False, create_missing: bool = False) -> None:
