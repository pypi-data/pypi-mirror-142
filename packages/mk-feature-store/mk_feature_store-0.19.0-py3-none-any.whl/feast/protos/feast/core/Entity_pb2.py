...
_ENTITYSPECV2_TAGSENTRY = _descriptor.Descriptor(
  name='TagsEntry',
  full_name='feast.core.EntitySpecV2.TagsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='feast.core.EntitySpecV2.TagsEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='feast.core.EntitySpecV2.TagsEntry.value', index=1,
...
_ENTITYSPECV2 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='join_key', full_name='feast.core.EntitySpecV2.join_key', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tags', full_name='feast.core.EntitySpecV2.tags', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='owner', full_name='feast.core.EntitySpecV2.owner', index=6,
  ...
  nested_types=[_ENTITYSPECV2_TAGSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_ENTITYSPECV2_TAGSENTRY.containing_type = _ENTITYSPECV2
_ENTITYSPECV2.fields_by_name['value_type'].enum_type = feast_dot_types_dot_Value__pb2._VALUETYPE_ENUM
_ENTITYSPECV2.fields_by_name['tags'].message_type = _ENTITYSPECV2_TAGSENTRY
