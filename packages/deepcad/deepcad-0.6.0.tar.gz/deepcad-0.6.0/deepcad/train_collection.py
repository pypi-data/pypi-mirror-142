...
class training_class():
    ...
    def train(self):
        ...
        if self.colab_display:
            ...
            print('Displaying denoised file of the last epoch: ', result_img_list[-1])
            display_img(results_path+'/'+result_img_list[-1],norm_min_percent=1, norm_max_percent=99, scale_num=1)
