...
class TypeStatistics(models.Model):
    ...
    buy_5_percent = models.DecimalField(
        _("Buy 5th Percentile"),
        max_digits=5,
        decimal_places=2
        )
    sell_5_percent = models.DecimalField(
    ...
    class Meta:
        ...
        default_permissions = ()
        constraints = [
            models.UniqueConstraint(fields=['eve_type', 'eve_region'], name="EveTypeEveRegionTypeStatistic"),
        ]
