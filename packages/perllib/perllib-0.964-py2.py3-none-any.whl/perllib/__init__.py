# perllib module for pythonizer, generated by makelib.py on Mon Mar 14 00:15:16 2022
#
...
def fileinput_next(files=None, inplace=False, backup='',*, mode='r', openhook=None, encoding=None, errors=None):
    ...
    if _fileinput_iter is None:
        try:
            (mode, encoding, errors) = handle_open_pragma(mode, encoding, errors)
        except NameError:
            pass
        try:
...
def handle_open_pragma(mode, encoding, errors):
