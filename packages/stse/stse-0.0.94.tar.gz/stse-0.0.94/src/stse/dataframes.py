...
class Dataframes:
    ...
    def id_nearest_col(self, df, name, case_insensitive=True):  # *
    ...
    def remove_header_chars(self, df, chars, case_insensitive=True):  # *
    ...
    def convert_to_nan(self, df, na=('', 'nan', 'none')):  # *
    ...
    def non_num_to_nan(self, df, columns):  # *
    ...
    def nan_col_indices(self, df, column_name):  # *
    ...
    def remove_nan_cols(self, df):  # *
        ...
        """
        return self.convert_to_nan(df).dropna(axis=1, how="all")

    def remove_nan_rows(self, df, value_column_names):  # *
