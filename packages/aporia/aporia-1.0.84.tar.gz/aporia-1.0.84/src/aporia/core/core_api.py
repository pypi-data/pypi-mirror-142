...
def create_model_version(
    ...
    Args:
        ...
        labels: Labels of multi-label, multiclass or binary model. Takes precedence over "multiclass_labels".
        ...
        mapping: General mapping. Allowed fields are:
    ...
    if multiclass_labels is not None:
        warnings.warn(
            '"multiclass_labels" parameter is deprecated, please use "labels".',
            DeprecationWarning,
            stacklevel=3,
        )
