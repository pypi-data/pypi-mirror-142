...
class DatasetUsage:
    ...
    def from_dict(obj: Any) -> 'DatasetUsage':
        ...
        return DatasetUsage(id, aspect_type, created_at, entity_id, field_query_counts, dataset_usage_id, latest, query_counts, recent_queries, table_joins)
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, dataset_created_at, deleted_at, documentation, entity_type, field_statistics, dataset_id, last_modified_at, logical_id, properties, schema, soda_data_quality, source_info, statistics, support_info, upstream, usage, usage_history)
