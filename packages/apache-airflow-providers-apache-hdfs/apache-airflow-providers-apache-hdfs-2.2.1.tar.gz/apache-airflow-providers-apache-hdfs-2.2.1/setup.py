...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0', 'hdfs[avro,dataframe,kerberos]>=2.0.4', 'snakebite-py3'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-apache-hdfs/2.2.1/',
