...
def create_and_populate_volume(job):
    ...
    if repo_url and commit:
        ...
        # print("@@@@@@@@@@@@")
        # print("project_file", workspace_dir, extra_dirs)
...
def copy_local_workspace_to_volume(volume, workspace_dir, extra_dirs):
    ...
    project_file = os.path.join(workspace_dir, "project.yaml")
...
def finalise_job(job):
    ...
    for filename in job.output_files:
        ...
        # docker.copy_from_volume(volume, "/", workspace_dir / filename)
        print("docker.copy_from_volume()", volume, filename, workspace_dir / filename)
