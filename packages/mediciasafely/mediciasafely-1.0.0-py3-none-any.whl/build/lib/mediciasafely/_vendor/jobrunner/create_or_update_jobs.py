...
def assert_new_jobs_created(new_jobs, current_jobs):
    ...
    print("pending", pending, len(pending))
    print("running", running, len(running))
    print("succeeded", succeeded, len(succeeded))
    print("failed", failed, len(failed))
    print("current_jobs", current_jobs, len(current_jobs))
