...
from hestia_earth.models.log import logger, logErrorRun, debugRequirements
...
def download(term: str, site: dict, data: dict, by_region=True) -> dict:
    ...
    try:
        ...
        debugRequirements(collection=collection, time=f"{current_time_ms() - now}ms", properties=properties)
        return properties
    except Exception as e:
