...
from hestia_earth.models.utils.cycle import get_excreta_N_total, get_max_rooting_depth, valid_site_type
...
def _should_run(cycle: dict, term=TERM_ID, tier=TIER):
    ...
    should_run = all([site_type_valid, clay, sand, rainfall, rooting_depth])
