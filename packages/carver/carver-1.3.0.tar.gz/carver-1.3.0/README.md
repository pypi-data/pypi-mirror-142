...
## NOTE
This is just a fork of Whittler. Permission was granted from the author to fork and automate the build and 
publishing in order to accommodate new features coming out.
## About
