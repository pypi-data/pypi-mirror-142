...
class FareCalculator:
    ...
    def __init__(self,
        ...
        Args:
            ...
            volatile_passenger_calc_script: расчет постоянных надбавок/скидок для стоимости провоза багажа
            permanent_baggage_calc_script: расчет временных надбавок/скидок для стоимости проезда
    ...
    def _communicate(self, process: subprocess.Popen, code: Code, module: str, offset: int) -> str:
        ...
        if stderr:
            stderr = stderr.decode(self.UTF8).lsjourney().replace(", in <module>", ":")
