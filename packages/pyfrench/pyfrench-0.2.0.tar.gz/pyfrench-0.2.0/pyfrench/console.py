...
class terminal():
    def clear():
        if name == "nt":
            ...
            system("clear")
    cls = clear()
    def pipInstall(nom: str):
        print("\033[1m" + "pyfrench -> pip install {}".format(nom))
        print("\033[0m")
        return system("pip install {}".format(nom))
    def pipUninstall(nom: str):
        print("\033[1m" + "pyfrench -> pip uninstall {}".format(nom))
        print("\033[0m")
        return system("pip uninstall {}".format(nom))
    def pipShow(nom: str):
        print("\033[1m" + "pyfrench -> pip show {}".format(nom))
        print("\033[0m")
        return system("pip show {}".format(nom))
    def pipList():
        print("\033[1m" + "pyfrench -> pip list")
        print("\033[0m")
        return system("pip list")
    def pipFreeze():
        print("\033[1m" + "pyfrench -> pip freeze")
        print("\033[0m")
        return system("pip freeze")
    def write(commande: str):
        print("\033[1m" + "pyfrench -> {}".format(commande))
