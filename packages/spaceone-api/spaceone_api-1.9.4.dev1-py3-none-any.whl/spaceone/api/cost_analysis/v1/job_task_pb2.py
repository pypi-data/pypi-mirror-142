...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _JOBTASK.methods_by_name['get']._serialized_options = b'\202\323\344\223\002*\022(/cost-analysis/v1/job-task/{job_task_id}'
  _JOBTASK.methods_by_name['list']._options = None
  _JOBTASK.methods_by_name['list']._serialized_options = b'\202\323\344\223\002C\022\033/cost-analysis/v1/job-tasksZ$\"\"/cost-analysis/v1/job-tasks/search'
  _JOBTASK.methods_by_name['stat']._options = None
  _JOBTASK.methods_by_name['stat']._serialized_options = b'\202\323\344\223\002\"\" /cost-analysis/v1/job-tasks/stat'
  _GETJOBTASKREQUEST._serialized_start=202
  _GETJOBTASKREQUEST._serialized_end=275
  _JOBTASKQUERY._serialized_start=278
  _JOBTASKQUERY._serialized_end=593
  _JOBTASKQUERY_STATUS._serialized_start=486
  _JOBTASKQUERY_STATUS._serialized_end=593
  _JOBTASKINFO._serialized_start=596
  _JOBTASKINFO._serialized_end=1054
  _JOBTASKINFO_STATUS._serialized_start=486
  _JOBTASKINFO_STATUS._serialized_end=593
  _JOBTASKSINFO._serialized_start=1056
  _JOBTASKSINFO._serialized_end=1152
  _JOBTASKSTATQUERY._serialized_start=1154
  _JOBTASKSTATQUERY._serialized_end=1245
  _JOBTASK._serialized_start=1248
  _JOBTASK._serialized_end=1707
