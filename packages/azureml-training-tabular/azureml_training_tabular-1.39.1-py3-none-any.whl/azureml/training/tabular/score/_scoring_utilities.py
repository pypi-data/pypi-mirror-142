...
from .._constants import Metric as metric_constants
...
from .._diagnostics.error_definitions import ArgumentOutOfRange, InsufficientMemory, InvalidMetricSpecified
...
def get_metric_class(metric_name):
    ...
    if metric_name not in class_map:
        raise AzureMLError.create(InvalidMetricSpecified, target="metric_name", metric=metric_name)
