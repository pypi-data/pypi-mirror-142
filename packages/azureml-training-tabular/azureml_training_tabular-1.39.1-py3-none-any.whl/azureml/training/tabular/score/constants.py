...
CLASSIFICATION_BINARY_SET = {AUC_BINARY, F1_BINARY, PRECISION_BINARY, RECALL_BINARY, AVERAGE_PRECISION_BINARY}
...
UNSUPPORTED_CLASSIFICATION_TABULAR_SET = (
    CLASSIFICATION_CLASSWISE_SET | CLASSIFICATION_MULTILABEL_SET | {CLASSIFICATION_REPORT}
)
...
REGRESSION_NORMALIZED_SET = {NORM_MEAN_ABS_ERROR, NORM_MEDIAN_ABS_ERROR, NORM_RMSE, NORM_RMSLE}
...
FULL_NONSCALAR_SET = CLASSIFICATION_NONSCALAR_SET | REGRESSION_NONSCALAR_SET | FORECASTING_NONSCALAR_SET
...
SAMPLE_WEIGHTS_UNSUPPORTED_SET = {SPEARMAN, WEIGHTED_ACCURACY, MEDIAN_ABS_ERROR, NORM_MEDIAN_ABS_ERROR}
