...
class EventRepeater(Controllable, RecurrenceSet, EventGenerator):

    class Meta:
        app_label = 'cal'
        verbose_name = _("Event repeater")
        verbose_name_plural = _("Event repeaters")
        abstract = dd.is_abstract_model(__name__, 'EventRepeater')
...
class Event(
    ...
    Publishable, GoogleCalendarEventSynchronized, Draggable, Controllable):
    ...
    repeater = models.ForeignKey('cal.EventRepeater', on_delete=models.SET_NULL, null=True, blank=True)
    ...
    def on_create(self, ar):
        if self.repeater is None:
            repeater = rt.models.cal.EventRepeater()
            repeater.full_clean()
            repeater.save()
        ...
        def get_duration():
            ...
            if oracle:
                raise NotImplementedError(
                    ...
                    "See: https://docs.djangoproject.com/en/3.2/ref/models/fields/#durationfield for help.")
