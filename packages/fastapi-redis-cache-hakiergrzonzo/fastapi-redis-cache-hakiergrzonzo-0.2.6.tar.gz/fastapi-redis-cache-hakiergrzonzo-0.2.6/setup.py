...
DESCRIPTION = "A patch to the simple and robust caching solution for FastAPI endpoints, fueled by the unfathomable power of Redis. Fixes the support for pydantic models."
