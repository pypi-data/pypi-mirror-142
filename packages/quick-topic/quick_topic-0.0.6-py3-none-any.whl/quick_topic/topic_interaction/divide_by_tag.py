...
def divide_by_tag(meta_csv_file,raw_text_folder,output_folder,list_category, start_year=2010,end_year=2021, tag_field="tag",keyword_field="keyword",year_field='year',time_field="time",id_field="Id",prefix_filename=""):
