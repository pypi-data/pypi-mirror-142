...
class Service:
    ...
    def register_service_blueprint(
        ...
        if service_blueprint.extend_parent_prefix and parent_prefix:
            ...
            service_blueprint.url_prefix = prefix
        else:
        ...
        self.app.register_blueprint(service_blueprint.blueprint)
    ...
    def _prepare_route(self, route: Type[Route]):
        self._instantiated_routes.append(route(self.app, authorizer=self.authorizer, cors=self.cors))
