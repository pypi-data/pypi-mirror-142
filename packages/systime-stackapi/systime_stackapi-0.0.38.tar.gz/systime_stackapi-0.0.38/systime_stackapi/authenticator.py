...
class Authenticator(object):
    def __init__(self, client_key_id, shared_secret, **kwargs):
        ...
        self.allowed_token_algorithms = kwargs.get('allowed_token_algorithms', ['HS256', 'HS384', 'HS512'])
    ...
    def validate_token_expiry(self, token, required_expiry_left):
        decoded_token = jwt.decode(token, verify=False, algorithms=self.allowed_token_algorithms)
