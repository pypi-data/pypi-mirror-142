 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    // the barrier on time.
    virtual ::grpc::Status ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::tensorflow::ShutdownAgentResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ShutdownAgentResponse>> AsyncShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ShutdownAgentResponse>>(AsyncShutdownAgentRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ShutdownAgentResponse>> PrepareAsyncShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ShutdownAgentResponse>>(PrepareAsyncShutdownAgentRaw(context, request, cq));
    }
    // Disconnects task from the service if it is in an ERROR state, thereby
    // allowing it to reconnect via RegisterWorker() in the future.
    virtual ::grpc::Status ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::tensorflow::ResetAgentResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ResetAgentResponse>> AsyncResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ResetAgentResponse>>(AsyncResetAgentRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ResetAgentResponse>> PrepareAsyncResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ResetAgentResponse>>(PrepareAsyncResetAgentRaw(context, request, cq));
    }
    ...
    class experimental_async_interface {
     public:
      ...
      // still disconnect, while an error is reported to tasks that did not reach
      // the barrier on time.
      virtual void ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ShutdownAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ShutdownAgentResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void ShutdownAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void ShutdownAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Disconnects task from the service if it is in an ERROR state, thereby
      // allowing it to reconnect via RegisterWorker() in the future.
      virtual void ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ResetAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ResetAgentResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void ResetAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ResetAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void ResetAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ResetAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // Report error to the task. RPC sets the receiving instance of coordination
      // service agent to error state permanently.
      // TODO(b/195990880): Consider splitting this into a different RPC service.
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ShutdownAgentResponse>* AsyncShutdownAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ShutdownAgentResponse>* PrepareAsyncShutdownAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ResetAgentResponse>* AsyncResetAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::tensorflow::ResetAgentResponse>* PrepareAsyncResetAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::tensorflow::ShutdownAgentResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ShutdownAgentResponse>> AsyncShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ShutdownAgentResponse>>(AsyncShutdownAgentRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ShutdownAgentResponse>> PrepareAsyncShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ShutdownAgentResponse>>(PrepareAsyncShutdownAgentRaw(context, request, cq));
    }
    ::grpc::Status ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::tensorflow::ResetAgentResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ResetAgentResponse>> AsyncResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ResetAgentResponse>>(AsyncResetAgentRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ResetAgentResponse>> PrepareAsyncResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tensorflow::ResetAgentResponse>>(PrepareAsyncResetAgentRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      ...
      #endif
      void ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response, std::function<void(::grpc::Status)>) override;
      void ShutdownAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ShutdownAgentResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void ShutdownAgent(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void ShutdownAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void ShutdownAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ShutdownAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      void ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response, std::function<void(::grpc::Status)>) override;
      void ResetAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ResetAgentResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void ResetAgent(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void ResetAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ResetAgentResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void ResetAgent(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tensorflow::ResetAgentResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::tensorflow::ShutdownAgentResponse>* AsyncShutdownAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::ShutdownAgentResponse>* PrepareAsyncShutdownAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ShutdownAgentRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::ResetAgentResponse>* AsyncResetAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::tensorflow::ResetAgentResponse>* PrepareAsyncResetAgentRaw(::grpc::ClientContext* context, const ::tensorflow::ResetAgentRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_ShutdownAgent_;
    const ::grpc::internal::RpcMethod rpcmethod_ResetAgent_;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // still disconnect, while an error is reported to tasks that did not reach
    // the barrier on time.
    virtual ::grpc::Status ShutdownAgent(::grpc::ServerContext* context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response);
    // Disconnects task from the service if it is in an ERROR state, thereby
    // allowing it to reconnect via RegisterWorker() in the future.
    virtual ::grpc::Status ResetAgent(::grpc::ServerContext* context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response);
    // Report error to the task. RPC sets the receiving instance of coordination
    // service agent to error state permanently.
    // TODO(b/195990880): Consider splitting this into a different RPC service.
  ...
  template <class BaseClass>
  class WithAsyncMethod_ShutdownAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_ShutdownAgent() {
      ::grpc::Service::MarkMethodAsync(3);
    }
    ~WithAsyncMethod_ShutdownAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ShutdownAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestShutdownAgent(::grpc::ServerContext* context, ::tensorflow::ShutdownAgentRequest* request, ::grpc::ServerAsyncResponseWriter< ::tensorflow::ShutdownAgentResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(3, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithAsyncMethod_ResetAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_ResetAgent() {
      ::grpc::Service::MarkMethodAsync(4);
    }
    ~WithAsyncMethod_ResetAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ResetAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestResetAgent(::grpc::ServerContext* context, ::tensorflow::ResetAgentRequest* request, ::grpc::ServerAsyncResponseWriter< ::tensorflow::ResetAgentResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_RegisterWorker<WithAsyncMethod_Heartbeat<WithAsyncMethod_WaitForAllTasks<WithAsyncMethod_ShutdownAgent<WithAsyncMethod_ResetAgent<WithAsyncMethod_ReportErrorToAgent<WithAsyncMethod_ReportErrorToService<WithAsyncMethod_InsertKeyValue<WithAsyncMethod_GetKeyValue<WithAsyncMethod_DeleteKeyValue<WithAsyncMethod_Barrier<WithAsyncMethod_CancelBarrier<Service > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_ShutdownAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_ShutdownAgent() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(3,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::tensorflow::ShutdownAgentRequest, ::tensorflow::ShutdownAgentResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::tensorflow::ShutdownAgentRequest* request, ::tensorflow::ShutdownAgentResponse* response) { return this->ShutdownAgent(context, request, response); }));}
    void SetMessageAllocatorFor_ShutdownAgent(
        ::grpc::experimental::MessageAllocator< ::tensorflow::ShutdownAgentRequest, ::tensorflow::ShutdownAgentResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(3);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(3);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::tensorflow::ShutdownAgentRequest, ::tensorflow::ShutdownAgentResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_ShutdownAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ShutdownAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* ShutdownAgent(
      ::grpc::CallbackServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* ShutdownAgent(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_ResetAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_ResetAgent() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(4,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::tensorflow::ResetAgentRequest, ::tensorflow::ResetAgentResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::tensorflow::ResetAgentRequest* request, ::tensorflow::ResetAgentResponse* response) { return this->ResetAgent(context, request, response); }));}
    void SetMessageAllocatorFor_ResetAgent(
        ::grpc::experimental::MessageAllocator< ::tensorflow::ResetAgentRequest, ::tensorflow::ResetAgentResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(4);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(4);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::tensorflow::ResetAgentRequest, ::tensorflow::ResetAgentResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_ResetAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ResetAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* ResetAgent(
      ::grpc::CallbackServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* ResetAgent(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithGenericMethod_ShutdownAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_ShutdownAgent() {
      ::grpc::Service::MarkMethodGeneric(3);
    }
    ~WithGenericMethod_ShutdownAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ShutdownAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_ResetAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_ResetAgent() {
      ::grpc::Service::MarkMethodGeneric(4);
    }
    ~WithGenericMethod_ResetAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ResetAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_ShutdownAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_ShutdownAgent() {
      ::grpc::Service::MarkMethodRaw(3);
    }
    ~WithRawMethod_ShutdownAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ShutdownAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/) override {
    ...
    void RequestShutdownAgent(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(3, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_ResetAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_ResetAgent() {
      ::grpc::Service::MarkMethodRaw(4);
    }
    ~WithRawMethod_ResetAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ResetAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/) override {
    ...
    void RequestResetAgent(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(4, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_ShutdownAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_ShutdownAgent() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(3,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->ShutdownAgent(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_ShutdownAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ShutdownAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_ResetAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_ResetAgent() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(4,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->ResetAgent(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_ResetAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ResetAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_ShutdownAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_ShutdownAgent() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::internal::StreamedUnaryHandler< ::tensorflow::ShutdownAgentRequest, ::tensorflow::ShutdownAgentResponse>(std::bind(&WithStreamedUnaryMethod_ShutdownAgent<BaseClass>::StreamedShutdownAgent, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_ShutdownAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status ShutdownAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ShutdownAgentRequest* /*request*/, ::tensorflow::ShutdownAgentResponse* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedShutdownAgent(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::tensorflow::ShutdownAgentRequest,::tensorflow::ShutdownAgentResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  class WithStreamedUnaryMethod_ResetAgent : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_ResetAgent() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::internal::StreamedUnaryHandler< ::tensorflow::ResetAgentRequest, ::tensorflow::ResetAgentResponse>(std::bind(&WithStreamedUnaryMethod_ResetAgent<BaseClass>::StreamedResetAgent, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_ResetAgent() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status ResetAgent(::grpc::ServerContext* /*context*/, const ::tensorflow::ResetAgentRequest* /*request*/, ::tensorflow::ResetAgentResponse* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedResetAgent(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::tensorflow::ResetAgentRequest,::tensorflow::ResetAgentResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
