...
class RustBackendGenerated:
    ...
    def import_collection_package(self, *, col_path: str, backup_path: str, media_folder: str) -> anki.generic_pb2.Empty:
        message = anki.import_export_pb2.ImportCollectionPackageRequest(col_path=col_path, backup_path=backup_path, media_folder=media_folder)
