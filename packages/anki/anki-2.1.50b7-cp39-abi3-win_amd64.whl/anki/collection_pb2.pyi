...
class CloseCollectionRequest(google.protobuf.message.Message):
    ...
    MINIMUM_BACKUP_INTERVAL_FIELD_NUMBER: builtins.int
    downgrade_to_schema11: builtins.bool
    backup_folder: typing.Text
    """Skip backup if unset"""

    minimum_backup_interval: builtins.int
    """Skip backup if one has been created in the last x seconds.
    If unset a default value is used.
    """

    def __init__(self,
        *,
        downgrade_to_schema11: builtins.bool = ...,
        backup_folder: typing.Optional[typing.Text] = ...,
        minimum_backup_interval: typing.Optional[builtins.int] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_backup_folder",b"_backup_folder","_minimum_backup_interval",b"_minimum_backup_interval","backup_folder",b"backup_folder","minimum_backup_interval",b"minimum_backup_interval"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_backup_folder",b"_backup_folder","_minimum_backup_interval",b"_minimum_backup_interval","backup_folder",b"backup_folder","downgrade_to_schema11",b"downgrade_to_schema11","minimum_backup_interval",b"minimum_backup_interval"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_backup_folder",b"_backup_folder"]) -> typing.Optional[typing_extensions.Literal["backup_folder"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_minimum_backup_interval",b"_minimum_backup_interval"]) -> typing.Optional[typing_extensions.Literal["minimum_backup_interval"]]: ...
...
class ExportCollectionRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ExportCollectionRequest = ExportCollectionRequest
