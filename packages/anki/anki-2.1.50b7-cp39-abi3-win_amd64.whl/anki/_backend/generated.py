...
class RustBackendGenerated:
    ...
    def close_collection(self, message: anki.collection_pb2.CloseCollectionRequest) -> anki.generic_pb2.Empty:
    ...
    def restore_backup_raw(self, message: bytes) -> bytes:
        return self._run_command(13, 2, message)

    def restore_backup(self, *, col_path: str, backup_path: str, media_folder: str) -> str:
        message = anki.collection_pb2.RestoreBackupRequest(col_path=col_path, backup_path=backup_path, media_folder=media_folder)
    ...
    def export_collection_raw(self, message: bytes) -> bytes:
        return self._run_command(13, 12, message)

    def export_collection(self, *, out_path: str, include_media: bool, legacy: bool) -> anki.generic_pb2.Empty:
        message = anki.collection_pb2.ExportCollectionRequest(out_path=out_path, include_media=include_media, legacy=legacy)
