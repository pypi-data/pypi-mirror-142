...
class LegacyTranslationEnum:
    ...
    ERRORS_STANDARD_POPUP = (15, 13)
    ERRORS_UNABLE_OPEN_COLLECTION = (15, 14)
    ERRORS_WINDOWS_TTS_RUNTIME_ERROR = (15, 15)
    ...
    PREFERENCES_MONTHLY_BACKUPS = (25, 19)
    PREFERENCES_NETWORK = (25, 20)
    PREFERENCES_NEXT_DAY_STARTS_AT = (25, 21)
    PREFERENCES_NIGHT_MODE = (25, 22)
    PREFERENCES_NOTE_MEDIA_IS_NOT_BACKED_UP = (25, 23)
    PREFERENCES_ON_NEXT_SYNC_FORCE_CHANGES_IN = (25, 24)
    PREFERENCES_PASTE_CLIPBOARD_IMAGES_AS_PNG = (25, 25)
    PREFERENCES_PASTE_WITHOUT_SHIFT_KEY_STRIPS_FORMATTING = (25, 26)
    PREFERENCES_PERIODICALLY_SYNC_MEDIA = (25, 27)
    PREFERENCES_PLEASE_RESTART_ANKI_TO_COMPLETE_LANGUAGE = (25, 28)
    PREFERENCES_PREFERENCES = (25, 29)
    PREFERENCES_SCHEDULING = (25, 30)
    PREFERENCES_SHOW_LEARNING_CARDS_WITH_LARGER_STEPS = (25, 31)
    PREFERENCES_SHOW_NEXT_REVIEW_TIME_ABOVE_ANSWER = (25, 32)
    PREFERENCES_SHOW_PLAY_BUTTONS_ON_CARDS_WITH = (25, 33)
    PREFERENCES_SHOW_REMAINING_CARD_COUNT_DURING_REVIEW = (25, 34)
    PREFERENCES_SOME_SETTINGS_WILL_TAKE_EFFECT_AFTER = (25, 35)
    PREFERENCES_SYNCHRONISATION = (25, 36)
    PREFERENCES_SYNCHRONIZATIONNOT_CURRENTLY_ENABLED_CLICK_THE_SYNC = (25, 37)
    PREFERENCES_SYNCHRONIZE_AUDIO_AND_IMAGES_TOO = (25, 38)
    PREFERENCES_THEME_DARK = (25, 39)
    PREFERENCES_THEME_FOLLOW_SYSTEM = (25, 40)
    PREFERENCES_THEME_LABEL = (25, 41)
    PREFERENCES_THEME_LIGHT = (25, 42)
    PREFERENCES_TIMEBOX_TIME_LIMIT = (25, 43)
    PREFERENCES_USER_INTERFACE_SIZE = (25, 44)
    PREFERENCES_V3_SCHEDULER = (25, 45)
    PREFERENCES_VIDEO_DRIVER = (25, 46)
    PREFERENCES_VIDEO_DRIVER_ANGLE = (25, 47)
    PREFERENCES_VIDEO_DRIVER_OPENGL_MAC = (25, 48)
    PREFERENCES_VIDEO_DRIVER_OPENGL_OTHER = (25, 49)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_MAC = (25, 50)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_OTHER = (25, 51)
    PREFERENCES_WEEKLY_BACKUPS = (25, 52)
    PREFERENCES_WHEN_ADDING_DEFAULT_TO_CURRENT_DECK = (25, 53)
    PREFERENCES_YOU_CAN_RESTORE_BACKUPS_VIA_FILESWITCH = (25, 54)
    ...
    QT_ACCEL_OPEN_ADDONS_FOLDER = (27, 25)
    QT_ACCEL_PREFERENCES = (27, 26)
    QT_ACCEL_PREVIOUS_CARD = (27, 27)
    QT_ACCEL_REDO = (27, 28)
    QT_ACCEL_RESET_ZOOM = (27, 29)
    QT_ACCEL_SELECT_ALL = (27, 30)
    QT_ACCEL_SELECT_NOTES = (27, 31)
    QT_ACCEL_SET_DUE_DATE = (27, 32)
    QT_ACCEL_SUPPORT_ANKI = (27, 33)
    QT_ACCEL_SWITCH_PROFILE = (27, 34)
    QT_ACCEL_TOOLS = (27, 35)
    QT_ACCEL_UNDO = (27, 36)
    QT_ACCEL_VIEW = (27, 37)
    QT_ACCEL_ZOOM_EDITOR_IN = (27, 38)
    QT_ACCEL_ZOOM_EDITOR_OUT = (27, 39)
    QT_ACCEL_ZOOM_IN = (27, 40)
    QT_ACCEL_ZOOM_OUT = (27, 41)
...
Debug info: '''
    ...
    def preferences_backup_explanation(self, ) -> str:
        r''' Anki periodically backs up your collection when it is closed. After backups are more than 2 days old,
Anki will start removing some of them to free up disk space. '''
    ...
    def preferences_theme_label(self, theme: str) -> str:
        r''' Theme: {$theme} '''
        return self._translate(25, 41, {"theme": theme})
    ...
    def preferences_video_driver(self, driver: str) -> str:
        ...
        return self._translate(25, 46, {"driver": driver})
