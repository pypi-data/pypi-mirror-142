...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0', 'paramiko>=2.6.0', 'pysftp>=0.2.9', 'sshtunnel>=0.3.2'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-ssh/2.4.1/',
