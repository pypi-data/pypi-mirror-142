...
class ActionConfig:
    def __init__(self, *, configuration: "CfnDetectorModel.ActionProperty") -> None:
    ...
    class EventProperty:
        def __init__(
            ...
            *,
            ...
            actions: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union["CfnDetectorModel.ActionProperty", aws_cdk.core.IResolvable]]]] = None,
...
class State(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iotevents.State"):
    ...
    def __init__(
        ...
        *,
        ...
        on_exit: typing.Optional[typing.Sequence[Event]] = None,
        on_input: typing.Optional[typing.Sequence[Event]] = None,
    ) -> None:
        '''
