...
class Sound(object):
    def __init__(self,Prefabs_directory=None):
        self.Prefabs_directory = Prefabs_directory
    class Jamps(object):
        def __init__(self):
            self.jamp1 = self.Prefabs_directory+'Prefabs\Sounds\Jamps\Jump1.wav'
            self.jamp2 = self.Prefabs_directory+'Prefabs\Sounds\Jamps\Jump2.wav'
            self.jamp3 = self.Prefabs_directory+'Prefabs\Sounds\Jamps\Jump3.wav'
