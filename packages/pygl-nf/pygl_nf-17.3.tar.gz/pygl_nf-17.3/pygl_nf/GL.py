...
def Mod(num):
    if num < 0:num = -num
    return num
def Get_pyHL_Version():
    print(colorama.Fore.BLUE+'Pygl version (17.3)'+colorama.Fore.RESET)
...
c_GRAY = (128, 128, 128)
c_ORANGE = (255, 165, 0)
c_DARK_ORANGE = (255, 140, 0)
c_TOMATO = (255, 99, 71)
c_GOLD = (255, 215, 0)
c_INDIGO = (75, 0, 130)
c_MAGENTA = (255, 0, 255)
c_DARK_VIOLET = (148, 0, 211)
c_BLUE_VIOLET = (138, 43, 226)
