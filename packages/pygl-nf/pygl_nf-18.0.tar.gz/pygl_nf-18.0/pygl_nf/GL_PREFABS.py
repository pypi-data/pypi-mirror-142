...
class Sound(object):
    ...
    class Jamps(object):
        def __init__(self):
            ...
            self._Jamp_Sounds = [self.jamp1,self.jamp2,self.jamp3,self.jamp4,self.jamp5,self.jamp6,self.jamp7,self.jamp8,self.jamp9,self.jamp10]
    ...
    class Pickaps(object):
        def __init__(self):
            ...
            self._Pickup_Sounds = [self.pickup1,self.pickup2,self.pickup3,self.pickup4,self.pickup5,self.pickup6,self.pickup7,self.pickup8,self.pickup9,self.pickup10]
