...
class Sound(object):
    ...
    class Jamps(object):
        def __init__(self):
            self.jamp1 = os.getcwd()+'Prefabs\Sounds\Jamps\Jump1.wav'
            self.jamp2 = os.getcwd()+'Prefabs\Sounds\Jamps\Jump2.wav'
            self.jamp3 = os.getcwd()+'Prefabs\Sounds\Jamps\Jump3.wav'
