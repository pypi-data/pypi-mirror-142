...
def make_win3():
    ...
    offline = [
        ...
        [sg.T('Offline Prediction', font='Any 16 bold')],
...
''', font='Any 12')],
    ...
    online = [
        ...
        [sg.T('Online Prediction', font='Any 16 bold')],
...
''', font='Any 12')],
    ...
    layout +=[[sg.TabGroup([[  sg.Tab('Offline Prediction', offline),
                              sg.Tab('Online Prediction', online),]
                              ])],
              [sg.B('Exit')] 
