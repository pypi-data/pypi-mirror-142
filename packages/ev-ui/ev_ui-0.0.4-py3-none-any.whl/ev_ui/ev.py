...
def make_win2():
    ...
    top_col = [
        [sg.T(
'''This program allows the user to plot three different forms of electrochemistry data. The ploted figure can then be adjusted and exported 
...
def make_win3():
    ...
    offline = [
        ...
        [sg.T('''Offline training model is based on 40 Samsung NMC 111/graphite fuel cell batteries from the UW Schwartz Lab. 
