...
def FT_ICRMS(path, formula='C50H60O50N1S1', mz_range=[200, 800], peak_threshold=7, error=1, iso_error=0.0003,
             iso_fold_change=5,mode = 'neg'):
    '''
    ...
    final_result['H/C'] = (final_result['H']/final_result['C']).astype(float).round(3)
    ...
    AI_numerator = 1 +final_result['C']-0.5*final_result['O']-final_result['S']-0.5*final_result['H']
