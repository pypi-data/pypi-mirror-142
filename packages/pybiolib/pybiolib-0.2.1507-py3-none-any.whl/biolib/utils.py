        ...
        with open(output_file_path, 'ab') as output_file:
            ...
            while True:
                logger_no_user_data.debug(
                    f'PresignedUrlDownloader: Creating chunk input sub iterator of '
                    f'size {parallel_download_processes_count}'
                )
                ...
                chunk_input_sub_iterator = itertools.islice(chunk_input_iterator, parallel_download_processes_count)
                chunk_result_iterator = process_pool.imap(func=_download_chunk, iterable=chunk_input_sub_iterator)
                if not chunk_result_iterator:
                    break

                return_tuple: DownLoadChunkReturnTuple  # for typing hinting
                for return_tuple in chunk_result_iterator:
