...
# 9     14  100.2   10          100.20      44.0    NA      NA        21.3    20.6    5
# 10    13  200.3   5           200.30      89.4    NA      NA        20.6    20.1    5
# 11    12  381     2.63        380.95      174.2   NA      NA        20.2    19.9    5
...
# 16    7   10417   0.225       4444        3944    NA      NA        17.9    17.4    5
# 17    6   15625   0.193       5181        5164    NA      NA        17.7    17.2    5
# 18    5   31250   0.161       6211        6776    NA      NA        17.5    17.0    5
#=======================================================================================#
...
def srTable():
    ...
    print('9  100.2   10       100.20   44.0      NA      NA      21.3  20.6')
    print('10 200.3   5        200.30   89.4      NA      NA      20.6  20.1')
    print('11 381     2.63     380.95   174.2     NA      NA      20.2  19.9')
    ...
    print('16 10417   0.225    4444     3944      NA      NA      17.9  17.4')
    print('17 15625   0.193    5181     5164      NA      NA      17.7  17.2')
    print('18 31250   0.161    6211     6776      NA      NA      17.5  17.0')
    print('=================================================================')
...
def enableDINint(addr, bit):    # enable DIN interrupt
    if (VerifyADDR(addr) == 0):
        return
