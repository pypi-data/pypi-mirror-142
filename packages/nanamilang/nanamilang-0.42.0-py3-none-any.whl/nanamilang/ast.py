    ...
    def evaluate(self, module_env) -> tuple:
        ...
        def recursive(local_env: dict,
            ...
            if isinstance(identifier_token_or_form, list):
                ...
                # If expression form has been evaluated to Py3Object, cast it to a Function and call
                if isinstance(result_or_nexception, datatypes.Py3Object):
                    return result_or_nexception.function().reference()(args)
            ...
            if identifier_token_or_form.identifier():
                ...
                # If final data type is Py3Object, cast to the 'Function' and call it with the args
                if isinstance(final, datatypes.Py3Object):
                    return final.function().reference()(args)
