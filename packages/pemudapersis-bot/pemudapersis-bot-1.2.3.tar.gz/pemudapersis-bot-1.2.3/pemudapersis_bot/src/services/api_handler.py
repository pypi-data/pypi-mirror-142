...
class APIHandler:
    ...
    def check_npa(self, npa: str) -> str:
        ...
        try:
            response = requests.post(api_url, headers=self.request_headers, data=request_body)
    ...
    def __get_access_token(self):
        ...
        try:
            response = requests.post(login_url, data=request_body, headers=self.request_headers)
        except requests.RequestException as exp:
