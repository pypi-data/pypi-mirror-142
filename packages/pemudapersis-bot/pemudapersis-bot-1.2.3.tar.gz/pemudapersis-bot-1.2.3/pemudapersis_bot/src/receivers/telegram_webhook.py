...
from pemudapersis_bot.src.receivers.telegram_bot import handler, start_command, help_command, contact_command
...
def start():
    APP.run(threaded=True, port=Config.WEBHOOK_PORT, host=Config.WEBHOOK_HOST, ssl_context=CONTEXT)
