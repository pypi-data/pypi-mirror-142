...
from mnapy import VoltageControlledVoltageSourceLimits
...
class VoltageControlledVoltageSource:
    def __init__(
        ...
        self.Gain = Gain
        self.option_limits = (
            VoltageControlledVoltageSourceLimits.VoltageControlledVoltageSourceLimits(
    ...
    def stamp(self) -> None:
        None
        self.context.stamp_vcvs(
            self.Nodes[0],
            self.Nodes[1],
            self.Nodes[2],
            self.Nodes[3],
            -self.Gain,
            self.context.ELEMENT_VCVS_OFFSET + self.SimulationId,
        )
