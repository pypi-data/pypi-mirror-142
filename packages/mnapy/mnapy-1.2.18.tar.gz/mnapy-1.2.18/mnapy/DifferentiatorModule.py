...
from mnapy import DifferentiatorModuleLimits
from mnapy import Utils
from mnapy import Wire


class DifferentiatorModule:
    def __init__(
            self,
            context,
            options,
        ...
        self.option_limits = DifferentiatorModuleLimits.DifferentiatorModuleLimits(
    ...
    def stamp(self) -> None:
        ...
        self.context.stamp_voltage(
            ...
            -1,
            self.Output_Voltage,
            self.context.ELEMENT_DIFFERENTIATOR_OFFSET + self.SimulationId,
        )
