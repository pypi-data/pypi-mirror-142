...
def get_article(pm_fetcher: PubMedFetcher, cr_fetcher: CrossRefFetcher, identifier: str) -> PubMedArticle:
    ...
    if re.match(PMID_REGEX, identifier):
        ...
        try:
            ...
            article = pm_fetcher.article_by_pmid(pmid)
            success = 1
        ...
        if success == 0:
            try:
                # work = cr_fetcher.article_by_doi(identifier)
                ...
                article = PubMedArticle('<PubmedArticle></PubmedArticle>')
