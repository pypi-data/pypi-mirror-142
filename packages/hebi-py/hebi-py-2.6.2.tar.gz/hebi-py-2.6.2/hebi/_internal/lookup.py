...
class Lookup:
  ...
  def __init__(self):
    self.__delegate = LookupDelegate.get_singleton()
  ...
  def get_group_from_names(self, families: "Union[str, List[str]]", names: "Union[str, List[str]]", timeout_ms: "Optional[float]"=None):
...
class LookupDelegate(UnmanagedObject):
  ...
  def __parse_to(self, timeout_ms: 'Optional[Any]'):
  ...
  def get_group_from_names(self, families: 'Union[List[str], str]', names: 'Union[List[str], str]', timeout_ms: 'Optional[Any]'=None):
