...
def populate_hebi_funcs(lib):
  ...
  if hasattr(lib, 'hebiGroupCreateFromNames'):
    ...
    lib_func.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p), ctypes.c_size_t,
                         ctypes.POINTER(ctypes.c_char_p), ctypes.c_size_t, ctypes.c_int32]
    lib_func.restype = ctypes.c_void_p
  else:
  ...
  if hasattr(lib, 'hebiRobotModelElementCreateRigidBody'):
    ...
    lib_func.argtypes = [ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double), ctypes.c_double,
                         ctypes.c_size_t, ctypes.POINTER(ctypes.c_double), ctypes.c_int]
    lib_func.restype = ctypes.c_void_p
  else:
  ...
  if hasattr(lib, 'hebiRobotModelElementCreateEndEffector'):
    ...
    lib_func.argtypes = [ctypes.c_int, ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double),
  ...
  if hasattr(lib, 'hebiIKAddObjectiveCustom'):
    ...
    ObjFunc = ctypes.CFUNCTYPE(None, ctypes.c_void_p, ctypes.c_size_t, ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double))
    lib_func.argtypes = [ctypes.c_void_p, ctypes.c_double, ctypes.c_size_t, ObjFunc, ctypes.c_void_p]
    lib_func.restype = ctypes.c_int
  else:
  ...
  if hasattr(lib, 'hebiTrajectoryCreateUnconstrainedQp'):
    ...
    lib_func.argtypes = [ctypes.c_size_t, ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double),
  ...
  if hasattr(lib, 'hebiTrajectoryGetState'):
    ...
    lib_func.argtypes = [ctypes.c_void_p, ctypes.c_double, ctypes.POINTER(ctypes.c_double),
                         ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double)]
    lib_func.restype = ctypes.c_int
  else:
