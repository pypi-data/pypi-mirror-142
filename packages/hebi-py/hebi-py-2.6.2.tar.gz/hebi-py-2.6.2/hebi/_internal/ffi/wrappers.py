...
class UnmanagedSharedObject(object):
  ...
  def __init__(self, internal: 'Any'=None, on_delete: 'Callable[[Any], None]'=(lambda _: None), existing: 'Optional[UnmanagedSharedObject]'=None, isdummy: bool=False):
    class Proxy(object):
      def __init__(self, internal=None, on_delete: 'Callable[[Any], None]'=(lambda _: None), proxy: 'Optional[Proxy]'=None):
...
class FieldDetails(object):
  ...
  def __init__(self, units: str, camel: str, pascal: str, snake: str, is_scalar: bool):
    if units is None:
      self._units = None
    else:
...
class MessageEnumTraits(EnumTraits):
  ...
  def __init__(self, value: int, name: str, field_details: 'Union[FieldDetails, NumberedFieldDetails, None]'=None, allow_broadcast=True, not_bcastable_reason: 'Optional[str]'='', yields_dict=None):
