...
class GroupCommandBase(UnmanagedSharedObject):
  ...
  def control_strategy(self, value):
    ...
    _marshalling.set_group_command_enum(self._command_refs, enums.CommandEnumControlStrategy, out)
  ...
  def mstop_strategy(self, value):
    ...
    _marshalling.set_group_command_enum(self._command_refs, enums.CommandEnumMstopStrategy, out)
  ...
  def min_position_limit_strategy(self, value):
    ...
    _marshalling.set_group_command_enum(self._command_refs, enums.CommandEnumMinPositionLimitStrategy, out)
  ...
  def max_position_limit_strategy(self, value):
    ...
    _marshalling.set_group_command_enum(self._command_refs, enums.CommandEnumMaxPositionLimitStrategy, out)
  ...
  @staticmethod
  def _map_enum_strings_if_needed(value: "Sequence[Union[int, str]]", mapping: "Mapping[str, int]") -> "List[int]":
    ret: "List[int]" = []
    for val in value:
