...
def qubit_table(target_qubits, signs, symmetry_generators, symmetry_generator_labels):
    n = len(symmetry_generators[0])
    subscripts = str.maketrans("0123456789", "₀₁₂₃₄₅₆₇₈₉")
...
def reduced_hamiltonian(atom, basis, charge = 0, spin = 0, irrep = None, verbose = True, show_lowest_eigenvalue = False, output_format = 'openfermion'):
    ...
    if verbose == True:
        ...
        qubit_table(target_qubits, signs, symmetry_generators, symmetry_generator_labels) +
