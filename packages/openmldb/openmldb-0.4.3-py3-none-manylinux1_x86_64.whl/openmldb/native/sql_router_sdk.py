...
class SQLRouter(object):
    ...
    def ExecuteOfflineQuery(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ExecuteOfflineQuery(self, sql, config, default_db, job_info)

    def ImportOnlineData(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ImportOnlineData(self, sql, config, default_db, job_info)

    def ImportOfflineData(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ImportOfflineData(self, sql, config, default_db, job_info)

    def ExportOfflineData(self, sql: "std::string const &", config: "std::map< std::string,std::string,std::less< std::string >,std::allocator< std::pair< std::string const,std::string > > > const &", default_db: "std::string const &", job_info: "::openmldb::taskmanager::JobInfo &") -> "::openmldb::base::Status":
        return _sql_router_sdk.SQLRouter_ExportOfflineData(self, sql, config, default_db, job_info)

    def GetJobLog(self, id: "int const", status: "Status") -> "std::string":
