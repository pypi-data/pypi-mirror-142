...
class BasePage:
    ...
    def __getattribute__(self, attr):
        ...
        if attr.startswith('e_') or attr.startswith('_e_'):
            ...
            if isinstance(_target, (List[MelonElement], Tuple[MelonElement], Set[MelonElement])):
                # 可迭代属性
    ...
    def __proxy_iterable(self, _targets: Union[List[MelonElement], Tuple[MelonElement], Set[MelonElement]]) -> List[WebElement]:
        """
        代理可迭代属性
        """
        _target = _targets[0]
