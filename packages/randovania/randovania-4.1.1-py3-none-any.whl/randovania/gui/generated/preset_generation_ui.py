...
class Ui_PresetGeneration(object):
    def setupUi(self, PresetGeneration):
        ...
        self.scroll_contents.setGeometry(QRect(0, 0, 479, 813))
    ...
    def retranslateUi(self, PresetGeneration):
        ...
        self.multi_pickup_label.setText(QCoreApplication.translate("PresetGeneration", u"<html><head/><body><p>If this setting is enabled, the generator will consider placing multiple items in multiple locations (e.g. Morph Ball and Bombs) in order to determine progression, rather than only a single item at a time as it is by default.</p></body></html>", None))
