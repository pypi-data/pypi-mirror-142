...
class ApolloClient(object):
    ...
    # Main method
    def get_value(self, key, default_val=None, namespace='application', auto_fetch_on_cache_miss=False, whole=False):
        ...
        elif key in self._cache[namespace]:
    ...
    def _long_poll(self):
        ...
        notifications = [{"namespaceName": key, "notificationId": self._notification_map[key]}
