...
from tensorflow.python.ops import gen_audio_ops as audio_ops  # pylint: disable=no-name-in-module
...
class AudioProcessor():
    ...
    """
        ...
        def processing_graph(wav_filename, foreground_volume,
            ...
            # pylint must be disabled here as it incorrectly identifies tf API
            # as explained in
            # https://github.com/tensorflow/tensorflow/issues/43038.
