...
def get_model_code(
    ...
    if isinstance(sklearn_pipeline, PipelineWithYTransformations):
        output.extend(get_y_transformer_code(sklearn_pipeline))
    ...
    if is_timeseries:
        ...
        if isinstance(sklearn_pipeline.pipeline, PipelineWithYTransformations):
            output.extend(get_y_transformer_code(sklearn_pipeline.pipeline))
            has_y_transformer = True
        ...
        output.append(get_build_model_pipeline_code_from_templates(pipeline_step_templates, has_y_transformer))
...
def get_build_model_pipeline_code_from_templates(
        pipeline_step_templates: List[PipelineStepTemplate], has_y_transformer: bool) -> str:
...
def get_scriptrun_code(
    ...
    if is_timeseries:
        ...
        function += code_body
        # TODO: Add this code for timeseries too
        function += [
            "",
            "print(metrics)",
