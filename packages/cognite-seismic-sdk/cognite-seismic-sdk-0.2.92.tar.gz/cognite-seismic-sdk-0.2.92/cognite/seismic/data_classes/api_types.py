...
class SourceSegyFile:
    ...
    def __init__(self, *, uuid, id, external_id, name, metadata, segy_overrides):
        self.uuid = uuid
        self.id = id
        self.external_id = external_id
        self.name = name
    ...
    def from_proto(proto) -> "SourceSegyFile":
        ...
        return SourceSegyFile(
            uuid=uuid, id=id, external_id=external_id, name=name, metadata=metadata, segy_overrides=segy_overrides
        )
